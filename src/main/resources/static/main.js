...
function seriesLoadScripts(e, t) {
    ...
    var i = document.getElementsByTagName("head").item(0) || document.documentElement, n = new Array, a = e.length - 1,
        s = function (o) {
            n[o] = document.createElement("script"), n[o].setAttribute("type", "text/javascript"), n[o].setAttribute("charset", "UTF-8"), n[o].onload = n[o].onreadystatechange = function () {
                this.onload = this.onreadystatechange = null, this.parentNode.removeChild(this), o != a ? s(o + 1) : "function" == typeof t && t()
...
function getUuid(e, t) {
    ...
    if (t = t || n.length, e) for (i = 0; i < e; i++) a[i] = n[0 | Math.random() * t]; else {
        var s;
        for (a[8] = a[13] = a[18] = a[23] = "-", a[14] = "4", i = 0; i < 36; i++) a[i] || (s = 0 | 16 * Math.random(), a[i] = n[19 == i ? 3 & s | 8 : s])
    }
    return a.join("")
}
...
function bindObjOutsiteClick(e, t, i) {
    var n = "doc_" + (new Date).getTime(), a = "doc_" + (new Date).getTime() + 1;
    e.attr("class") && e.attr("class", e.attr("class").replace(/doc_(\d+)/g, "")), e.addClass(n), t && (t.attr("class", t.attr("class").replace(/doc_(\d+)/g, "")), t.addClass(a)), setTimeout(function () {
        $(document).bind("click", function (t) {
            $(t.target).hasClass(a) || $(t.target).parents(".showErrorBox").length || 0 == $(t.target).parents("." + n).length && (e.hide(), "function" == typeof i && i(), $(document).unbind("click"))
        })
    }, 200)
}
...
function Utemplate(e, t) {
    ...
    return i(e.substr(o, e.length - o)), s += "return arr.join('')", new Function(s.replace(/[\r\t\n]/g, "")).apply(t)
}
...
function loadGatewayScript(e, t, i) {
    function n(i) {
        s[i] = document.createElement("script"), s[i].setAttribute("type", "text/javascript"), s[i].setAttribute("charset", "UTF-8"), s[i].onload = s[i].onreadystatechange = function () {
            this.onload = this.onreadystatechange = null, this.parentNode.removeChild(this), i != o ? n(i + 1) : "function" == typeof t && t()
        }, s[i].setAttribute("src", e[i]), "IFRAME" != a.tagName ? a.appendChild(s[i]) : a.contentDocument.body ? a.contentDocument.body.appendChild(s[i]) : a.contentDocument.documentElement.appendChild(s[i])
    }

    "object" != typeof e && (e = [e]);
    var a = i || document.getElementsByTagName("head").item(0) || document.documentElement, s = new Array,
        o = e.length - 1;
    n(0)
}
...
var Cookie = {
    get: function (e) {
        ...
        s = n ? s + ";domain=" + n : s, s = a ? s + ";path=" + a : s, document.cookie = s
    }, del: function (e, t, i) {
        var n = new Date("1970/01/01"), a = e + "=null;expires=" + n.toGMTString();
        a = t ? a + ";domain=" + t : a, a = i ? a + ";path=" + i : a, document.cookie = a
    }
}, cookie = {
    get: function (e) {
        var t, i = new RegExp("(^| )" + e + "=([^;]*)(;|$)");
...
!function () {
    ...
    var e = location.href.indexOf("/gongsi/fa2f92669c66eee31Hc~") > -1, t = "undefined" == typeof _PAGE,
        i = encodeURIComponent(document.referrer).indexOf("security-check.html") > -1;
    if (e) {
        var n = new Image, a = "BSCompany_" + (t ? "mobile" : "pc") + "_" + (i ? "isCheck" : "notCheck");
...
KZ = {
    form: {
        ...
        show: function (e, t, i, n, a) {
            var s;
            if (s = $(".guide").length ? $(window.document) : $(window.parent.document), 0 == s.find(t.selector).length) {
                s.width(), $(t).outerWidth(), $(window).height(), $(t).outerHeight()
            } else {
                s.width(), s.find(t.selector).outerWidth(), $(window).height(), s.find(t.selector).outerHeight()
            }
            ...
            s.find("#lockpage").css("height", $(document).height() + "px"), 0 == s.find(t.selector).length ? ($(t).appendTo(s.find("body")), s.find(t).css({
                position: "fixed",
                zIndex: e + 1,
                left: "50%",
                top: "50%",
                ...
                display: "block"
            }), KZ.pageLock.hide(i, t, a), "function" == typeof n && n()
        }, hide: function (e, t, i) {
            var n;
    ...
    cWidth: 350, cHeight: 350, cR: 175, show: function (e) {
        ...
        t.html.find(".selectpic .editbox .pop i .scale-icon").length && t.html.find(".selectpic .editbox .pop i .scale-icon").remove(), t.html.find(".selectpic .editbox .pop i").append('<div class="scale-icon"></div>'), t.html.find(".selectpic .editbox .pop i .scale-icon").hide(), this.popbox.bind("mousedown", function (e) {
            ...
            t.html.bind("mousemove", function (e) {
                var t = e.clientX - n.x, a = e.clientY - n.y;
                crop.circle.x = i.x + t, crop.circle.y = i.y + a, crop.popbox.css({
            ...
            var i = {x: crop.circle.x, y: crop.circle.y, r: crop.circle.r},
                n = {x: e.clientX, y: e.clientY, left: $(this).position().left, top: $(this).position().top};
            t.html.bind("mousemove", function (e) {
                var a = e.clientX - n.x, s = e.clientY - n.y, o = Math.max(a, s);
        ...
        i.crossOrigin = "Anonymous", i.onload = function () {
            ...
            a.clearRect(0, 0, n.width, n.height), a.fillStyle = "#fff", a.fillRect(0, 0, n.width, n.height), a.drawImage(i, -1 * (t.x - t.r), -1 * (t.y - t.r));
        ...
        return s.clearRect(0, 0, a.width, a.height), imageWidth < a.width ? s.drawImage(e, (a.width - imageWidth) / 2, 0, imageWidth, imageHeight) : s.drawImage(e, 0, (a.height - imageHeight) / 2, imageWidth, imageHeight), a.toDataURL("image/png", t)
    }
};
if (function (e) {
    function t() {
    ...
    i.prototype = {
        constructor: i, _events: [], _attachEvents: function () {
            ...
            this.endDate = e || 1 / 0, this.endDate !== 1 / 0 && (this.endDate = a.parseDate(this.endDate, this.format, this.language, this.formatType)), this.update(), this.updateNavArrows()
            ...
            if (!this.isInline) {
                ...
                var i, n, a, s, o = t + 10;
                s = this.container instanceof e ? this.container.offset() : e(this.container).offset(), this.component ? (i = this.component.offset(), a = i.left, "bottom-left" != this.pickerPosition && "top-left" != this.pickerPosition || (a += this.component.outerWidth() - this.picker.outerWidth())) : (i = this.element.offset(), a = i.left), a + 220 > document.body.clientWidth && (a = document.body.clientWidth - 220), n = "top-left" == this.pickerPosition || "top-right" == this.pickerPosition ? i.top - this.picker.outerHeight() : i.top + this.height, n -= s.top, a -= s.left, this.picker.css({
                    top: n,
                    left: a,
                    zIndex: o
                })
            ...
            var e, t = !1;
            arguments && arguments.length && ("string" == typeof arguments[0] || arguments[0] instanceof Date) ? (e = arguments[0], t = !0) : ("string" == typeof (e = (this.isInput ? this.element.val() : this.element.find("input").val()) || this.element.data("date") || this.initialDate) || e instanceof String) && (e = e.replace(/^\s+|\s+$/g, "")), e || (e = new Date, t = !1), this.date = a.parseDate(e, this.format, this.language, this.formatType), t && this.setValue(), this.date < this.startDate ? this.viewDate = new Date(this.startDate) : this.date > this.endDate ? this.viewDate = new Date(this.endDate) : this.viewDate = new Date(this.date),
                this.fill()
        }, fillDow: function () {
            ...
            if (null != this.date && null != this.viewDate) {
                var i = new Date(this.viewDate), s = i.getUTCFullYear(), o = i.getUTCMonth(), r = i.getUTCDate(),
                ...
                if (this.picker.find(".datetimepicker-days thead th:eq(1)").text(n[this.language].months[o] + " " + s), "time" == this.formatViewType) {
                    var g = c % 12 ? c % 12 : 12, v = (g < 10 ? "0" : "") + g, b = (l < 10 ? "0" : "") + l,
                        y = n[this.language].meridiem[c < 12 ? 0 : 1];
                    this.picker.find(".datetimepicker-hours thead th:eq(1)").text(v + ":" + b + " " + (y ? y.toUpperCase() : "")), this.picker.find(".datetimepicker-minutes thead th:eq(1)").text(v + ":" + b + " " + (y ? y.toUpperCase() : ""))
                } else this.picker.find(".datetimepicker-hours thead th:eq(1)").text(r + " " + n[this.language].months[o] + " " + s), this.picker.find(".datetimepicker-minutes thead th:eq(1)").text(r + " " + n[this.language].months[o] + " " + s);
                ...
                var w = t(s, o - 1, 28, 0, 0, 0, 0), $ = a.getDaysInMonth(w.getUTCFullYear(), w.getUTCMonth());
                w.setUTCDate($), w.setUTCDate($ - (w.getUTCDay() - this.weekStart + 7) % 7);
                var x = new Date(w);
                x.setUTCDate(x.getUTCDate() + 42), x = x.valueOf();
                for (var C, k = [], T = ""; w.valueOf() < x;) {
                    var _ = "";
                    if (w.getUTCDay() == this.weekStart && k.push("<tr>"), C = "", T = w.getUTCDate(), w.getUTCFullYear() < s || w.getUTCFullYear() == s && w.getUTCMonth() < o ? C += " old" : (w.getUTCFullYear() > s || w.getUTCFullYear() == s && w.getUTCMonth() > o) && (C += " new"), this.todayHighlight && w.getUTCFullYear() == m.getFullYear() && w.getUTCMonth() == m.getMonth() && T == m.getDate() && (C += " today", T = "浠婃棩"), w.valueOf() == f && (C += " active"), w.valueOf() + 864e5 <= this.startDate || w.valueOf() > this.endDate || -1 !== e.inArray(w.getUTCDay(), this.daysOfWeekDisabled)) C += " disabled"; else {
                        var S = "" + w.getUTCFullYear() + w.getUTCMonth() + w.getUTCDate();
                        this.inDate.filter(function (e) {
                            return "" + e.year + e.month + e.day === S
                        }).length && (_ = '<i class="indate-dot"></i>')
                    }
                    k.push('<td class="day' + C + '"><em>' + w.getUTCDate() + "</em>" + _ + "</td>"), w.getUTCDay() == this.weekEnd && k.push("</tr>"), w.setUTCDate(w.getUTCDate() + 1)
                }
                this.picker.find(".datetimepicker-days tbody").empty().append(k.join("")), k = [];
                for (var D = "", E = "", j = "", I = 0; I < 24; I++) {
                    var P = t(s, o, r, I);
                    C = "", P.valueOf() + 36e5 <= this.startDate || P.valueOf() > this.endDate ? C += " disabled" : c == I && (C += " active"), this.showMeridian && 2 == n[this.language].meridiem.length ? (E = I < 12 ? n[this.language].meridiem[0] : n[this.language].meridiem[1], E != j && ("" != j && k.push("</fieldset>"), k.push('<fieldset class="hour"><legend>' + E.toUpperCase() + "</legend>")), j = E, D = I % 12 ? I % 12 : 12, k.push('<span class="hour' + C + " hour_" + (I < 12 ? "am" : "pm") + '">' + D + "</span>"), 23 == I && k.push("</fieldset>")) : (D = I + ":00", k.push('<span class="hour' + C + '">' + D + "</span>"))
                }
                this.picker.find(".datetimepicker-hours td").html(k.join("")), k = [], D = "", E = "", j = "";
                for (var I = 0; I < 60; I += this.minuteStep) {
                    var P = t(s, o, r, c, I, 0);
                    C = "", P.valueOf() < this.startDate || P.valueOf() > this.endDate ? C += " disabled" : Math.floor(l / this.minuteStep) == Math.floor(I / this.minuteStep) && (C += " active"), this.showMeridian && 2 == n[this.language].meridiem.length ? (E = c < 12 ? n[this.language].meridiem[0] : n[this.language].meridiem[1], E != j && ("" != j && k.push("</fieldset>"), k.push('<fieldset class="minute"><legend>' + E.toUpperCase() + "</legend>")), j = E, D = c % 12 ? c % 12 : 12, k.push('<span class="minute' + C + '">' + D + ":" + (I < 10 ? "0" + I : I) + "</span>"), 59 == I && k.push("</fieldset>")) : (D = I + ":00", k.push('<span class="minute' + C + '">' + c + ":" + (I < 10 ? "0" + I : I) + "</span>"))
                }
                this.picker.find(".datetimepicker-minutes td").html(k.join(""));
                var A = this.date.getUTCFullYear(),
                    R = this.picker.find(".datetimepicker-months").find("th:eq(1)").text(s).end().find("span").removeClass("active");
                A == s && R.eq(this.date.getUTCMonth()).addClass("active"), (s < d || s > u) && R.addClass("disabled"), s == d && R.slice(0, p).addClass("disabled"), s == u && R.slice(h + 1).addClass("disabled"), k = "", s = 10 * parseInt(s / 10, 10);
                var z = this.picker.find(".datetimepicker-years").find("th:eq(1)").text(s + "-" + (s + 9)).end().find("td");
                s -= 1;
                for (var I = -1; I < 11; I++) {
                    var O = s;
                    if (this.minLimitYear && s < this.minLimitYear) return;
                    this.minLimitYear && s == this.minLimitYear && (O = s + 1 + "浠ュ墠"), k += '<span class="year' + (-1 == I || 10 == I ? " old" : "") + (A == s ? " active" : "") + (s < d || s > u ? " disabled" : "") + '" data-year="' + s + '">' + O + "</span>", s += 1
                }
                z.html(k), this.place(), this.updateNavArrows()
            }
            ...
            switch (this.viewMode) {
                case 0:
                    this.startDate !== -1 / 0 && t <= this.startDate.getUTCFullYear() && i <= this.startDate.getUTCMonth() && n <= this.startDate.getUTCDate() && a <= this.startDate.getUTCHours() ? this.picker.find(".prev").css({visibility: "hidden"}) : this.picker.find(".prev").css({visibility: "visible"}), this.endDate !== 1 / 0 && t >= this.endDate.getUTCFullYear() && i >= this.endDate.getUTCMonth() && n >= this.endDate.getUTCDate() && a >= this.endDate.getUTCHours() ? this.picker.find(".next").css({visibility: "hidden"}) : this.picker.find(".next").css({visibility: "visible"});
                    break;
                case 1:
                ...
                case 3:
                case 4:
                    this.startDate !== -1 / 0 && t <= this.startDate.getUTCFullYear() ? this.picker.find(".prev").css({visibility: "hidden"}) : this.picker.find(".prev").css({visibility: "visible"}), this.endDate !== 1 / 0 && t >= this.endDate.getUTCFullYear() ? this.picker.find(".next").css({visibility: "hidden"}) : s ? this.picker.find(".next").css({visibility: "hidden"}) : this.picker.find(".next").css({visibility: "visible"})
            }
                ...
                switch (n[0].nodeName.toLowerCase()) {
                    case"th":
                        switch (n[0].className) {
                            ...
                            case"today":
                                var s = new Date;
                                s = t(s.getFullYear(), s.getMonth(), s.getDate(), s.getHours(), s.getMinutes(), s.getSeconds(), 0), s < this.startDate ? s = this.startDate : s > this.endDate && (s = this.endDate), this.viewMode = this.startViewMode, this.showMode(0), this._setDate(s), this.fill(), this.autoclose && this.hide()
                        }
                        break;
                    case"span":
                        if (!n.is(".disabled")) {
            ...
            }, i = o + t, a.setUTCMonth(i), (i < 0 || i > 11) && (i = (i + 12) % 12); else {
                for (var c = 0; c < r; c++) a = this.moveMonth(a, t);
            ...
            switch (e.keyCode) {
                ...
                case 39:
                    ...
                    t = 37 == e.keyCode ? -1 : 1, viewMode = this.viewMode, e.ctrlKey ? viewMode += 2 : e.shiftKey && (viewMode += 1), 4 == viewMode ? (i = this.moveYear(this.date, t), n = this.moveYear(this.viewDate, t)) : 3 == viewMode ? (i = this.moveMonth(this.date, t), n = this.moveMonth(this.viewDate, t)) : 2 == viewMode ? (i = this.moveDate(this.date, t), n = this.moveDate(this.viewDate, t)) : 1 == viewMode ? (i = this.moveHour(this.date, t), n = this.moveHour(this.viewDate, t)) : 0 == viewMode && (i = this.moveMinute(this.date, t), n = this.moveMinute(this.viewDate, t)), this.dateWithinRange(i) && (this.date = i, this.viewDate = n, this.setValue(), this.update(), e.preventDefault(), a = !0);
                    break;
                case 38:
                case 40:
                    if (!this.keyboardNavigation) break;
        ...
        return this.each(function () {
            var s = e(this), o = s.data("datetimepicker"), r = "object" == typeof t && t;
            if (o || s.data("datetimepicker", o = new i(this, e.extend({}, e.fn.datetimepicker.defaults, r))), "string" == typeof t && "function" == typeof o[t] && void 0 !== (a = o[t].apply(o, n))) return !1
        }), void 0 !== a ? a : this
    ...
    var n = e.fn.datetimepicker.dates = {
        ...
        parseDate: function (a, s, o, r) {
            if (a instanceof Date) {
                var c = new Date(a.valueOf() - 6e4 * a.getTimezoneOffset());
            ...
            if (/^\d{4}\-\d{1,2}\-\d{1,2}$/.test(a) && (s = this.parseFormat("yyyy-mm-dd", r)), /^\d{4}\-\d{1,2}\-\d{1,2}[T ]\d{1,2}\:\d{1,2}$/.test(a) && (s = this.parseFormat("yyyy-mm-dd hh:ii", r)), /^\d{4}\-\d{1,2}\-\d{1,2}[T ]\d{1,2}\:\d{1,2}\:\d{1,2}[Z]{0,1}$/.test(a) && (s = this.parseFormat("yyyy-mm-dd hh:ii:ss", r)), /^[-+]\d+[dmwy]([\s,]+[-+]\d+[dmwy])*$/.test(a)) {
                var l, d, p = /([-+]\d+)([dmwy])/, u = a.match(/([-+]\d+)([dmwy])/g);
                a = new Date;
            ...
            var f, m, l, u = a && a.match(this.nonpunctuation) || [], a = new Date(0, 0, 0, 0, 0, 0, 0), g = {},
            ...
            if (b.M = b.MM = b.mm = b.m, b.dd = b.d, b.P = b.p, a = t(a.getFullYear(), a.getMonth(), a.getDate(), a.getHours(), a.getMinutes(), a.getSeconds()), u.length == s.parts.length) {
                for (var h = 0, y = s.parts.length; h < y; h++) {
                    if (f = parseInt(u[h], 10), l = s.parts[h], isNaN(f)) switch (l) {
                        case"MM":
                ...
                for (var w, h = 0; h < v.length; h++) (w = v[h]) in g && !isNaN(g[w]) && b[w](a, g[w])
            }
            return a
        },
        formatDate: function (t, i, s, o) {
            ...
            if ("standard" == o) r = {
                ...
                i: t.getUTCMinutes(),
                s: t.getUTCSeconds()
            }, 2 == n[s].meridiem.length ? r.H = r.h % 12 == 0 ? 12 : r.h % 12 : r.H = r.h, r.HH = (r.H < 10 ? "0" : "") + r.H, r.P = r.p.toUpperCase(), r.hh = (r.h < 10 ? "0" : "") + r.h, r.ii = (r.i < 10 ? "0" : "") + r.i, r.ss = (r.s < 10 ? "0" : "") + r.s, r.dd = (r.d < 10 ? "0" : "") + r.d, r.mm = (r.m < 10 ? "0" : "") + r.m; else {
    ...
    e.cleanData = function (t) {
        ...
        var a, s, o, r, c = {}, l = t.split(".")[0];
        return t = t.split(".")[1], a = l + "-" + t, n || (n = i, i = e.Widget), e.expr[":"][a.toLowerCase()] = function (t) {
            return !!e.data(t, a)
        ...
        }), o.prototype = e.widget.extend(r, {widgetEventPrefix: s ? r.widgetEventPrefix || t : t}, c, {
            constructor: o,
            namespace: l,
            widgetName: t,
            widgetFullName: a
        ...
        for (var n, a, s = i.call(arguments, 1), o = 0, r = s.length; r > o; o++) for (n in s[o]) a = s[o][n], s[o].hasOwnProperty(n) && void 0 !== a && (t[n] = e.isPlainObject(a) ? e.isPlainObject(t[n]) ? e.widget.extend({}, t[n], a) : e.widget.extend({}, a) : a);
        return t
    }, e.widget.bridge = function (t, n) {
        var a = n.prototype.widgetFullName || t;
        e.fn[t] = function (s) {
            var o = "string" == typeof s, r = i.call(arguments, 1), c = this;
            return o ? this.each(function () {
                var i, n = e.data(this, a);
                return "instance" === s ? (c = n, !1) : n ? e.isFunction(n[s]) && "_" !== s.charAt(0) ? (i = n[s].apply(n, r), i !== n && void 0 !== i ? (c = i && i.jquery ? c.pushStack(i.get()) : i, !1) : void 0) : e.error("no such method '" + s + "' for " + t + " widget instance") : e.error("cannot call methods on " + t + " prior to initialization; attempted to call method '" + s + "'")
        ...
        _on: function (t, i, n) {
            ...
            "boolean" != typeof t && (n = i, i = t, t = !1), n ? (i = a = e(i), this.bindings = this.bindings.add(i)) : (n = i, i = this.element, a = this.widget()), e.each(n, function (n, o) {
                ...
                var c = n.match(/^([\w:-]*)\s*(.*)$/), l = c[1] + s.eventNamespace, d = c[2];
                d ? a.delegate(d, l, r) : i.bind(l, r)
            })
        },
        _off: function (t, i) {
    ...
    "JSON" in window && "parse" in JSON && (i = JSON, n = "parse"), e.ajaxTransport("iframe", function (i) {
        if (i.async) {
            ...
            return {
                send: function (r, c) {
                    n = e('<form style="display:none;"></form>'), n.attr("accept-charset", i.formAcceptCharset), s = /\?/.test(i.url) ? "&" : "?", "DELETE" === i.type ? (i.url = i.url + s + "_method=DELETE", i.type = "POST") : "PUT" === i.type ? (i.url = i.url + s + "_method=PUT", i.type = "POST") : "PATCH" === i.type && (i.url = i.url + s + "_method=PATCH", i.type = "POST"), t += 1, a = e('<iframe src="' + o + '" name="iframe-transport-' + t + '"></iframe>').bind("load", function () {
                        ...
                        }), n.prop("target", a.prop("name")).prop("action", i.url).prop("method", i.type), i.formData && e.each(i.formData, function (t, i) {
                    ...
                    a && a.unbind("load").prop("src", o), n && n.remove()
                }
            }
        }
    }), e.ajaxSetup({
    ...
    function t(t) {
        ...
        return function (n) {
            ...
            a && -1 !== e.inArray("Files", a.types) && !1 !== this._trigger(t, e.Event(t, {delegatedEvent: n})) && (n.preventDefault(), i && (a.dropEffect = "copy"))
        }
    }
    ...
    e.support.fileInput = !(new RegExp("(Android (1\\.[0156]|2\\.[01]))|(Windows Phone (OS 7|8\\.0))|(XBLWP)|(ZuneWP)|(WPDesktop)|(w(eb)?OSBrowser)|(webOS)|(Kindle/(1\\.0|2\\.[05]|3\\.0))").test(window.navigator.userAgent) || e('<input type="file"/>').prop("disabled")), e.support.xhrFileUpload = !(!window.ProgressEvent || !window.FileReader), e.support.xhrFormDataFileUpload = !!window.FormData, e.support.blobSlice = window.Blob && (Blob.prototype.slice || Blob.prototype.webkitSlice || Blob.prototype.mozSlice), e.widget("blueimp.fileupload", {
        ...
        _initXHRData: function (t) {
            var i, n = this, a = t.files[0], s = t.multipart || !e.support.xhrFileUpload,
                o = "array" === e.type(t.paramName) ? t.paramName[0] : t.paramName;
            t.headers = e.extend({}, t.headers), t.contentRange && (t.headers["Content-Range"] = t.contentRange), s && !t.blob && this._isInstanceOf("File", a) || (t.headers["Content-Disposition"] = 'attachment; filename="' + encodeURI(a.uploadName || a.name) + '"'), s ? e.support.xhrFormDataFileUpload && (t.postMessage ? (i = this._getFormData(t), t.blob ? i.push({
                name: o,
                value: t.blob
            }) : e.each(t.files, function (n, a) {
                i.push({name: "array" === e.type(t.paramName) && t.paramName[n] || o, value: a})
        ...
        _getXHRPromise: function (t, i, n) {
            ...
            return i = i || this.options.context || s, !0 === t ? a.resolveWith(i, n) : !1 === t && a.rejectWith(i, n), s.abort = a.promise, this._enhancePromise(s)
        },
        _addConvenienceMethods: function (t, i) {
            ...
            i.process = function (t, s) {
                ...
                }).then(t, s)), this._processQueue || a([this])
            }, i.submit = function () {
        ...
        _chunkedUpload: function (t, i) {
            ...
            var n, a, s = this, o = t.files[0], r = o.size, c = t.uploadedBytes, l = t.maxChunkSize || r,
                d = this._blobSlice, p = e.Deferred(), u = p.promise();
            return !(!(this._isXHRUpload(t) && d && (c || ("function" === e.type(l) ? l(t) : l) < r)) || t.data) && (!!i || (c >= r ? (o.error = t.i18n("uploadedBytes"), this._getXHRPromise(!1, t.context, [null, "error", o.error])) : (a = function () {
                var i = e.extend({}, t), u = i._progress.loaded;
                i.blob = d.call(o, c, c + ("function" === e.type(l) ? l(i) : l), o.type), i.chunkSize = i.blob.size, i.contentRange = "bytes " + c + "-" + (c + i.chunkSize - 1) + "/" + r, s._trigger("chunkbeforesend", null, i), s._initXHRData(i), s._initProgressListener(i), n = (!1 !== s._trigger("chunksend", null, i) && e.ajax(i) || s._getXHRPromise(!1, i.context)).done(function (n, o, l) {
                    c = s._getUploadedBytes(l) || c + i.chunkSize, u + i.chunkSize - i._progress.loaded && s._onProgress(e.Event("progress", {
                        lengthComputable: !0,
                        loaded: c - i.uploadedBytes,
                        total: c - i.uploadedBytes
                    }), i), t.uploadedBytes = i.uploadedBytes = c, i.result = n, i.textStatus = o, i.jqXHR = l, s._trigger("chunkdone", null, i), s._trigger("chunkalways", null, i), c < r ? a() : p.resolveWith(i.context, [n, o, l])
                }).fail(function (e, t, n) {
        ...
        _onDone: function (t, i, n, a) {
            var s = a._progress.total, o = a._response;
        ...
        _onSend: function (t, i) {
            ...
            var n, a, s, o, r = this, c = r._getAJAXSettings(i), l = function () {
                return r._sending += 1, c._bitrateTimer = new r._BitrateTimer, n = n || ((a || !1 === r._trigger("send", e.Event("send", {delegatedEvent: t}), c)) && r._getXHRPromise(!1, c.context, a) || r._chunkedUpload(c) || e.ajax(c)).done(function (e, t, i) {
                    r._onDone(e, t, i, c)
                }).fail(function (e, t, i) {
                    r._onFail(e, t, i, c)
            ...
            return this._beforeSend(t, c), this.options.sequentialUploads || this.options.limitConcurrentUploads && this.options.limitConcurrentUploads <= this._sending ? (this.options.limitConcurrentUploads > 1 ? (s = e.Deferred(), this._slots.push(s), o = s.then(l)) : (this._sequence = this._sequence.then(l, l), o = this._sequence), o.abort = function () {
                return a = [void 0, "abort", "abort"], n ? n.abort() : (s && s.rejectWith(c.context, a), l())
            }, this._enhancePromise(o)) : l()
        },
        _onAdd: function (t, i) {
            var n, a, s, o, r = this, c = !0, l = e.extend({}, this.options, i), d = i.files, p = d.length,
            ...
            if (!p) return !1;
            if (h && void 0 === d[0].size && (h = void 0), (l.singleFileUploads || u || h) && this._isXHRUpload(l)) if (l.singleFileUploads || h || !u) if (!l.singleFileUploads && h) for (s = [], n = [], o = 0; o < p; o += 1) m += d[o].size + f, (o + 1 === p || m + d[o + 1].size + f > h || u && o + 1 - v >= u) && (s.push(d.slice(v, o + 1)), a = g.slice(v, o + 1), a.length || (a = g), n.push(a), v = o + 1, m = 0); else n = g; else for (s = [], n = [], o = 0; o < p; o += u) s.push(d.slice(o, o + u)), a = g.slice(o, o + u), a.length || (a = g), n.push(a); else s = [d], n = [g];
            return i.originalFiles = d, e.each(s || d, function (a, o) {
                var l = e.extend({}, i);
                return l.files = s ? o : [o], l.paramName = n[a], r._initResponseObject(l), r._initProgressObject(l), r._addConvenienceMethods(t, l), c = r._trigger("add", e.Event("add", {delegatedEvent: t}), l)
            }), c
        },
        _replaceFileInput: function (t) {
            var i = t.fileInput, n = i.clone(!0), a = i.is(document.activeElement);
            t.fileInputClone = n, e("<form></form>").append(n)[0].reset(), i.after(n).detach(), a && n.focus(), e.cleanData(i.unbind("remove")), this.options.fileInput = this.options.fileInput.map(function (e, t) {
                return t === i[0] ? n[0] : t
        ...
        _handleFileTreeEntry: function (t, i) {
            ...
            }, r) : t.isDirectory ? (n = t.createReader(), l()) : s.resolve([]), s.promise()
        },
        ...
        _onChange: function (t) {
            ...
            this._getFileInputFiles(n.fileInput).always(function (a) {
                n.files = a, i.options.replaceFileInput && i._replaceFileInput(n), !1 !== i._trigger("change", e.Event("change", {delegatedEvent: t}), n) && i._onAdd(t, n)
            })
        },
        _onPaste: function (t) {
        ...
        _onDrop: function (t) {
            ...
            var i = this, n = t.dataTransfer, a = {};
            n && n.files && n.files.length && (t.preventDefault(), this._getDroppedFiles(n).always(function (n) {
                a.files = n, !1 !== i._trigger("drop", e.Event("drop", {delegatedEvent: t}), a) && i._onAdd(t, a)
            }))
        },
        ...
        _initDataAttributes: function () {
            ...
            e.each(this.element[0].attributes, function (e, a) {
                ...
                }), s = n[o], t._isRegExpOption(o, s) && (s = t._getRegExp(s)), i[o] = s)
            })
        },
        _create: function () {
                ...
                if (t.fileInput && !t.files) {
                    ...
                    return o.abort = function () {
                        ...
                        if (!n) {
                            ...
                            t.files = e, i = a._onSend(null, t), i.then(function (e, t, i) {
                                s.resolve(e, t, i)
                            }, function (e, t, i) {
                                s.reject(e, t, i)
                            })
...
!function (e) {
    ...
    e.fn.confirm = function (t, i) {
        return void 0 === t && (t = {}), "string" == typeof t && (t = {
            ...
            i.on("click", function (n) {
                n.preventDefault();
                var a = e.extend({}, t);
                i.attr("data-title") && (a.title = i.attr("data-title")), i.attr("data-content") && (a.content = i.attr("data-content")), a.$target = i, i.attr("href") && !t.confirm && (a.confirm = function () {
        ...
        _init: function () {
            ...
            e.each(this.$content.find("img:not(.loaded)"), function (i, n) {
                var a = setInterval(function () {
                    "0px" !== e(n).css("height") && (e(n).addClass("loaded"), t.setDialogCenter(), clearInterval(a))
                }, 40)
            })
            ...
            if (t = t || this.content, this._isAjax = !1, this.content) if ("string" == typeof this.content) if ("url:" === this.content.substr(0, 4).toLowerCase()) {
                ...
                "object" != typeof a ? console.error("The content function must return jquery promise.") : "function" != typeof a.always ? console.error("The object returned is not a jquery promise.") : (this._isAjax = !0, a.always(function (e, t) {
            ...
            var a = e(window).height(), s = this.$b.outerHeight() - i + t, o = (a - s) / 2;
            if (s > a - 100) {
    ...
    "use strict";
    var n = (e(t), e(document), !-[1] && t.XMLHttpRequest, !1), a = function (t) {
    ...
    a.defaults = {
        ...
        init: function () {
            ...
            var t = "", i = "", n = "", a = "", s = "", o = "", r = "";
            this.settings.type && (t = '<i class="icon-dialog icon-dialog-' + this.settings.type + '"></i>'), this.settings.lock && (n = '<div class="dialog-layer"></div>', this.settings.opacityLock && (n = '<div class="dialog-layer dialog-opacity-layer"></div>')), this.settings.preKa && (a = this.settings.preKa + "_"), ("around" == this.settings.position || this.settings.inline) && (s = '<span class="icon-dialog-arrow"></span>'), this.settings.closeText && (o = '<a href="javascript:;" class="close" ka="' + a + 'dialog_close"><i class="icon-close"></i></a>'), (this.settings.confirmText || this.settings.cancelText) && (r = '<div class="dialog-footer"><div class="btns"></div></div>'), i = '<div class="dialog-wrap">' + n + '<div class="dialog-container">' + s + '<div class="dialog-title">' + t + '<h3 class="title">' + this.settings.title + "</h3>" + o + '</div><div class="dialog-con">' + this.settings.content + "</div>" + r + "</div></div>", e(".dialog-wrap").length && !this.settings.inline && e(".dialog-wrap").each(function () {
            ...
            if (this.settings.element) {
                var i = this, n = i.settings.element, a = i.dialog.find(".dialog-container").outerWidth(),
                    s = e(n).offset(), o = s.left + n.width() / 2;
                o < a && (o = a / 2), i.settings.inline || "around" != i.settings.position || i.dialog.css({
                    left: o + "px",
                    top: s.top + "px"
    ...
    var t = function (t, i) {
        ...
        container: function () {
            ...
            return e.each(t, function (e, t) {
                n += "<tr>", n += '<td class="industry-category" data-code="' + t.code + '">' + t.name + "</td>", n += "<td>", n += s(t.subLevelModelList), n += "</td>", n += "</tr>"
            }), n += "</table>"
        }
    };
    t.prototype.init = function () {
        ...
        var t = this, a = t.option.multiple ? "industry-multiple-wrapper " : "";
        t.$dialog = e.dialog({
            bind: !0,
            title: "璇烽€夋嫨琛屼笟绫诲埆",
            content: n.container(),
            ...
            onOpen: function (a) {
                ...
                e(a).on("click.industry", "table span", function () {
                    ...
                    e(a).find(".selected[data-code=" + i + "]").removeClass("selected"), t.toggleSelected()
                    ...
                    var o = (new Date).getTime() - s, r = o > 500 ? o : 500 - o;
                    setTimeout(function () {
                        e(a).find(".industry-panel").html(n.industry(i, t.$element.data("selected"))), t.toggleSelected()
                    }, r)
                })
            },
            onClose: function (t) {
    ...
    var a = function (i) {
        return this.each(function () {
            var n = e(this), a = n.data("boss.industry");
            a || n.data("boss.industry", a = new t(this, i)), "string" == typeof i && a[i].call(n)
        })
    }, s = e.fn.industry;
    e.fn.industry = a, e.fn.industry.Constructor = t, e.fn.industry.noConflict = function () {
        return e.fn.industry = s, this
    }
}(jQuery), function (e, t, i) {
    "use strict";
    var n = (e(t), e(document), !1), a = function (t) {
        ...
        init: function (t) {
            ...
            var a = function (e) {
                for (var i = t.json, n = [], a = 0; a < i.length; a++) {
                    var s = i[a].name, o = i[a].subLevelModelList || i[a].children || i[a].subList;
            ...
            a.length ? function (e, a) {
                ...
                for (var s = 0; s < e.length; s++) {
                    var o = e[s].name.toLowerCase(), r = a.toLowerCase(), c = o.indexOf(r), l = r.length,
                        d = e[s].name.substring(0, c) + '<span class="h">' + e[s].name.substring(c, c + l) + "</span>" + e[s].name.substring(c + l);
            ...
            }(a, e) : (i.html("").addClass("hide"), n.removeClass("hide"))
        }, suggestSelected: function (t, i) {
            var n = i, a = n.$searchLists.find("li");
            if ("" != n.$searchInput.val().trim()) switch (t.which) {
                case 38:
                    a.removeClass("selected"), -1 == n.currentSelection || 0 == n.currentSelection ? (n.currentSelection = -1, n.currentSelection = a.length - 1) : n.currentSelection--, a.eq(n.currentSelection).addClass("selected"), n.scrollVisiable(a.eq(n.currentSelection), "up");
                    break;
                case 40:
                    t.preventDefault(), a.removeClass("selected"), n.currentSelection > a.length - 2 && (n.currentSelection = -1), n.currentSelection++, a.eq(n.currentSelection).addClass("selected"), n.scrollVisiable(a.eq(n.currentSelection), "down");
                    break;
                case 13:
                    n.currentSelection = -1;
                    var s = n.$searchLists.find("li.selected"), o = s.get(0);
                    if (s.length) {
            ...
            if (!t) return !1;
            var a = n.find("li").length, s = e(t).index(), o = s > 4 ? s - 4 : 0,
                r = "down" == i && (o < a - 4 || 0 === s), c = "up" == i && (s < a - 5 || s == a - 1);
            "up" == i && (o = s), (c || r) && n.scrollTop(o * e(t).height())
        }, addHtml: function (e) {
            ...
            var i = e(t).parents(".js-two"), n = e(".js-two"), a = e(".js-li"),
                s = this.getThreeData(e(t).attr("data-code")), o = this.joinThreeData(s);
            s ? (this.resetHTML(n, a), e(t).addClass(this.active), i.append(o)) : (this.setPop(t), this.removeNode(e(".js-dialog-position")))
        }, getOneData: function (t, i) {
            var n = this, a = "";
            return e.each(t, function (e, t) {
                var s = t.name, o = n.getCode(t);
            ...
            return e.each(this.json, function (a, s) {
                ...
                e.each(o, function (e, a) {
                    if (n.getCode(a) == t) return i = a.subLevelModelList || a.children || a.subList, !1
                })
            }), i
            ...
            var i = "", n = 0, a = this, s = t.length || 0;
            return e.each(t, function (e, t) {
                var o = a.getCode(t), r = t.name;
                e % 4 == 0 && (i += '<div class="js-two"><ul class="navs" data-eq=' + n++ + ">"), i += '<li class="js-li" data-code="' + o + '">' + r + "</li>", e % 4 != 3 && e !== s - 1 || (i += "</ul></div>")
            }), i
        }, joinThreeData: function (t) {
            var i = this, n = '<ol class="list block">';
            return e.each(t, function (e, t) {
                var a = i.getCode(t), s = t.name;
...
var Payment = function () {
    ...
    function i(e, t, i) {
        var n, a = !0, s = {bzbParam: e.bzbParam};
        ...
        var t = $.extend({
            ...
            a && (n.close(), i.ptype = e.data.payType, t.success(i))
        }, c = function () {
            $(".pop-payment .PaymentCheck").html('<i class="loader-gray-17"></i>姝ｅ湪鏌ヨ鏀粯缁撴灉锛岃绋嶅悗'), o.get.queryStatus(e, s).then(function (e) {
                if (1 !== e.zpData.state) {
                    $(".pop-payment .PaymentCheck").html('<span class="gray">鏈敮浠樻垚鍔燂紝璇锋偍鎵爜瀹屾垚鏀粯銆�</span><a class="PayCheckBtn" href="javascript:">閲嶆柊鏌ヨ</a>')
                } else 0 === e.code && 1 == e.zpData.state && (a = !1, r(e))
            })
        }, l = function () {
            o.get.queryStatus(e, s).then(function (e) {
                0 === e.code && 1 !== e.zpData.state ? a && setTimeout(l, 3e3) : 0 === e.code ? (a && r(e), a = !1) : $.toast({
                    type: "error",
                    content: e.message
                })
            })
    ...
    function n(e, t) {
        var i, n = {
            ...
            o.post.purchase(e, t).then(function (n) {
                ...
                }), t.success(n.zpData)) : (e.orderId = n.zpData.orderId, e.qrCode = n.zpData.qrUrl, e.orderNo = n.zpData.orderNo, 2 == e.data.payType ? a(e, t) : s(e, t), t.buy && t.buy({
                    pay: e.amount,
                    balance: e.balance,
                    payType: e.data.payType,
                    orderNo: n.orderNo
            ...
            var a = $(n);
            i = this, a.on("click", ".prop-order-type p", function () {
                if ($(this).hasClass("selected") || $(this).hasClass("disabled")) return !1;
                a.find(".prop-order-type .selected").addClass("disabled").removeClass("selected"), $(this).addClass("selected").addClass("disabled"), e.data.payType = $(this).attr("data-payType"), c(e, t)
                ...
                $(this).hasClass("selected") ? (e.coupon = i.offAmount, e.discountId = i.discountId, n.text(i.discountDesc), a.find(".coupon-selected").text("-" + e.coupon + "鐩磋眴").show()) : (e.coupon = 0, e.discountId = "0", n.html("&nbsp;"), a.find(".coupon-selected").text(e.userCouponList.length + "寮犲彲鐢�"));
                var s = e.amount, o = 100 * e.coupon + e.totalOffAmount, r = e.amount - e.balance - o,
                    c = s > o + e.balance ? r : e.amount - o;
                e.pay = c, e.cost = r, e.cost <= 0 && (e.data.payType = 4), a.find(".pay-amount").text(e.pay / 100 + "鐩磋眴"), e.cost > 0 || e.recharge ? (a.find(".prop-order-type").show(), a.find(".btn-block").hide()) : (a.find(".btn-block").show(), a.find(".prop-order-type").hide())
    ...
    return o.get = {}, o.post = {}, o.post.orderInfo = function (e, t) {
        ...
        var a = function (e) {
            c = "free", $.when(o.post.orderInfo(e), o.get.coupon(e)).then(function (t, n) {
                ...
                var a = $.extend({}, t.zpData, {bzbParam: e, userCouponList: n.zpData.discountList || []});
                i(a)
            })
        }, s = function (e) {
        ...
        e.data.priceId ? (e.data.bz = e.data.business, e.data.jid = e.data.jobId, $.post(n, e.data, s)) : $.post(n, {paramsJson: encodeURIComponent(JSON.stringify(e.data))}, s)
        ...
        var i = $.Deferred(), n = "/wapi/zpp/user/bzbOrder", a = {
            discountParam: e.discountParam,
            bzbParam: e.bzbParam,
            discountId: e.discountId,
            bzbChannel: e.data.payType
        };
        return e.recharge && (n = "/wapi/zpp/user/rechargeBean", a = {
            amount: 100 * e.data.beanCount,
            payChannel: e.data.payType
        }), $.ajax({
            method: "post", url: n, data: a, cache: !1, success: function (e) {
    ...
    }, {wx: a, zfb: s, notice: e, success: t, purchase: n, balance: o.get.balance}
}(), Purchase = function () {
    function e(e, t, i) {
        Payment.success({
    ...
    function t(t, i, n) {
        ...
        var a = n.action ? n.action : "鍙戝竷", s = {
            ordinary: {
                1: "鐏垎鑱屼綅鏅€氱増" + a + "鎴愬姛锛佸彲淇濇寔鑱屼綅鍦ㄧ嚎<%this.description%>锛屾湡闂存瘡鏃ユ煡鐪嬬墰浜轰笂闄�<%this.view%>锛屽紑鑱婁笂闄�<%this.employ%>銆�",
                2: "",
        ...
        var a = n.item.type || "ordinary", l = Utemplate(s[a][i.action], n.item), d = o[a][i.action],
    ...
    return {
        vip: function (e, t) {
            ...
            var s = {
                ...
                11: "鎮ㄥ凡鎴愬姛璐拱VIP璐﹀彿锛屽彲鍦╒IP鏉冪泭椤甸潰鏌ョ湅浣跨敤鏄庣粏" + a,
                12: "",
                16: "鎮ㄥ凡鎴愬姛璐拱VIP璐﹀彿锛屽彲鍦╒IP鏉冪泭椤甸潰鏌ョ湅浣跨敤鏄庣粏" + a
            };
            ...
            var r = i.item ? i.item : i, c = r.cardId, l = s[c] ? Utemplate(s[c], r) : "", d = 9 == c ? function (e) {
                ...
                var a = "";
                3 == c && r.activityType && (a = '<ul class="vip-promotion-2018-notice"><li>鐗瑰埆娉ㄦ剰锛�</li><li>1. 娲诲姩鏈熼棿锛屾瘡涓敤鎴峰彧鑳借喘涔颁竴娆IP璐﹀彿锛屼笉鍙娆¤喘涔帮紱</li><li>2. 娲诲姩鏈熼棿璐拱鐨勫晢鍝佸師鍒欎笂鏃犳硶鐢宠閫€娆撅紝濡傚洜骞冲彴鍘熷洜瀵艰嚧鎮ㄦ棤娉曚娇鐢ㄨ处鍙风殑璧犻€佹椂闀胯鑱旂郴瀹㈡湇锛�</li></ul>'), 2 == c && r.activityType && (a = '<ul class="vip-promotion-2018-notice"><li>鐗瑰埆娉ㄦ剰锛�</li><li>1. 娲诲姩鎴鏃堕棿1鏈�1鏃�,瓒呭嚭娲诲姩鏃堕棿鑼冨洿锛岃喘涔扮殑鍟嗗搧涓嶅啀浜彈娲诲姩鎶樻墸锛�</li><li>2. 鏈浼樻儬娲诲姩浠呴拡瀵归儴鍒嗙敤鎴�,鏈€缁堣В閲婃潈褰払OSS鐩磋仒鎵€鏈夛紱</li><li>3. 娲诲姩鏈熼棿璐拱鐨勫晢鍝佸師鍒欎笂鏃犳硶鐢宠閫€娆惧鍥犲钩鍙板師鍥犲鑷存偍鏃犳硶浣跨敤璐﹀彿鐨勮禒閫佹椂闀胯鑱旂郴瀹㈡湇锛�</li></ul>'), e(l, d + a, {confirm: n})
            }, u = {
    ...
    function t(t) {
        var i = function (e) {
            ...
            e($.extend({url: t.url, callback: t.success, confirm: t.success}, s(a, n(a)))), $(i).remove()
        };
        $.dialog({
            title: "鐩磋眴鍏呭€�", content: a.rebate(function () {
                return [100, 200, 300, 500, 1e3].map(function (e) {
                    return {amount: e, save: s(e, n(e)).save}
                })
    ...
    function i(t) {
        var i = t.discount ? .9 : 1, n = function (e) {
            ...
            e($.extend({callback: t.success, url: t.url}, s(a, i))), $(n).remove()
        };
        $.dialog({
            title: "鐩磋眴鍏呭€�",
    ...
    function e() {
        return function (e, t) {
            for (var n = e, a = [], s = i.unit(n); n <= t;) a.push(n), s = i.unit(n), n += s;
            return a
        }(1, 250)
    }

    function t(e) {
        for (var t = i.max(e), n = i.unit(e), a = Math.floor(e / n) * n, s = [], o = i.unit(a); a < t;) o = i.unit(a), (a += o) <= t && s.push(a);
        return s
    }
    ...
    var e = function (e) {
        ...
        for (var t = 0, i = e.length, n = -1, a = 0; a < i; a++) n = e.charCodeAt(a), t += n >= 0 && n <= 128 ? 1 : 2;
        return t
    };
...
!function (e) {
    ...
    t.prototype.init = function () {
        ...
        for (var t = ["涓€鏈�", "浜屾湀", "涓夋湀", "鍥涙湀", "浜旀湀", "鍏湀", "涓冩湀", "鍏湀", "涔濇湀", "鍗佹湀", "鍗佷竴鏈�", "鍗佷簩鏈�"], i = '<div class="title"><p class="text">' + e + '</p></div><div class="content"><ul>', n = this.getFill(), a = 0; a < 12; a++) {
        ...
        var t = this.dates.filter(function (e) {
            return e.value == t
        })[0], n = t.value, a = t.name, s = this.$element.attr("data-fill"), o = e("input[name=" + s + "]");
        i && (n += "-" + i, a += "-" + i), this.$element.val(a), o && o.val(n), this.hide()
    }, t.prototype.show = function () {
    ...
    var i = function (i) {
        return this.each(function () {
            var n = e(this), a = n.data("boss.date");
            a || n.data("boss.date", a = new t(this, i)), "string" == typeof i && a[i].call(n)
        })
    ...
    t.prototype = {
        constructor: t, select: function () {
            ...
            var a = e(t).parent().hasClass("dropup"),
                s = (a || (i.top, i.height), e(t).hasClass("dropdown-menu-right"));
            s || i.left;
            ...
            if (n && n.length) for (i = 0; i < n.length; ++i) n[i].length > 2 && a.push(n[i]); else a = [], a.push(e);
            t = t.replace(/[\(\)\/\.\*\+\?\[\]]/g, function (e) {
                return "\\" + e
            });
            var o, r = new RegExp(t, "g");
            for (i = 0; i < a.length; ++i) (o = a[i].match(r)) && o.length > 0 && s.push(a[i]);
            for (i = 0; i < s.length; ++i) e = e.replace(s[i], s[i].replace(r, "<strong>$&</strong>"));
            return e
        }, render: function (t) {
            var i = this, n = this, a = !1, s = [], o = i.options.separator;
            return e.each(t, function (e, i) {
                e > 0 && i[o] !== t[e - 1][o] && s.push({__type: "divider"}), !i[o] || 0 !== e && i[o] === t[e - 1][o] || s.push({
                    __type: "category",
                    name: i[o]
                }), s.push(i)
            }), t = e(s).map(function (t, s) {
                if ("category" == (s.__type || !1)) return e(i.options.headerHtml).text(s.name)[0];
                if ("divider" == (s.__type || !1)) return e(i.options.headerDivider)[0];
                var o = n.displayText(s);
                return t = e(i.options.item).data("value", s), t.find("a").html(i.highlighter(o, s)), o == n.$element.val() && (t.addClass("active"), n.$element.data("active", s), a = !0), t[0]
            }), 1 == t.length && i.options.emptyItem && t.eq(0).addClass("empty").find("a").prepend("<span>鍥炶溅娣诲姞鏍囩</span>"), t.length && n.$menu.parent().find(".skills-pannel").hide(), this.autoSelect && !a && (t.filter(":not(.dropdown-header)").first().addClass("active"), this.$element.data("active", t.first().data("value"))), this.$menu.html(t), this
    ...
    e.fn.typeahead = function (i) {
        ...
        return "string" == typeof i && "getActive" == i ? this.data("active") : this.each(function () {
            var a = e(this), s = a.data("typeahead"), o = "object" == typeof i && i;
            s || a.data("typeahead", s = new t(this, o)), "string" == typeof i && s[i] && (n.length > 1 ? s[i].apply(s, Array.prototype.slice.call(n, 1)) : s[i]())
        })
    }, t.defaults = {
        source: [],
        items: 8,
    ...
    t.prototype = {
        constructor: t, add: function (t, i, n) {
            ...
            if (!(s.options.maxTags && s.itemsArray.length >= s.options.maxTags) && (!1 === t || t)) {
                if ("string" == typeof t && s.options.trimValue && (t = e.trim(t)), "object" == typeof t && !s.objectItems) throw"Can't add objects when itemValue option is not set";
                if (!t.toString().match(/^\s*$/)) {
                    ...
                    var l = s.options.itemValue(t), d = s.options.itemText(t), p = s.options.tagClass(t),
                        u = s.options.itemTitle(t), h = e.grep(s.itemsArray, function (e) {
                            return s.options.itemValue(e) === l
                        })[0];
                    if (!h || s.options.allowDuplicates) {
                        if (!(s.items().toString().length + t.length + 1 > s.options.maxInputLength)) {
                            ...
                            if (s.$element.trigger(f), !f.cancel) {
                                s.itemsArray.push(t);
                                var m = e('<span class="tag ' + a(p) + (null !== u ? '" title="' + u : "") + '">' + a(d) + '<span data-role="remove"></span></span>');
                                m.data("item", t), s.findInputWrapper().before(m), m.after(" ");
                                var g = e('option[value="' + encodeURIComponent(l) + '"]', s.$element).length || e('option[value="' + a(l) + '"]', s.$element).length;
                                if (s.isSelect && !g) {
                                    var v = e("<option selected>" + a(d) + "</option>");
                                    v.data("item", t), v.attr("value", l), s.$element.append(v)
                                }
                                i || s.pushVal(s.options.triggerChange), s.options.maxTags !== s.itemsArray.length && s.items().toString().length !== s.options.maxInputLength || s.$container.addClass("bootstrap-tagsinput-max"), e(".typeahead, .twitter-typeahead", s.$container).length && s.$input.typeahead("val", ""), this.isInit ? s.$element.trigger(e.Event("itemAddedOnInit", {
                                    item: t,
                                    options: n
                                })) : s.$element.trigger(e.Event("itemAdded", {item: t, options: n}))
                            }
                        }
                    } else if (s.options.onTagExists) {
                        var b = e(".tag", s.$container).filter(function () {
                            return e(this).data("item") === h
                        });
                        s.options.onTagExists(t, b)
                    }
                }
            }
            ...
            if (a.objectItems && (t = "object" == typeof t ? e.grep(a.itemsArray, function (e) {
                ...
                var s = e.Event("beforeItemRemove", {item: t, cancel: !1, options: n});
                if (a.$element.trigger(s), s.cancel) return;
                e(".tag", a.$container).filter(function () {
                    return e(this).data("item") === t
                }).remove(), e("option", a.$element).filter(function () {
                    return e(this).data("item") === t
                }).remove(), -1 !== e.inArray(t, a.itemsArray) && a.itemsArray.splice(e.inArray(t, a.itemsArray), 1)
            }
            i || a.pushVal(a.options.triggerChange), a.options.maxTags > a.itemsArray.length && a.$container.removeClass("bootstrap-tagsinput-max"), a.$element.trigger(e.Event("itemRemoved", {
                item: t,
                options: n
            ...
            e(".tag", t.$container).each(function () {
                var i = e(this), n = i.data("item"), s = t.options.itemValue(n), o = t.options.itemText(n),
                    r = t.options.tagClass(n);
                if (i.attr("class", null), i.addClass("tag " + a(r)), i.contents().filter(function () {
                    return 3 == this.nodeType
                })[0].nodeValue = a(o), t.isSelect) {
            ...
            var a = this;
            if (a.options = e.extend({}, r, t), a.objectItems && (a.options.freeInput = !1), i(a.options, "itemValue"), i(a.options, "itemText"), n(a.options, "tagClass"), a.options.listTags && e(a.options.listTags).on("click", "li", function () {
                a.add(e(this).text()), a.options.showListTags(e(this).text(), a)
            }), a.options.typeahead) {
                var c = a.options.typeahead || {};
                n(c, "source"), a.$input.typeahead(e.extend({}, c, {
                    source: function (t, i) {
                        function n(e) {
            ...
            if (a.options.typeaheadjs) {
                ...
                e.isArray(l) || (l = [null, l]), e.fn.typeahead.apply(a.$input, l).on("typeahead:selected", e.proxy(function (e, t, i) {
                    var n = 0;
                    l.some(function (e, t) {
                        return e.name === i && (n = t, !0)
                    }), l[n].valueKey ? a.add(t[l[n].valueKey]) : a.add(t), a.$input.typeahead("val", "")
                }, a))
            }
            a.$container.on("click", e.proxy(function (e) {
                a.$element.attr("disabled") || a.$input.removeAttr("disabled"), a.$input.focus()
            }, a)), a.options.addOnBlur && a.options.freeInput && a.$input.on("focusout", e.proxy(function (t) {
                0 === e(".typeahead, .twitter-typeahead", a.$container).length && (a.add(a.$input.val()), a.$input.val(""))
            }, a)), a.$container.on({
                focusin: function () {
                ...
                var i = e(t.target), n = a.findInputWrapper();
            ...
            }, a)), a.$container.on("keypress", "input", e.proxy(function (t) {
                var i = e(t.target);
                if (a.$element.attr("disabled")) return void a.$input.attr("disabled", "disabled");
                var n = i.val(), s = a.options.maxChars && n.length >= a.options.maxChars;
                a.options.freeInput && (o(t, a.options.confirmKeys) || s) && (0 !== n.length && (a.add(s ? n.substr(0, a.options.maxChars) : n), i.val("")), !1 === a.options.cancelConfirmKeysOnEmpty && t.preventDefault());
                var r = i.val().length;
                Math.ceil(r / 5);
                i.attr("size", Math.max(this.inputSize, i.val().length))
            }, a)), a.$container.on("click", "[data-role=remove]", e.proxy(function (t) {
                a.$element.attr("disabled") || a.remove(e(t.target).closest(".tag").data("item"))
            }, a)), a.options.itemValue === r.itemValue && ("INPUT" === a.$element[0].tagName ? a.add(a.$element.val()) : e("option", a.$element).each(function () {
        ...
        return this.each(function () {
            ...
            if (o) if (i || n) {
                if (void 0 !== o[i]) {
                    if (3 === o[i].length && void 0 !== a) var r = o[i](n, null, a); else var r = o[i](n);
                    void 0 !== r && s.push(r)
                }
            } else s.push(o); else o = new t(this, i), e(this).data("tagsinput", o), s.push(o), "SELECT" === this.tagName && e("option", e(this)).attr("selected", "selected"), e(this).val(e(this).val())
    ...
    var s = t, o = s.document;
    e.fn.suggestion = function (t) {
        var i = this, s = t.throttleTime || 150, r = void 0 === t.focusSugges || !!t.focusSugges,
        ...
        t.blankHTML && (l += '<div class="suggestion-blank">', l += n(t.blankHTML, {searchText: '<span class="suggestion-text"></span>'}), l += "</div>"), l += "</div>", this.each(function (n, d) {
            function p(e) {
                w(e, f), g.trigger("suggestion.hide")
            }

            function u(t, i) {
                "" !== e.trim(m.val()) && g.trigger("suggestion.show");
                var n = e(t || "");
                D = -1, S = 0, n.length > 0 ? (S = n.length, n.each(function (t, a) {
                    var s = e(this);
                    s.text() === i && (n.removeClass("active"), s.addClass("active"), D = t)
                }), v.show(), b.length > 0 && b.hide()) : (v.hide(), b.length > 0 && (y.text(i), b.show())), v.html(n)
            }
            ...
            var m = e(t.input || ".suggestion-ipt", f).length > 0 ? e(t.input || ".suggestion-ipt", f) : e(".suggestion-ipt", f),
                ...
                b = e(t.blank, g).length > 0 ? e(t.blank, g) : e(".suggestion-blank", g), y = e(".suggestion-text", b),
                w = a(t.onChecked, f, i), $ = a(t.onHover, f, i), x = a(t.onShow, f, i), C = a(t.onHide, f, i), k = 0,
                T = !1, _ = !0, S = 0, D = -1;
            g.bind("suggestion.show", function () {
                ...
                if (!(g.is(":hidden") || 0 == S || T || 13 != t.keyCode && 38 != t.keyCode && 40 != t.keyCode)) {
                    ...
                    var n = e(".suggestion", f), a = n.height(), s = n.offset().top, o = i.height(), r = i.offset().top,
                        c = v.parent().scrollTop();
                    r < s ? v.parent().scrollTop(c - (s - r)) : r + o > s + a && v.parent().scrollTop(c + (r + o - (s + a))), $(e("li.active", v), f)
                }
    ...
    function a(e, t) {
        for (var i = t.length, a = "", s = 0; s < i; s++) a += n(e, t[s]);
        return a
    }
        ...
        b.push(t), y || e.ajax({
            url: "/wapi/zpCommon/data/city.json", type: "get", dataType: "json", success: function (e) {
                if (0 == e.code) {
                    ...
                    var t = e.zpData.cityList, i = t.length, a = e.zpData.hotCityList, s = a.length,
                        o = {code: 1e8, name: "鐑棬", subLevelModelList: a, firstChar: "a", rank: 0, index: 0};
                    ...
                    for (var w, $ = 0; $ < s; $++) a[$].index = $, w = 1e4 * parseInt(a[$] / 1e4), u[w] && (a[$].provinceCode = u[w].code, a[$].province = u[w].name, a[$].provinceIndex = u[w].index), h[a[$].code] = a[$], h[a[$].name] = a[$];
                    v = !0, y = !0;
                    for (var x; x = b.shift();) x()
                }
            }
        })
    }
    ...
    var c = t, l = c.document, d = [], p = {}, u = {}, h = {}, f = null,
        m = '<li data-code="$code$" data-name="$name$">$name$</li>', g = "", v = !1, b = [], y = !1;
    e.fn.citySelector = function (t) {
        ...
        e(this).length && r(function () {
            ...
            i.each(function () {
                function r(e, t) {
                    var i = y.height(), n = y.offset().top, a = e.height(), s = e.offset().top, o = t.height(),
                        r = t.offset().top, c = w.scrollTop(), l = $.scrollTop();
                    s < n ? w.scrollTop(c - (n - s)) : s + a > n + i && w.scrollTop(c + (s + a - (n + i))), r < n ? $.scrollTop(l - (n - r)) : r + o > n + i && $.scrollTop(l + (r + o - (n + i)))
                }

                function d() {
                    var t = e("li", w).removeClass("active").eq(x).addClass("active"),
                        i = e("li", $).removeClass("active").eq(C).addClass("active");
                    0 === k ? ($.removeClass("city-selector-cur"), w.addClass("city-selector-cur")) : (w.removeClass("city-selector-cur"), $.addClass("city-selector-cur")), r(t, i)
                }
                ...
                var v = e(t.input || ".suggestion-ipt", g).length > 0 ? e(t.input || ".suggestion-ipt", g) : e(".suggestion-ipt", g),
                    b = (e(t.input || ".suggestion-ipt", g).length > 0 ? e(t.input || ".suggestion-ipt", g) : e(".suggestion-ipt", g), e.trim(v.val())),
                    y = e(".city-selector", g), w = e(".city-selector-province", g), $ = e(".city-selector-citys", g),
                    x = 0, C = 0, k = 0, T = !0, _ = !1, S = s(t.onChecked, g, i), D = s(t.onHover, g, i),
                    E = s(t.onShow, g, i), j = s(t.onHide, g, i);
                y.bind("selector.show", function () {
                    y.is(":hidden") && (y.show(), E())
                }), y.bind("selector.hide", function () {
                    y.is(":visible") && (y.hide(), j())
                }), w.html(o), u(), b && m(b), v.is(":focus") && y.trigger("selector.show"), w.on("mouseenter", function (e) {
                    k = 0, d()
                }), $.on("mouseenter", function (e) {
                    k = 1, d()
                }), e("li", w).on("mouseenter", function (t) {
                    var i = e("li", w).index(this);
                    ...
                    if (!(y.is(":hidden") || 13 != i && 37 != i && 38 != i && 39 != i && 40 != i)) {
                        ...
                        var a = e("li", w).length - 1, s = e("li", $).length - 1;
                        x < 0 ? x = a : x > a && (x = 0), C < 0 ? C = s : C > s && (C = 0), n ? u() : d()
                    }
                        ...
                        e.ajax({
                            ...
                            success: function (t) {
                                if (t && t.data instanceof Array) {
                                    for (var n = t.data, s = n.length, o = [], r = 0; r < s; r++) o.push(p[n[r].code]);
                                    i(e(a(c, o)))
                                }
                            }
                        })
    ...
    var t, i = {
        get: function (e) {
            ...
            return void 0 === e ? s = 0 : e < 0 && (s = this[0].value.length + s), void 0 !== i && (a = i >= 0 ? s + o : this[0].value.length + o), n[t].set.apply(this, [s, a]), this
        ...
        xul: {
            ...
            get: function (e) {
                ...
                var n = 0, a = 0, s = this[0].value.length, o = this[0].value.replace(/\r\n/g, "\n"),
                    r = this[0].createTextRange(), c = this[0].createTextRange();
                r.moveToBookmark(t.getBookmark()), c.collapse(!1), -1 === r.compareEndPoints("StartToEnd", c) ? (n = -r.moveStart("character", -s), n += o.slice(0, n).split("\n").length - 1, -1 === r.compareEndPoints("EndToEnd", c) ? (a = -r.moveEnd("character", -s), a += o.slice(0, a).split("\n").length - 1) : a = s) : (n = s, a = s);
                var i = {position: n, start: n, end: a, length: s, text: t.text};
                return void 0 === e ? i : i[e]
            }, set: function (e, t) {
                ...
                if (void 0 !== i) {
                    ...
                    i.collapse(!0), i.moveEnd("character", a), i.moveStart("character", n), i.select()
                }
            }, replace: function (e) {
    ...
    e.fn.extend({
        textrange: function (n) {
            var a = "get", s = {};
            return void 0 === this[0] ? this : ("string" == typeof n ? a = n : "object" == typeof n && (a = n.method || a, s = n), void 0 === t && (t = "selectionStart" in this[0] ? "xul" : document.selection ? "msie" : "unknown"), "unknown" === t ? this : (s.nofocus || document.activeElement === this[0] || this[0].focus(), "function" == typeof i[a] ? i[a].apply(this, Array.prototype.slice.call(arguments, 1)) : void e.error("Method " + a + " does not exist in jQuery.textrange")))
        }
    })
}), function (e) {
    "function" == typeof define && define.amd ? define(["jquery"], e) : e("object" == typeof exports ? require("jquery") : jQuery)
    ...
    function o(e, i) {
        for (var n = e.split(/[\n\r]/g), a = 0, s = -1, o = 0, r = 0, c = 0, l = 0, d = 0, p = 0; p < n.length; p++) d = t(i, a, n[p]), d && (1 == d ? (s = p, r = i.start - l) : 2 == d && (c = i.end - l), o++), l += n[p].length + 1, a += n[p].length + 1;
        return 0 == c && (c = r), {startLine: s, startLineIndex: r, lineCount: o, endLineIndex: c}
    }

    function r(e, t) {
        for (var r, c, d, p = e.val(), u = e.textrange("get"), h = u.start, f = 0, m = p.split(/[\n\r]/g), g = o(p, u), v = g.startLine, b = g.startLineIndex, y = g.endLineIndex, w = g.lineCount, $ = t ? n(m[v]) : i(m[v]), x = m[Math.max(v - 1, 0)].match(l), C = t ? x && x[4] ? x[4] : "." : "鈼�", k = x && x[3] ? parseInt(x[3]) : 0, T = 0, _ = 0; _ < w; _++) c = _ + v, r = m[c], T = r.length, $ ? r = a(r) : (k++, r = s((t ? k : "") + C, r)), d = r.length - T, c === v ? (h += b + d < 0 ? -1 * b : d, h = Math.max(h, 0), f += 1 == w ? y - b : r.length - Math.max(b + d, 0)) : f += _ == w - 1 ? Math.max(y + d, 1) : r.length, _ > 0 && f++, m[c] = r;
        e.val(m.join("\n")).textrange("set", h, f).focus().trigger("input")
    }

    var c = /^((\s+)?鈼�(\s+)?)/,
        l = /^((\s+)?(\d+)([\.|銆乚)(\s+)?)/,d=/^((\s+)?(((\d+)([\.|銆乚))|鈼�))(\s+)?/;e.fn.extend({textarealist:function(t){var s=e.extend({wrapClass:".serial-wrap",btnNum:".serial-btn-num",btnBullet:".serial-btn-bullet"});this.each(function(){if(!this.__textareaListInited){this.__textareaListInited=!0;var t=e(this),c=t.closest(s.wrapClass).length>0?t.closest(s.wrapClass):t.parent(),l=e(s.btnNum,c);e(s.btnBullet,c).on("click",function(){r(t,!1)}),l.on("click",function(){r(t,1)}),t.on("keyup",function(s){if(13==s.keyCode){var c=t.val(),l=t.textrange("get"),d=c.split(/[\n\r]/g
...
Date.prototype.Format = function (e) {
    ...
    for (var t = {}, i = [], n = 0; n < this.length; n++) {
        var a = this[n], s = !!e && typeof t[a] != typeof a;
        (void 0 === t[a] || s) && (t[a] = a, i.push(a))
    }
    return i
    ...
    for (var n = [], a = arguments.length >= 2 ? arguments[1] : void 0, s = 0; s < i; s++) if (s in t) {
        var o = t[s];
    ...
    for (t && (i = t), n = new Array(o), a = 0; a < o;) {
        var r, c;
        a in s && (r = s[a], c = e.call(i, r, a, s), n[a] = c), a++
    }
    return n
}), Array.prototype.indexOf || (Array.prototype.indexOf = function (e, t) {
    var i;
    ...
    for (var t, i = Object(this), n = i.length >>> 0, a = arguments[1], s = 0; s < n; s++) if (t = i[s], e.call(a, t, s, i)) return t
    ...
    for (1 < arguments.length && (n = t, s = !0), i = 0; a > i; ++i) this.hasOwnProperty(i) && (s ? n = e(n, this[i], i, this) : (n = this[i], s = !0));
    ...
    s.prototype = {
        init: function () {
            var n = this, a = n.$element, s = a.children("ul"), o = s.children("li"), r = o.length, c = n.options.start,
                l = 0, d = 0;
            ...
            var h = function () {
                var e = a.width(), t = n.options.height / n.options.width * e;
                a.css("height", t)
            };
            if (a.css("height", n.options.height), h(), e(t).resize(function () {
                h()
                ...
                f = setInterval(m, n.options.interval), a.hover(function () {
                    f = clearInterval(f)
                }, function () {
            ...
            n.options.touch && o.on({
                touchstart: function (e) {
                    ...
                    var t = e.originalEvent.changedTouches[0].clientY, i = e.originalEvent.changedTouches[0].clientX,
                        a = l - t, s = d - i;
                    Math.abs(s) > Math.abs(a) && (s > 5 ? (c >= r ? c = 1 : c += 1, n.moveTo(c, "next")) : (1 == c ? c = r : c -= 1, n.moveTo(c, "prev"))), l = null, d = null
                }, touchmove: function (e) {
                    e.preventDefault && e.preventDefault()
                }
            })
        }, moveTo: function (t, i) {
            var n = this, a = n.$element, s = n.clickable, o = a.find(".slider-dot i"),
                r = a.parent().find(".slider-nav a"), c = a.children("ul"), l = c.children("li");
            if (!s) return !1;
...
var Storage = {
    ...
    init: function () {
        ...
        $.post({
            url: "/wapi/zpuser/h5/user/report/getAllReason", data: e, success: function (e) {
                0 == e.code ? e && e.zpData && e.zpData.length ? ($("#toast").remove(), Report.handleReportTypeListDom(e.zpData)) : $.toast({
                    type: "error",
                    content: "涓炬姤鍒楄〃閿欒锛岃绋嶅悗鍐嶈瘯"
                }) : 7 == e.code && void 0 !== Detail ? (Detail.showSign(1011), $("#toast").remove()) : $.toast({
                    content: e.message,
                    type: "error"
                })
            }, error: function (e) {
        ...
        $("body").css("overflow", "hidden"), $.dialog({
            title: "閫夋嫨涓炬姤绫诲瀷",
            content: i,
            inline: !0,
            confirmText: !1,
        ...
        $.get("/wapi/zpuser/wap/report/random", function (a) {
            0 == a.code ? ($("#toast").remove(), $.dialog({
                ...
                onOpen: function (e) {
                    "FormsUI" in window && FormsUI.dropSelect(e), "DropDown" in window && DropDown.init(e), t.length || $(".pop-report .form-row-choice").hide(), e.find(".verify-box img").on("click", function () {
                ...
                onClose: function () {
                    $(".dialog-report-type-list").remove(), $("body").css("overflow", "auto")
                }
        ...
        el.fileupload({
            ...
            add: function (e, t) {
                var i = t.files[0], n = i.name, a = i.size;
                return fileInfo = i, typeRule.test(n) ? a > maxSize ? void $.toast({
        ...
        var a = e, s = $.trim(a.find("textarea").val()), o = !1, r = this, c = "", l = "", d = [], p = "";
        if (n.length && (a.find(".active").each(function () {
            d.push($(this).attr("data-code"))
        }), !(d = d.join(",")))) return $.toast({type: "error", content: "璇峰厛閫夋嫨璇存槑鏍囩"}), !1;
        a.find(".ipt-wrap").each(function () {
            return o = r.checkForm($(this)), r.checkForm($(this))
        }), a.find(".preview img").each(function () {
            c += $(this).attr("data-img") + ","
        }), c = c.substring(0, c.length - 1), "" != t ? (l = t, p = i) : "_reportData" in window ? (l = _reportData.reportedId, p = _reportData.targetId) : (l = Chat.curUserData.uid, p = Chat.curUserData.infoData.expectId);
        var u = {
            reportedId: l,
        ...
        return o && (o = !1, $.ajax({
            ...
            success: function (t) {
                0 === t.code ? ($.toast({
                    ...
                    content: t.message,
                    type: "error"
                }), "楠岃瘉鐮侀敊璇�" == t.message && (a.find(".verify-box .ipt").val("").focus(), a.find(".verify-box img").click()))
            },
            error: function (e) {
            }
        })), !1
...
var Block = function () {
        ...
        function t(t) {
            var i = t, n = t.content || s({title: i.title, description: i.description});
        ...
        function i(t, i) {
            ...
            var n, a = {}, o = function (e, t) {
                ...
                if ("vip" == $(".hot-list-tab .checked").attr("data-cls")) return a.vip.type = "vip", a.vip;
                var e = $("input[name=ordinary]").filter(":checked"), t = e.attr("data-type"), i = e.attr("data-index");
                return selected = a[t][i], selected.type = t, selected.activityType = a.activityType, selected.activityEndDate = a.activityEndDate, selected.ba = a.ba, selected
            }, d = function (e) {
                var t = function (e) {
                ...
                open: function (e) {
                    ...
                    if (t.on("change", "input[name='ordinary']", function () {
                        var i = $(this).attr("data-type"), n = $(this).attr("data-index"), s = a[i][n];
                        o(e.$confirmButton, s.pay), t.find("." + i + "-view").text(s.view), t.find("." + i + "-employ").text(s.employ)
                        ...
                        e.$btnc.append(Utemplate('<p class="trial">鎮ㄦ湁涓€娆″厤璐逛綋楠屾満浼氾紝鍙厤璐硅瘯鐢ㄧ伀鐖嗚亴浣嶆櫘閫氱増<%this.expiredays%>澶╋紝<a href="javascript:">鐐瑰嚮鍏嶈垂浣跨敤</a></p>', a.experience))
                    }
                    d(t)
                }, next: function () {
                    var e = r();
            ...
            i.canBuyVip ? function () {
                $.when(u({sf: i.sf || "", vipPriceId: i.vipPriceId}), h(t)).then(function (t, n) {
                    ...
                    var o = $.extend(p, i);
                    e(o, s({title: o.title, description: o.description}) + l.storm(t.detailPage, n))
                })
            }() : function () {
                var n = function (t) {
                    a = t;
                    var n = $.extend(p, i);
                    e(n, s({title: n.title, description: n.description}) + c.storm(t))
                };
        ...
        function n(t, i) {
            var n, a = function (t) {
                n = t;
                var a = i, r = s({title: a.title, description: a.description}) + o(t);
                a.next = function () {
                    var e = $("input[name=super]").filter(":checked").attr("data-index"), t = n.prices[e];
                    a.confirm(t)
                }, a.open = function (e) {
                    var a = e.$content, s = function (e, t) {
                        var n = (i.isEdit, "鍙戝竷");
                        e.text("浠樿垂" + n + "鑱屼綅锛氾骏" + t)
                    ...
                    }), a.find("input[name=super]").filter(":checked").trigger("change"), n.experience) {
        ...
        var s = function (e) {
            ...
            return -1 == e.view ? e.view = "鏃犱笂闄�" : e.view = e.view,
            ...
            u(t).then(function (n) {
                var a = i,
                    o = s({title: a.title || "鍙戝竷鏅€氳亴浣嶄釜鏁板凡杈句笂闄�", description: a.description}) + l.vip(n.detailPage);
                a.style = "pop-vip", a.cancelText = "鎴戝啀鎯虫兂", a.confirmText = "寮€閫歏IP甯愬彿", a.next = function () {
                    i.confirm({
                        ba: n.detailPage.ba,
        ...
        return {
            confirm: t, purchase: i, supermethod: n, upgrade: a, vip: f, action: function (e, t) {
        ...
        var e = {}, t = {
            ...
            var t = $(".direct-card-pop .position-category .selected"), i = t.length > 0 ? t.length : 0,
                n = Math.min(i, e.positionDiscount.length - 1), a = e.positionDiscount[n],
            ...
            return {amount: s / 1e3, discount: a, save: t.length > 0 ? Math.ceil(s / 1e3 - o) : 0, pay: o}
        }, s = function () {
            var e = a(), t = "閫夋嫨鏇村鑱岀被缃《锛屾彁鍗囨嫑鑱樻晥鏋滐紝鍙韩棰濆鎶樻墸";
            if (e.discount > 0) {
            ...
            $.dialog({
                ...
                onOpen: function (i) {
                    ...
                    $(i).on("click", ".bead-close", function () {
                        ...
                        a.close(), t.prop(e.jobId).then(function (e) {
                            r(e)
        ...
        _picCount: 0, _limitPicCount: 3, getContent: function () {
                ...
                $.dialog({
                    ...
                    onOpen: function (t) {
                        var i = t.find(".upload-pics"), n = t.find(".upload-pic-btn"),
                            a = t.find(".upload-pic-btn-wrapper"), s = t.find(".verify-box");
                        Feedback._picCount = 0, s.find("img").on("click", function () {
                            ...
                            s ? e.checkForm(s) ? e.uploadPicture(i, t) : n.preventDefault() : e.uploadPicture(i, t)
                        }), i.on("click", ".remove-pic", function (e) {
                            $(this).closest(".upload-pic").remove(), --Feedback._picCount, i.children(".upload-pic").length < Feedback._limitPicCount && a.show()
                        })
                    },
            ...
            i.find(".ipt-wrap").each(function () {
                return t = a.checkForm($(this)), a.checkForm($(this))
            });
            var s = {
                content: n,
            ...
            if (void 0 != e.find(".ipt").attr("data-range")) {
                ...
                if (i = a[0], t = a[1], n.length > t) return e.next(".text-error").html("璇疯緭鍏�" + t + "涓瓧浠ュ唴鐨勫唴瀹�"), !1;
                if (e.next(".text-error").html(""), n.length < i) return e.next(".text-error").html("鍐呭鎻忚堪鑷冲皯" + i + "涓瓧"), !1;
                e.next(".text-error").html("")
            }
            if ("" == n) {
                var s = e.find(".ipt").attr("data-blank");
                return e.find(".ipt").focus(), e.next(".text-error").html(s), !1
            }
            return e.next(".text-error").html(""), !0
        }
    ...
    COOKIE_DOMAIN = function () {
        ...
        function e(e, i) {
            var n = (new Date).getTime() + 2304e5, a = "";
            try {
                a = (new t).z(e, parseInt(i) + 60 * (480 + (new Date).getTimezoneOffset()) * 1e3)
            } catch (e) {
            }
            if (a && (Cookie.set(GATEWAY_TOKEN_NAME, a, n, COOKIE_DOMAIN, "/"), void 0 !== window.wst && "function" == typeof window.wst.postMessage)) {
                var s = {
                    name: "setWKCookie",
                    params: {
                        url: COOKIE_DOMAIN,
            ...
            return Cookie.del(GATEWAY_SEED_NAME, COOKIE_DOMAIN, "/"), Cookie.del(GATEWAY_SCRIPT_NAME, COOKIE_DOMAIN, "/"), Cookie.del(GATEWAY_TS_NAME, COOKIE_DOMAIN, "/"), a
        }

        var t, i = {}, n = document.createElement("iframe");
        return n.style.display = "none", n.name = "zhipinFrame", (document.body || document.documentElement).appendChild(n), function (a, s, o) {
            if (a && s && o || (a = Cookie.get(GATEWAY_SEED_NAME), s = Cookie.get(GATEWAY_SCRIPT_NAME), o = Cookie.get(GATEWAY_TS_NAME)), a && s && o) return i["" + s] ? void e(a, o) : void loadGatewayScript(SECURITY_SCRIPT_PATH + s + ".js", function () {
                i["" + s] = 1, t = n.contentWindow.ABC, e(a, o)
            }, n)
        }
    }();
$(function () {
...
myCookie.getCookie = function (e) {
    ...
    var n = getsec(i), a = new Date;
    a.setTime(a.getTime() + 1 * n), document.cookie = e + "=" + escape(t) + ";expires=" + a.toGMTString()
    ...
    function a() {
        var e = (v.offset().top, $(window).scrollTop(), $("body").outerHeight(), w.height(), $(window).height() - ($("#footer").offset().top - $(document).scrollTop()));
        e > 0 ? b.css("bottom", e) : b.css("bottom", 0)
    }
        ...
        init: function (e) {
            ...
            this.getTagData().then(function (n) {
                if (0 == n.code && n.zpData) {
                    ...
                    if (0 == a.length) return i = t.errorTips("notHave"), void e(i);
                    i = 4 == t.curTab.index ? c.getInterviewTemplate(a) : c.getOtherTemplate(a)
            ...
            var t = this, i = "", n = "", a = "", s = "", o = "", r = "";
            return $.each(e, function (e, c) {
                a = "", s = "/job_detail/" + c.encryptJobId + ".html", o = c.salaryDesc, 2 == c.jobValidStatus && (a = "opacity", s = "javascript:;", o = "鍋滄鎷涜仒"), c.salaryMonthText && (r = "路" + c.salaryMonthText), 1 == t.curTab.index && (i = '<button class="btn btn-primary btn-small btn-sider-interest"  data-jobid="' + c.encryptJobId + '">绉婚櫎</button>');
                var l = c.brandStageName ? '<span class="vline"></span><span>' + c.brandStageName + "</span>" : "",
                    d = "";
                1 == c.proxyType ? d = '<img class="job-medium-icon" src="https://z.zhipin.com/web/geek/resource/job-medium-icon2.png" alt="浠ｆ嫑鑱屼綅">' : 3 == c.proxyType && (d = '<img class="job-medium-icon" src="https://z.zhipin.com/web/geek/resource/job-medium-icon3.png" alt="娲鹃仯鑱屼綅">'), n += '                         <li class="' + a + '">                            <a href="' + s + '">                                <h4><span class="sider-degree">' + o + r + '</span><span class="sider-position-title"><span class="title-text' + (1 == c.proxyType || 3 == c.proxyType ? "" : " no-medium") + '">' + c.jobName + "</span>" + d + '</span></h4>                                <p class="company-info">                                    <span>' + c.brandName + "</span>" + l + '                                </p>                                <p>                                    <img class="user-avatar" src="' + c.bossAvatar + '" alt=""/>                                    <span class="user-text">' + c.bossName + '<span class="vline"></span>' + c.bossTitle + "</span>                                    " + i + "                                </p>                            </a>                        </li>"
            ...
            for (var a in n) {
                var s = new Date(n[a][0].appointmentDate), o = s.getDate(), r = +s.getMonth() + 1;
                i = "", $.each(n[a], function (e, t) {
                ...
                }), t += '                <div class="oneday-wrap ' + a + '" data-value = "' + a + '">                <p class="interview-time"> ' + n[a][0].appointmentWeekDesc + " <span>" + r + "鏈�" + o + '鏃�</span></p>                <ul class="interview-list">                ' + i + "                </ul>                </div>"
            }
            ...
            $("body").on("click", "#siderbar .siderbar-top li a", function (e) {
                ...
                var i = $(this), n = i.closest("li").index(), a = i.closest(".oneday-wrap").attr("data-value"),
                    s = t.target;
                return $(s).hasClass("btn-submit") ? c.showInviteTip(function () {
                    ...
                    e.interviewData[a].splice(n, 1), i.closest("li").find(".interview-status").html("宸叉嫆缁�").end().slideUp(300, function () {
                        $(this).remove(), 0 == e.interviewData[a].length && $("." + a).remove()
                    })
                }), !1
    ...
    if ($(window).scroll(function () {
        ...
        return $(this).each(function () {
            $(this).hover(function () {
                clearTimeout(i), t = setTimeout(a.hoverEvent, a.hoverDuring)
            }, function () {
                clearTimeout(t), i = setTimeout(a.outEvent, a.outDuring)
            })
        })
    }, $(".city-page-btn.next").on("click", function () {
        $(".slider-city-li").animate({left: "-792px"}), $(".city-page-btn.next").hide(), $(".city-page-btn.prev").show()
    ...
    $(".top-sign-box .btn-dialog-upload").on("click", m),
            ...
            success: function (e) {
                if (0 == e.code && e.zpData && e.zpData.length > 0) {
                    ...
                    $.each(e.zpData, function (e, n) {
                        var a = window._PAGE || {};
                        n.name + "绔�" === a.citySiteName ? t = n : i += '<li class="city-item"><a ka="city-sites-' + n.code + '" href="' + n.url + '">' + n.name + "绔�</a></li>"
                    });
    ...
    if ($(".manager-list .manager-inner").length && $(".manager-list li").length > 1 && ($(".manager-list h3").css("background", "none"), $(".manager-list .manager-inner").hwSlider({
        ...
        t.hoverDelay({
            hoverDuring: 100, outDuring: 100, hoverEvent: function () {
                ...
                if ($(".top-sign-box").length && (a = 130), $(".top-active-box").length && (s = 120), n = a + s, 0 != e || 10 == e && $(".ie7").length) {
        ...
        var t = $(this), i = t.find(".info-primary a"), n = i.attr("href"), a = $(".job-tab"),
            s = a.attr("data-keyword"), o = a.attr("data-l3code"), r = a.attr("data-filter"),
            c = a.attr("data-rescount"), l = a.attr("data-page"), d = i.attr("data-index"), p = i.attr("data-lid"),
            u = i.attr("data-itemid"), h = a.attr("data-lid"), f = i.attr("data-jobid");
        ...
        if ("A" == e.target.nodeName && e.target.href.indexOf("job_detail") > -1) {
            var m = e.target.getAttribute("href"), g = e.target.getAttribute("data-lid"),
                v = e.target.getAttribute("ka"), b = $(e.target);
            return b.wrap('<form action="' + m + '" method="get" target="_blank"></form>'), b.append('<input type="hidden" name="ka" value="' + v + '_blank" />'), b.append('<input type="hidden" name="lid" value="' + g + '" />'), b.closest("form").submit(), b.find('input[name="ka"]').remove(), b.find('input[name="lid"]').remove(), b.unwrap("form"), !1
        }
        var y = {
            keyword: s,
            l3code: o,
        ...
        var t = $(this), i = t.parents(".job-list").find("li").first().find(".info-primary a"),
            n = (i.attr("href"), $(".job-tab")), a = n.attr("data-keyword"), s = n.attr("data-l3code"),
        ...
        $.ajax({
            type: "POST",
            url: "/wapi/zpCommon/actionLog/search.json",
            data: {keyword: a, l3code: s, filter: o, rescount: r, page: c, index: l, lid: d, itemid: 0, source: p},
            dataType: "json",
            success: function (e) {
            }
        })
        ...
        var t = $(this), i = t.parent().attr("data-jid"), n = t.parent().attr("data-lid"), a = "", s = !1;
        (i || n) && t.hoverDelay({
            hoverDuring: 400, outDuring: 500, hoverEvent: function () {
                ...
                if ("" === t.find(".info-detail").text()) $.ajax({
                    ...
                    e < o + 18 && t.parent().find(".info-detail").css("top", -(o - e + 18) + "px"), t.parent().addClass("cur"), a = setTimeout(function () {
                        try {
                            _T.sendEvent("show_popjob_" + i)
                        } catch (e) {
                        }
                ...
                s || (clearTimeout(a), t.parent().removeClass("cur"), t.parent().find(".info-detail").css("top", 0))
            }
        })
        ...
        var v = $("#footer"), b = $(".footer-scan"), y = $(".home-box .job-list"), w = $(window);
        y.css("margin-bottom", "105px"), a(), $(window).scroll(function () {
            a()
        }), b.find(".footer-scan-close").click(function () {
    ...
    if ($(window).width() < 1348 && $(".footer-scan .btns").css("margin-right", "84px"), $(window).resize(function () {
        ...
        if (!$(".chat-bot-iframe-mask").length) {
            ...
            $("body").append('        <div class="chat-bot-iframe-mask">            <iframe                class="chat-bot-iframe"                src="/web/wisdomstone/index.html">            </iframe>        </div>'), window.addEventListener("message", function (e) {
        ...
        if ($(this).parents("h3").first().find("span").removeClass("cur"), $(this).addClass("cur"), $(t).find("ul").removeClass("cur"), $(t).find("ul").eq(e).addClass("cur"), s($(t).find("ul").eq(e)), t.hasClass("job-tab-box")) {
            var i = t.find(".cur li").first();
            i.attr("data-url") && t.find(".common-tab-more a").attr("href", "/" + i.attr("data-url"))
        }
    }), s($(".common-tab-box ul.cur")), $(".job-menu-school dl").each(function (e) {
        var t = $(this);
        t.hoverDelay({
            hoverDuring: 100, outDuring: 100, hoverEvent: function () {
        ...
        $("#header").append('<div class="school-nav-box"><a href="/xiaoyuan/"><div class="img-box xiaoyuan"></div></a><a href="/xiaoyuan/renshebu/"><div class="img-box renshebu"></div></a><a href="/xiaoyuan/yangshi/"><div class="img-box yangshi"></div></a><a href="/xiaoyuan/fupin/"><div class="img-box fupin"></div></a></div>');
    ...
    ({
        ...
        hoverTimer: null,
        init: function () {
            this.renderCodeDiv(), this.$recommendBox[0] && (this.$recommendBox.before([$('<ul class="sub-ul-box sub-ul-0"></ul>').css({
                display: "none",
                "min-height": "40px",
                width: "104%"
                ...
                "min-height": "40px",
                width: "104%"
            })]), this.getRecommendInfo()), this.initEvent()
        },
        initEvent: function () {
            var e = this;
            $(document).on("mouseenter", "#main .guide-app-download-icon", function () {
                var t = $(this), i = $(this)[0].getBoundingClientRect().left,
                    n = $(this)[0].getBoundingClientRect().top;
                document.querySelector(".guide-download-app-v62").style.display = "block", document.querySelector(".guide-download-app-v62").style.top = n - 20 + "px", document.querySelector(".guide-download-app-v62").style.left = i + 24 + "px", e.hoverTimer && clearTimeout(e.hoverTimer), e.hoverTimer = setTimeout(function () {
                    try {
                        var e = "";
                        e = t.parent().parent().parent().parent().data("data") ? t.parent().parent().parent().parent().data("data").encryptJobId : t.parent().parent().attr("href").split("/job_detail/")[1].split(".html")[0], _T.sendEvent("sanwu_downloadapp", "0", e)
                    } catch (e) {
                    }
                }, 2e3)
                ...
                t.stoppropagation, e.activeTabid = 1 * $(this).index() + 1, e.$container.find(".sub-ul-box").hide(), e.$container.find(".sub-ul-" + $(this).index()).show()
        ...
        renderCodeDiv: function () {
            $(".guide-download-app-v62")[0] || $(document.body).append('<div class="guide-download-app-v62" style="display:none"><div class="app-icon-arrow"></div><div class="app-icon-v62"></div><div class="app-icon-des-v62">涓€閿壂鐮�  闅忔椂娌熼€�</div></div>')
        },
        renderRecommend1: function (e, t) {
            this.$container.find(".sub-ul-0").empty();
            for (var i = 0; i < e.length; i++) this.$container.find(".sub-ul-0").append(this.renderCard1(e[i], i, t))
        },
        renderRecommend2: function (e, t) {
            this.$container.find(".sub-ul-1").empty();
            for (var i = 0; i < e.length; i++) this.$container.find(".sub-ul-1").append(this.renderCard2(e[i], i, t))
        },
        isShowRecommendBox: function () {
            this.$container.find("h3>span").hide(), this.$container.find(".sub-ul-box").hide(), this.recommendData1.length > 0 && (this.$container.show(), this.$container.find("h3>span").eq(0).show()), this.recommendData2.length > 0 && (this.$container.show(), this.$container.find("h3>span").eq(1).show()), this.$container.find("h3>span").eq(0).trigger("click")
        },
        renderCard1: function (e, t, i) {
            var n = "";
            e.cityName && (n = e.cityName), e.areaDistrict && (n = n ? n + "路" + e.areaDistrict : e.areaDistrict), e.businessDistrict && (n = n ? n + "路" + e.businessDistrict : e.businessDistrict);
            var a = "";
            e.jobLabels[1] && (a = e.jobLabels[1]), a && e.jobLabels[2] && (a = a + '<span class="vline"></span>' + e.jobLabels[2]);
            var s = "", o = "";
            1 == e.proxyType && (o = '<img class="job-daizhao-icon" src="https://z.zhipin.com/web/geek/resource/job-medium-icon2.png" alt="浠ｆ嫑鑱屼綅">'), 3 == e.proxyType && (s = '<img class="job-paiqian-icon" src="https://z.zhipin.com/web/geek/resource/job-medium-icon3.png" alt="娲鹃仯鑱屼綅">');
            var r = $("#page_key_name").val() || "";
            if (e.anonymous > 0) var c = $('<li><div class="sub-li"><a href="/job_detail/' + e.encryptJobId + ".html?pk=" + r + "&ka=rcmd_list_job_" + (1 * t + 1) + "_blank&lid=" + e.lid + "&sessionId=" + i + '" ka="rcmd_list_job_' + t + '" class="job-info" target="_blank"><div class="sub-li-top"><p class="name">' + (filterXss(e.jobName) || "") + "</p>" + s + o + '<div class="guide-app-download-icon"></div><p class="salary">' + (e.salaryDesc || "") + '</p></div><p class="job-text">' + a + '</p></a><div class="sub-li-bottom"><a href="javascript:;"  class="user-info"><p><img src="' + filterXss(e.brandLogo) + '"></p></a><a href="javascript:;" ka="rcmd_list_company_' + t + '" class="sub-li-bottom-commany-info"><span class="name">' + (filterXss(e.brandName) || "") + '</span></a><div class="sub-li-bottom-commany-place"><i class="job-card-location"></i><span class="name">' + n + "</span></div></div></div></li>"); else var c = $('<li><div class="sub-li"><a href="/job_detail/' + e.encryptJobId + ".html?pk=" + r + "&ka=rcmd_list_job_" + (1 * t + 1) + "_blank&lid=" + e.lid + "&sessionId=" + i + '" ka="rcmd_list_job_' + t + '" class="job-info" target="_blank"><div class="sub-li-top"><p class="name">' + (filterXss(e.jobName) || "") + "</p>" + s + o + '<div class="guide-app-download-icon"></div><p class="salary">' + (e.salaryDesc || "") + '</p></div><p class="job-text">' + a + '</p></a><div class="sub-li-bottom"><a href="/gongsi/' + (e.encryptBrandId || "") + ".html?ka=rcmd_list_company_" + (1 * t + 1) + '" ka="rcmd_list_company_' + t + '"  class="user-info" target="_blank"><p><img src="' + filterXss(e.brandLogo) + '"></p></a><a href="/gongsi/' + (e.encryptBrandId || "") + ".html?ka=rcmd_list_company_" + (1 * t + 1) + '" ka="rcmd_list_company_' + t + '" class="sub-li-bottom-commany-info" target="_blank"><span class="name">' + (filterXss(e.brandName) || "") + '</span></a><div class="sub-li-bottom-commany-place"><i class="job-card-location"></i><span class="name">' + n + "</span></div></div></div></li>");
        ...
        getPushRecommendInfo: function (e) {
            ...
            $.ajax({
                type: "get", url: n, dataType: "json", async: !1, success: function (i) {
                    i && 0 == i.code && i.zpData && i.zpData.jobList && (i.zpData.jobList.length > 9 && (i.zpData.jobList = i.zpData.jobList.slice(0, 9)), t["renderRecommend" + e](i.zpData.jobList, i.zpData.sessionId), t["recommendData" + e] = i.zpData.jobList)
                }
            })
        },
        getRecommendInfo: function (e) {
            ...
            $.ajax({
                ...
                dataType: "json",
                success: function (e) {
                    e && 0 == e.code && e.zpData && e.zpData.expectList && (t.renderRecommendSelect(e.zpData.expectList), t.getPushRecommendInfo(1), t.getPushRecommendInfo(2), t.isShowRecommendBox())
                }
            })
        },
        renderRecommendSelect: function (e) {
            var t = e[0] || {};
            this.exceptId = t.id;
            var i = $('<div class="select-label"></div>'), n = $('<div class="select-dropdown-menu"></div>');
            ...
            for (var a = 0; a < e.length; a++) n.append($("<div >" + (e[a].locationName || "") + '<div class="vline"></div>' + (e[a].positionName || "") + '<div class="vline"></div>' + (e[a].salary || "") + "</div>").data("data", e[a]));
            i.append(n), $(".merge-city-job-recommend .dropdown-filter-geek-recommend").append(i), $(".merge-city-job-recommend .dropdown-filter-geek-recommend .select-dropdown-menu>div").eq(0).addClass("active")
        },
        ...
        notData: function (e, t) {
            t && t.length > 0 ? e.find(".not-data,.not-data-text").hide() : (e.find(".not-data")[0] ? e.find(".not-data,.not-data-text").show() : e.append($('<div class="not-data"></div><div class="not-data-text">鏆傛棤鑱屼綅</div>')), this.$recommendBox.hide())
        }
    }).init()
}();
var Search = {
    init: function () {
        ...
        Search.searchBox = $(".search-box"), Search.isLoading = !1, $(".bottom-banner .closeIcon").on("click", function () {
        ...
        }), Search.searchBox.length && (Search.loadIndustryData(Search.renderIndustry), Search.loadCityData()), Search.searchBox.find(".dropdown-menu").each(function () {
            function e(e) {
                s.length && (3 == s.attr("data-level") && s.html('<ul class="tree-1"></ul><ul class="tree-2"></ul><ul class="tree-3"></ul>'), 2 == s.attr("data-level") && s.html('<ul class="tree-1"></ul><ul class="tree-2"></ul>'), Search.getTreeData(s, e)), o.length && Resume.getTag(formEl, !0), t.on("mouseenter", "li", function () {
                    if ($(this).closest(".select-tree").length) {
                        ...
                        if ($(this).parent().find("li").removeClass("selected"), $(this).addClass("selected"), 3 == t) {
                            if ($(this).closest(".tree-1").length) return $(this).closest(".select-tree").find(".tree-3").hide(), Search.getTreeData(s, e, $(this).attr("data-id")), !1;
                            if ($(this).closest(".tree-2").length) return $(this).closest(".select-tree").find(".tree-3").show(), a.attr("level2", $(this).attr("data-id")), Search.getTreeData(s, e, $(this).closest(".select-tree").find(".tree-1 .selected").attr("data-id"), $(this).attr("data-id")), !1
                        }
                        if (2 == t) {
                            if ($(this).closest(".tree-1").length) return $(this).closest(".select-tree").find(".tree-3").hide(), Search.getTreeData(s, e, $(this).attr("data-id")), !1;
                            if ($(this).closest(".tree-2").length) return $(this).closest(".select-tree").find(".tree-3").show(), a.attr("level2", $(this).attr("data-id")), Search.getTreeData(s, e, $(this).closest(".select-tree").find(".tree-1 .selected").attr("data-id"), $(this).attr("data-id")), !1
                    ...
                    if (3 != e || $(this).closest(".tree-1").length || $(this).closest(".tree-2").length) {
                        ...
                        0 == $(this).attr("data-id") && (n.text("鑱屼綅绫诲瀷"), a.val($(this).attr("")), Search.searchBox.removeClass("show-position"))
                    } else n.text($(this).text()), a.val($(this).attr("data-val")), Search.searchBox.removeClass("show-position")
                })
            }

            var t = $(this), i = Search.searchBox.find(".position-sel"), n = i.find(".label-text b"),
                a = Search.searchBox.find(".position-code"), s = t.find(".select-tree"), o = t.find(".tags-cells");
            ...
            if ("鎼滅储鑱屼綅銆佸叕鍙�" == n && i.val(""), "" != n && window.localStorage) {
                ...
                if (a) if (-1 === a.indexOf(n)) a.unshift(n), Storage.set("_Search_History", a); else {
                    var s = [];
                    $(a).each(function (e, t) {
                        e >= 3 || t != n && s.push(t)
                    }), s.unshift(n), Storage.set("_Search_History", s)
                } else Storage.set("_Search_History", [n])
            }
        }), $(document).on("click", function (e) {
            $(e.target).closest(".city-sel").length || $(e.target).closest(".dorpdown-province").length || (Search.searchBox.removeClass("show-city"), $("#header .nav-city").length && !$(e.target).closest(".nav-city-box").length && $("#header .nav-city").removeClass("show-city")), $(e.target).closest(".position-sel").length || $(e.target).closest(".position-box").length || Search.searchBox.removeClass("show-position"), $(e.target).closest(".industry-sel").length || Search.searchBox.removeClass("show-industry"), $(e.target).closest(".suggest-result").length || $(e.target).closest(".ipt-search").length || Search.searchBox.find(".suggest-result").hide(), $(e.target).closest(".city-sel").length || Search.searchBox.find(".dropdown-city-menu").hide()
        }), Search.searchBox.find(".industry-box").on("click", " li a", function (e) {
            return "涓嶉檺" == $(this).text() ? Search.searchBox.find(".industry-sel").find(".label-text b").text("琛屼笟涓嶉檺") : Search.searchBox.find(".industry-sel").find(".label-text b").text($(this).text()),
                Search.searchBox.find(".industry-code").val($(this).parent().attr("data-val")), Search.searchBox.find(".industry-box ul .cur").removeClass("cur"), $(this).parent().addClass("cur"), e.preventDefault(), Search.searchBox.toggleClass("show-industry"), !1
        ...
        if (Search.searchBox.find(".ipt-search").keydown(function (e) {
            ...
            var a = ($(".select-city-wrapper").html(), $(".filter-box .expect").offset().top), s = $(".top-filter-bar");
            ...
            }), $(window).scrollTop() > a && s.addClass("show"), $(window).on("scroll", function () {
        ...
        $.ajax({
            type: "GET", url: "/wapi/zpCommon/data/city.json", data: {}, dataType: "json", success: function (e) {
        ...
        for (a = 0; a < t.length; a++) {
            ...
            if (r += '<li data-id="' + t[a].code + '">' + t[a].name + "</li>", d && i && t[a].code == i) for (s = 0; s < d.length; s++) {
                var p = d[s].subLevelModelList;
                if (c += '<li data-id="' + d[s].code + '">' + d[s].name + "</li>", p && n && d[s].code == n) for (o = 0; o < p.length; o++) l += '<li data-val="' + p[o].code + '">' + p[o].name + "</li>"
            }
        }
        ...
        $.ajax({
            ...
            success: function (e) {
                ...
                if (e.zpData && e.zpData.data && e.zpData.data.length) {
                    for (t = e.zpData.data, a = 0; a < t.length; a++) s += "<li>" + t[a].hlname + "</li>";
                    n.html(s), i.show()
        ...
        if (!e) return !1;
        var n = i.find("li").length, a = $(e).index(), s = a > 4 ? a - 4 : 0, o = "down" == t && (s < n - 4 || 0 === a),
            r = "up" == t && (a < n - 5 || a == n - 1);
        "up" == t && (s = a), (r || o) && i.scrollTop(s * $(e).height())
        ...
        $.ajax({type: "GET", url: "/wapi/zpCommon/data/cityGroup.json", dataType: "JSON"}).success(function (t) {
            if (0 == t.code) {
                ...
                var a = {ABCDE: [], FGHJ: [], KLMN: [], PQRST: [], WXYZ: []};
                n.forEach(function (e, t) {
                    /[ABCDE]/g.test(e.firstChar) && a.ABCDE.push(e), /[FGHJ]/g.test(e.firstChar) && a.FGHJ.push(e), /[KLMN]/g.test(e.firstChar) && a.KLMN.push(e), /[PQRST]/g.test(e.firstChar) && a.PQRST.push(e), /[WXYZ]/g.test(e.firstChar) && a.WXYZ.push(e)
                });
                for (var s in a) i.push({name: s, subLevelModelList: a[s]});
        ...
        if (t.length) return void t.toggle();
        ...
        var e = e || Search.searchBox.find(".search-form-con"), t = Search.cityData && Search.cityData.cityList;
        t.unshift({name: "鐑棬鍩庡競", subLevelModelList: Search.cityData.hotCityList});
        var i = "", n = "";
        t.forEach(function (e, t) {
            "鐑棬鍩庡競" == e.name && e.subLevelModelList.shift(), 0 == t ? (i += "<li>" + e.name + "</li>", e.subLevelModelList.forEach(function (e, i) {
        ...
        e.append(a);
        var s = 0, o = 0, r = function (t) {
            var i = t.secondCode, n = (t.name, t.thirdName || "");
            e.parents("form").find('input[name="city"]').val(i), e.parents("form").find('input[name="area"]').val(n), e.parents("form").find(".city-sel .label-text b").text(t.name), e.find(".dropdown-city-menu").hide()
        };
        e.find(".dropdown-province li").hover(function () {
            ...
            }), e.find(".dropdown-city").html(i), e.find(".city-box").find(".dropdown-third").remove(), $(this).addClass("cur").siblings().removeClass("cur")
        }), e.on("mouseover", ".dropdown-city li", function () {
            o = $(this).index();
            var i = "", n = t[s].subLevelModelList[o], a = n.subLevelModelList;
            a && a.length ? (a.forEach(function (e, t) {
                3 == e.cityType && (i += '<li ka="sel-subLevel-' + t + '" data-code="' + e.code + '">' + e.name + "</li>")
            }), i ? (i = '<li ka="sel-subLevel--1" data-code="' + n.code + '">' + n.name + "</li>" + i, e.find(".dropdown-third").length ? e.find(".dropdown-third").html(i) : e.find(".city-box").append('<ul class="dropdown-third">' + i + "</ul>")) : (e.find(".city-box").find(".dropdown-third").remove(), $(this).addClass("item-nocity"))) : (e.find(".city-box").find(".dropdown-third").remove(), $(this).addClass("item-nocity")), $(this).addClass("cur").siblings().removeClass("cur")
        }).on("click", ".dropdown-city li", function () {
            if ($(this).hasClass("item-nocity")) {
                var e = {};
                e.secondCode = $(this).attr("data-code"), e.name = $(this).text(), r(e)
            }
        }), e.on("click", ".dropdown-third li", function () {
            var e = {};
            e.secondCode = t[s].subLevelModelList[o].code, e.name = $(this).text(), e.thirdName = 0 == $(this).index() ? "" : $(this).text(), r(e)
        })
    }
};
$(function () {
...
var Detail = {
    hoverTimer: null, init: function (wrap) {
        function showBanner() {
        ...
        function setPopjobTop(e, t, i) {
            var n = e.find(".info-detail"),
                a = document.documentElement.clientHeight - t.get(0).getBoundingClientRect().top, s = n.height();
            a < s + 18 && n.css("top", -(s - a + 18) + "px"), e.addClass("cur"), hoverTimer = setTimeout(function () {
                try {
                    _T.sendEvent("show_popjob_" + i)
                } catch (e) {
                }
        ...
        function deleteRow(e) {
            for (var t = e.rows.length, i = t - 1; i >= 4; i--) deletedRows.unshift(e.rows[i].outerHTML), e.deleteRow(i)
        }

        function insertRow(e) {
            for (var t = e.rows.length + deletedRows.length, i = 4; i < t; i++) e.insertRow(i).outerHTML = deletedRows.shift()
        }
        ...
        }), $(".job-detail-guide-download-app-v62")[0] || $(document.body).append('<div class="job-detail-guide-download-app-v62" style="display:none"><div class="app-icon-arrow"></div><div class="app-icon-v62"></div></div>'), $(document).on("mouseenter", "#main .info .job-detail-guide-download-app", function () {
            var e = $(this)[0].getBoundingClientRect().left, t = $(this)[0].getBoundingClientRect().top;
            document.querySelector(".job-detail-guide-download-app-v62").style.display = "block", document.querySelector(".job-detail-guide-download-app-v62").style.top = t - 20 + 44 + "px", document.querySelector(".job-detail-guide-download-app-v62").style.left = e + 24 - 92 + "px", _this_.hoverTimer && clearTimeout(_this_.hoverTimer), _this_.hoverTimer = setTimeout(function () {
                try {
        ...
        }), $(".company-detail-guide-download-app-v62")[0] || $(document.body).append('<div class="company-detail-guide-download-app-v62" style="display:none"><div class="app-icon-arrow"></div><div class="app-icon-v62"></div><div class="app-icon-des-v62">涓嬭浇App  鏌ョ湅鏇村</div></div>'), $(document).on("mouseenter", "#main .company-name .company-guide-loaddown-app", function () {
            var e = $(this), t = $(this)[0].getBoundingClientRect().left, i = $(this)[0].getBoundingClientRect().top;
            document.querySelector(".company-detail-guide-download-app-v62").style.display = "block", document.querySelector(".company-detail-guide-download-app-v62").style.top = i - 20 + 3 + "px", document.querySelector(".company-detail-guide-download-app-v62").style.left = t + 24 - 76 - 19 + 90 + "px", _this_.hoverTimer && clearTimeout(_this_.hoverTimer), _this_.hoverTimer = setTimeout(function () {
                try {
        ...
        if (tagContainer.each(function (e, t) {
        ...
        }), $(".detail-content .job-sec .fold-text").height() > 178 ? $(".detail-content .job-sec .fold-text").find(".more-view").show() : $(".detail-content .job-sec .fold-text").find(".more-view").hide(), $(".manager-list .fold-text").each(function () {
            $(this).height() > 106 ? $(this).find(".more-view").show() : $(this).find(".more-view").hide()
            ...
            var t = $(this);
            if (t.hasClass("btn-send-phone")) Detail.sendPhone(t); else if (t.hasClass("btn-outline")) {
                ...
                e.preventDefault()
            } else t.hasClass("btn-startchat") && ("绔嬪嵆娌熼€�" == t.text() ? (e.preventDefault(), Detail.openChatDialog(t)) : Detail.startChat(t))
        ...
        }), $(".detail-hasmore").length ? !$(".detail-hasmore-btn").is(":visible") && isVisiable($(".job-location")[0]) && Detail.companyDetail() : isVisiable($(".job-location")[0]) && Detail.companyDetail(), this.detailMap(), $(".detail-hasmore .detail-hasmore-layer .detail-hasmore-btn").on("click", function () {
            $(this).closest(".detail-hasmore").removeClass("detail-hasmore"), isVisiable($(".job-location")[0]) && Detail.companyDetail()
        }), $(".location-item").on("click", function () {
            $(this).parent().find(".location-item").removeClass("show-map"), $(this).addClass("show-map");
            var e = $(this).find(".map-container").eq(0);
            e.find("img").length || e.html('<img src="' + e.attr("data-src") + '" alt="鍏徃鍦板潃"><p>鐐瑰嚮鏌ョ湅鍦板浘</p>')
        ...
        if ($(document).height() - $(window).height() < 260 || 0 == $(".job-banner").length || (showBanner(), $(window).scroll(function () {
            showBanner(), $(".detail-hasmore").length ? !$(".detail-hasmore-btn").is(":visible") && isVisiable($(".job-location")[0]) && Detail.companyDetail() : isVisiable($(".job-location")[0]) && Detail.companyDetail()
                    ...
                    hoverDuring: 400, hoverEvent: function () {
                        ...
                        "" == $.trim(e.text()) ? $.ajax({
                            ...
                            success: function (n) {
                                if (0 == n.code) {
                                    var a = n.zpData.html;
                                    e.html(a), setPopjobTop(t, t.closest("li"), i)
                                }
                            }
        ...
        var $equityInfo = $(".equity-info"), $equityTable = $(".equity-table"), equityTable = $(".equity-table").get(0),
            deletedRows = [];
        $(".equity-table .equity-expand-btn label").click(function () {
            "灞曞紑" == $(this).text() ? ($(this).html('<span>鏀惰捣</span><i class="fz fz-slideup"></i>'), $(".company-detail-grab .company-equity .equity-detail .equity-table .row-3 ~ tr").css("display", "table-row")) : ($(this).html('<span>灞曞紑</span><i class="fz fz-slidedown"></i>'), $(".company-detail-grab .company-equity .equity-detail .equity-table .row-3 ~ tr").css("display", "none"))
        });
        var $fakeBanner = $(".company-detail-grab .company-banner"), $jobBox = $(".company-detail-grab .job-box"),
            elFakeBanner = $fakeBanner.get(0), bannerRect;
        $fakeBanner.length && (bannerRect = elFakeBanner.getBoundingClientRect(), window.onscroll = function () {
            document.documentElement.scrollTop >= bannerRect.bottom ? ($fakeBanner.addClass("fixed"), $jobBox.css("marginTop", 30 + bannerRect.height)) : ($fakeBanner.removeClass("fixed"), $jobBox.css("marginTop", 30))
        });
        ...
        if ($fakeBanner.length && $(elAnchors).on("click", function (e) {
            if ("鍏徃绠€浠�" == this.innerText && (window.location.pathname.indexOf("/gongsi/") > -1 || window.location.pathname.indexOf("/gongsis/") > -1) && (e.preventDefault(), $("html,body").animate({scrollTop: 0})), "宸ュ晢淇℃伅" == this.innerText || "鑲℃潈淇℃伅" == this.innerText || "鍏徃鍦板潃" == this.innerText) for (var t = 0; t < elSectionTitles.length; t++) this.innerText == elSectionTitles[t].innerText && $("html,body").animate({scrollTop: $(elSectionTitles[t]).offset().top - bannerRect.height});
            "鎷涜仒鑱屼綅" == this.innerText && $("html,body").animate({scrollTop: $(".job-sec.search-box").offset().top - bannerRect.height});
            for (var i = 0; i < elAnchors.length; i++) elAnchors[i].innerText !== this.innerText && $(elAnchors[i]).removeClass("cur");
            $(this).addClass("cur")
        }), $(".links-box").length > 0) {
        ...
        $(".company-job.company-desc .job-list li").length > 0 && $(".company-job.company-desc .job-list").on("click", "li", function (e) {
            if ("A" !== e.target.nodeName && -1 === e.target.className.indexOf("startchat")) {
                ...
                t.append(s), t.find("form").submit(), t.find("form").remove()
            }
        ...
        $.ajax({
            ...
            success: function (i) {
                var a = i.zpData;
                0 == i.code && (Attachment.attachmentList = a, a.hasInterviewed || t ? Detail.beforeAcceptInvite(e, a, n) : Detail.showInviteTip(e, a, n))
            }
        })
        ...
        $.ajax({
            ...
            success: function (n) {
                if (0 === n.code) $.dialog({
                    ...
                    var a = (n.zpData.bizCode, n.zpData.bizMessage), s = n.zpData.bizData;
                    s.chatRemindDialog ? ($.extend(i, {cid: 1}), Detail.showBlockDialog(s.chatRemindDialog, e, 17, t.resumeId, i)) : $.toast({
                        content: a,
                        type: "error"
                    })
        ...
        e.attr("redirect-url");
        n = n.replace("/gchat/deliveryResume.json", "/wapi/zpgeek/resume/onekeydeliver.json"), e.hasClass("btn-loading") || e.hasClass("btn-disabled") || (e.html('<i class="icon-loading"></i>鎶曢€掍腑').addClass("btn-loading"), Detail.getQueryParams(n).resumeId || (n = n + "&resumeId=" + i), $.ajax({
            url: n, type: "post", dataType: "json", success: function (t) {
                var n = t.zpData || {};
                0 === t.code ? $.dialog({
                    content: '<div class="tip-text">鎮ㄧ殑闄勪欢绠€鍘嗗凡缁忓彂閫佺粰Boss锛岃闈欏€欎匠闊炽€�</div>',
                    title: "鎶曢€掓垚鍔�",
        ...
        var e = e, a = t || e.attr("data-url"), s = e.attr("redirect-url");
        "javascript:;" != e.attr("href") || e.hasClass("btn-disabled") || (e.addClass("btn-disabled"), $.ajax({
            type: "POST", url: a, dataType: "JSON", data: null, success: function (t) {
                if (0 == t.code) {
        ...
        function i(e) {
            return $.ajax({
                ...
                dataType: "JSON",
                data: {bossId: e.encBossId, securityId: e.securityId, bossSource: e.bossSource}
            })
        }
        ...
        function n(e) {
            ...
            return $.ajax({
                ...
                dataType: "JSON",
                data: {securityId: e, sceneType: 1}
            }).then(function (e) {
                if (0 == e.code) {
                    var i = e.zpData.qrcode, n = e.zpData.wxNotifyStatus;
                    i || 1 !== n ? t = "/wapi/zpweixin/qrcode/getqrcode?w=180&h=180&content=" + i : (t = staticPath + "/web/geek/images/start_chat_default_qrcode.jpg", $(".startchat-dialog .startchat-content .right .title").text("宸插紑鍚秷鎭闃�"), $(".startchat-dialog .startchat-content .right .sub-title").text("灏忕▼搴忎篃鑳界户缁洖澶岯OSS淇℃伅"), $(".startchat-dialog .startchat-content .right .tip").text("浣跨敤寰俊鎵爜")), $(".startchat-dialog .startchat-content .img-container .wechat-qrcode").attr("src", t).removeClass("loading")
                }
            })
        }
        ...
        function s(e, t) {
            7 == t.code || 1011 == t.code ? (Detail.showSign(1011), e.removeClass("btn-disabled")) : 1 == t.code ? t.zpData && 1 == t.zpData.bizCode ? (Detail.showBlockDialog(t.zpData.bizData.chatRemindDialog, e, 1), e.removeClass("btn-disabled")) : t.zpData && 2 == t.zpData.bizCode ? Detail.showGrabTip(e) : ($.toast({
                content: t.message,
                type: "error"
            }), e.removeClass("btn-disabled")) : 24 == t.code ? ($.toast({
                content: "璇峰埌APP涓垏鎹㈠埌鐗涗汉韬唤鍚庡啀閲嶈瘯",
        ...
        var e = e, o = t || e.attr("data-url");
        if (redirectUrl = e.attr("redirect-url"), "javascript:;" == e.attr("href") && !e.hasClass("btn-disabled")) {
            e.addClass("btn-disabled");
            var r;
            !function () {
                var e = $('<div class="page-loading"><img class="loading-img" src="/v2/web/geek/images/loading.gif"></div>');
                $("body").append(e)
            }(), function () {
                return $.ajax({type: "POST", url: o, dataType: "JSON", data: null})
            }().then(function (t) {
                if (0 == t.code) {
                    var n = $(".job-banner .btn-container .btn.btn-startchat"),
                        a = $(".smallbanner .btns .btn.btn-startchat");
                    n.attr("href", n.attr("redirect-url")).text("缁х画娌熼€�"), n.removeClass("btn-disabled"), a.attr("href", a.attr("redirect-url")).text("缁х画娌熼€�"), a.removeClass("btn-disabled");
                    var o = t.zpData || {};
                    return r = o.greeting, i(o)
                }
                return s(e, t), $.Deferred().reject("寮€鑱婂け璐�")
            }).then(function (e) {
                if (0 == e.code) {
                    var t = e.zpData.data || {};
                    t.greeting = r, Detail.chatDialog(t), n(t.securityId), a()
                }
            }).fail(function (t) {
                e.removeClass("btn-disabled"), a()
            })
        }
    }, chatDialog: function (e) {
        function t(e) {
            function t(e) {
                o.attr("id", e), n(o, "success")
            }

            function s(e) {
                o.attr("id", e), n(o, "error")
            }

            var o = i(e);
            if ("EventBus" in window) {
                var r = a;
                r.message = e, EventBus.publish("CHAT_SEND_TEXT", r, t, s)
            }
        }
        ...
        function i(e, t) {
            ...
            return n(a, t), i.append(a), i.animate({scrollTop: i.prop("scrollHeight")}, 500), a
        }

        function n(e, t) {
            var i = ["sending", "success", "error"], n = {sending: "鍙戦€佷腑", success: "宸插彂閫�", error: "澶辫触"};
            e = e.find(".status");
            for (var a = 0; a < i.length; a++) i[a] !== t && e.removeClass(i[a]), e.addClass(t).text(n[t])
        }

        var a = {uid: e.uid, source: e.bossSource, encryptUid: e.encryptBossId},
            s = '<div class="startchat-title">    <img class="avatar" src="' + e.tinyUrl + '">    <div class="boss-info">        <div class="name">' + e.name + '</div>        <div class="position">' + e.companyName + "路" + e.title + "</div>    </div></div>";
        $.dialog({
            title: s,
            content: '<div class="startchat-content">    <div class="left">        <div class="message">            <ul class="message-list"></ui>        </div>        <div class="edit-area">            <textarea class="input-area" placeholder="璇风畝鐭弿杩版偍鐨勯棶棰�"></textarea>            <div class="send-message disable">鍙戦€�</div>        </div>    </div>    <div class="right">        <div class="title">璁㈤槄鍥炲娑堟伅</div>        <div class="desc sub-title">鍦ㄥ井淇′笂瀹炴椂鏀跺埌浠栫殑鍥炲</div>        <div class="img-container">             <img class="wechat-qrcode loading" src="/v2/web/geek/images/loading.gif">        </div>        <div class="desc tip">浣跨敤寰俊鎵爜璁㈤槄</div>    </div></div>',
            cancelText: "",
            confirmText: "",
            closeText: !0,
            inline: !1,
            ...
            onOpen: function (n) {
                function a() {
                    s && s.length && (t(s), o.val(""), s = "", r.addClass("disable"))
                }

                var s, o = n.find(".input-area"), r = n.find(".send-message");
                e.greeting && i(e.greeting, "success"), o.on("input", function () {
                    s = o.val().trim(), s = filterXss(s), s.length ? r.removeClass("disable") : r.addClass("disable")
                }), r.on("click", function () {
                    a()
        ...
        function t() {
            $.ajax({
                type: "POST", url: n, dataType: "JSON", data: null, success: function (t) {
                    0 == t.code ? (e.removeClass("btn-disabled"), window.location.href = a) : 7 == t.code || 1011 == t.code ? (Detail.showSign(1011), e.removeClass("btn-disabled")) : 1 == t.code ? t.zpData && 1 == t.zpData.bizCode ? (Detail.showBlockDialog(t.zpData.bizData.chatRemindDialog, e, 1), e.removeClass("btn-disabled")) : t.zpData && 2 == t.zpData.bizCode ? Detail.showGrabTip(e) : ($.toast({
                        content: t.message,
                        type: "error"
                    }), e.removeClass("btn-disabled")) : 24 == t.code ? ($.toast({
                        content: "璇峰埌APP涓垏鎹㈠埌鐗涗汉韬唤鍚庡啀閲嶈瘯",
        ...
        var e = e, i = e.attr("data-url"), n = e.attr("data-send-url"), a = e.attr("redirect-url");
        "javascript:;" != e.attr("href") || e.hasClass("btn-disabled") || (e.addClass("btn-disabled"), $.ajax({
            type: "POST",
            url: i,
            dataType: "JSON",
            data: null,
            success: function (i) {
                0 == i.code ? t() : 7 == i.code || 1011 == i.code ? (Detail.showSign(1011), e.removeClass("btn-disabled")) : 1 == i.code ? i.zpData && 1 == i.zpData.bizCode ? (Detail.showBlockDialog(i.zpData.bizData.chatRemindDialog, e, 1), e.removeClass("btn-disabled")) : i.zpData && 2 == i.zpData.bizCode ? Detail.showGrabTip(e) : ($.toast({
                    content: i.message,
                    type: "error"
                }), e.removeClass("btn-disabled")) : 24 == i.code ? ($.toast({
                    content: "璇峰埌APP涓垏鎹㈠埌鐗涗汉韬唤鍚庡啀閲嶈瘯",
                    type: "error"
                }), e.removeClass("btn-disabled")) : 25 == i.code ? (e.removeClass("btn-disabled"), window.location.href = "/web/geek/guide") : ($.toast({
                    content: i.message,
                    type: "error"
                }), e.removeClass("btn-disabled"))
            },
        ...
        var s = e.title, o = e.content, r = e.buttonList, c = e.remindType, l = "";
        ...
        var d = {
            ...
            onConfirm: function (s) {
                if (Detail.sendEventAction(e, "addf-limit-popup-connect"), e.showNotRemind && $(".remindType input:checked").length && Detail.sendRemindType(c), p.close(), 2 == c) return void (1 == i ? Detail.startChat(t, r[1].webUrl) : 17 == i ? Detail.postDeliveResume(t, a) : Detail.deliveResume(t, r[1].webUrl, n));
        ...
        2 === r.length && (d.onCancel = function () {
            if (Detail.sendEventAction(e, "addf-limit-popup-connect"), p.close(), 2 === r.length) {
                if (4 == c) return void (17 == i ? Detail.postDeliveResume(t, a) : Detail.startChat(t, r[0].webUrl));
        ...
        Detail.getIntersetStatus(e).then(function (t) {
            var i = t.zpData.bizData, n = t.zpData, a = "鎰熷叴瓒�";
            3 === n.bizCode && (a = "瑕�, 鍙戠畝鍘�");
            var s = "";
            s += '<i class="arrow-noumenon"></i>', s += "<p>" + n.bizMessage || t.message + "</p>", s += '<div class="btn-wrap">', s += "</div>";
            var o = $.dialog({
                content: s,
                title: "",
                closeText: !1,
                ...
                onConfirm: function (t) {
                    ...
                    }) : Detail.interestGeekOther(e, i), t.remove()
                },
                onCancel: function (t) {
                    Detail.setInterest(e), o.close()
                }
            })
        })
        ...
        setTimeout(function () {
            $(".job-location .job-location-map[data-content]").each(function () {
                ...
                if (!e.find("img").length) if (e.attr("data-src")) {
                    e.html('<img src="' + e.attr("data-src") + '" alt="鍏徃鍦板潃"><p>鐐瑰嚮鏌ョ湅鍦板浘</p>');
                    try {
                        _T.sendEvent("get_amap_pc")
                    } catch (e) {
                    }
                } else (new AMap.Geocoder).getLocation(t, function (t, i) {
            ...
            var e = $(".job-location .map-container").eq(0), t = e.attr("data-content");
            if (!e.find("img").length) if (e.attr("data-src")) {
                e.html('<img src="' + e.attr("data-src") + '" alt="鍏徃鍦板潃"><p>鐐瑰嚮鏌ョ湅鍦板浘</p>');
                try {
        ...
        }, 2e3), $(".js-open-map").on("click", function () {
            ...
            $.dialog({
                ...
                wrapClass: "map-pop",
                onOpen: function (e) {
                    var n = t.split(","), a = new AMap.Map("map-container", {
                        resizeEnable: !0,
                        scrollWheel: !0,
                        center: [n[0], n[1]],
                        zoom: 16
                    ...
                    AMap.event.addListener(s, "click", function () {
                        ...
                        a.addControl(e), a.addControl(t)
                    }), infoWindow = new AMap.InfoWindow({
                        content: i,
                        offset: new AMap.Pixel(5, -25)
                    }), infoWindow.open(a, a.getCenter()), e.find(".dialog-container").css({margin: "-250px 0 0 -330px"})
                }
            })
        })
    }, detailMap: function () {
        $(".js-open-detail").on("click", function () {
            var e = $(this).attr("data-id"), t = $(this).attr("data-lat"), i = filterXss($(this).attr("data-content")),
        ...
        if ("undefined" != typeof _jobInfo) {
            $.get("/wapi/zpitem/web/competitive/jobDetail.json", {encryptJobId: _jobInfo.job_id}, function (n) {
                0 == n.code ? (e.find(".prop-default").removeClass("prop-default"), e.find("h3").append("<span>宸插紑鍚�</span>"), t.find(".level-" + (n.zpData.position + 1)).prepend('<p class="text-position icon-position">鎮ㄧ殑浣嶇疆</p>'), i.find(".pull-right").siblings().html("涓汉缁煎悎鎺掑悕锛�<span>涓変釜鏈堝唴鍏�<em>" + n.zpData.totalNum + "</em>浣嶇墰浜烘矡閫�</span>"), i.find(".pull-right").html('<a href="javascript:;" class="link-detail" ka="check_personal_competitive_detail">鏌ョ湅瀹屾暣涓汉绔炰簤鍔�</a>')) : (e.find(".prop-default").removeClass("prop-default"), t.prepend('<p class="text-position">浣犲湪锛熶綅缃�</p>'), i.find(".pull-right").html('<a href="javascript:;" class="link-detail" ka="check_personal_competitive_detail">鏌ョ湅瀹屾暣涓汉绔炰簤鍔�</a>'))
            });
            var n = function () {
                var e = $.Deferred();
                return $.get("/wapi/zpitem/web/competitive/useStatus.json", {encryptJobId: _jobInfo.job_id}, function (t) {
                    e.resolve(t)
                }), e
            }, a = function (e, t) {
                $.ajax({
                    url: "/wapi/zpitem/web/competitive/use",
                    data: {encryptJobId: e.targetId},
                    type: "post",
                    success: function (t) {
                        0 == t.code ? window.location.href = "/geek/item/competitive/report/" + e.targetId + ".html" : 600050 == t.code ? Detail.showPop({
                            title: "娓╅Θ鎻愮ず",
                            ...
                            callback: function (t) {
                                t.find(".btn-sure").on("click", function () {
                                    ...
                                    window.location.href = "/geek/item/competitive/report/" + e.targetId + ".html"
                                })
                            }
                        }) : 600052 == t.code ? Detail.showPop({
                            title: "娓╅Θ鎻愮ず",
                        ...
                        }) : $.toast({content: t.message, type: "error"})
                    }
                })
            }, s = function () {
                n().then(function (e) {
                    if (7 == e.code) return void $.toast({content: "绔炰簤鍔涘垎鏋愬櫒浠呭湪宸茬櫥褰曠姸鎬佷笅鍙娇鐢� ", type: "error"});
                    if (24 == e.code) $.toast({
                    ...
                    } else if (0 != e.zpData.itemLeftCount) $.dialog({
                        title: "",
                        content: "纭畾瀵硅鑱屼綅浣跨敤绔炰簤鍔涘垎鏋愬櫒锛�",
                        confirmText: "浣跨敤1/" + e.zpData.itemLeftCount,
                        cancelText: "鎴戝啀鎯虫兂",
                        ...
                        onConfirm: function (t) {
                            ...
                            var i = {targetId: e.zpData.targetId};
                            a(i)
                        },
                        onCancel: function (e) {
                            try {
                                    ...
                                    if ("confirm" == e) {
                                        ...
                                        n().then(function (e) {
                                            if (0 == e.zpData.status) {
                                                var t = {targetId: e.zpData.targetId};
                                                a(t, wrap)
                                            } else $.toast({content: e.message, type: "error"})
                                        })
                                    } else try {
        ...
        $.post("/wapi/zpitem/web/geekVip/getSubscribeYellow", {encryptBrandId: $('input[id="encryptBrandId"]').val() || ""}, function (e) {
        ...
        $(".job-list").prepend(i), $(".job-list").on("click", ".detail-vip-container .btn", function () {
            var e = {
        ...
        var t = {
            encryptBrandId: e.encryptBrandId, subscribe: e.subscribe
        }, i = e.elContainer;
        $.post("/wapi/zpitem/web/geekVip/subscribe", t, function (e) {
            0 == e.code ? (0 == t.subscribe ? $.toast({
                content: "璇ュ叕鍙歌亴浣嶅凡璁㈤槄鎴愬姛锛屾柊鑱屼綅鍙戝竷灏嗗疄鏃舵彁閱掓偍",
                type: "success"
            }) : $.toast({
                content: "鍙栨秷璁㈤槄鎴愬姛",
                type: "success"
            }), i.find(".btn").text(e.zpData.buttonText), i.find("span").text(e.zpData.yellowText), e.zpData.subscribe ? i.find(".btn").addClass("btn-outline") : i.find(".btn").removeClass("btn-outline"), e.zpData.hasVip || i.parents(".detail-vip-tip").remove()) : $.toast({
                content: e.message,
                type: "error"
            })
        })
    }, jobSubscribe: function (e) {
        var t = e.find('input[name="sceneStr"]').val(), i = e.find('input[name="filter"]').val();
        $.ajax({
            type: "GET",
            url: "/wapi/zpgeek/job/subscribe/qr.json",
            data: {filter: i, sceneStr: t},
            dataType: "json",
            success: function (t) {
                if (0 == t.code) {
                    var i = t.zpData;
                    e.find("dt").append('<img src="/wapi/zpweixin/qrcode/getqrcode?content=' + i + '&w=140&h=140">')
                } else this.$toast({content: t.message, type: "error"})
            }
        }), e.find(".close").on("click", function () {
            $.ajax({
                type: "GET",
...
$(function () {
    Detail.init(), Detail.showPropDetail(), $('input[id="encryptBrandId"]').length && Detail.getVipStatus()
});
var Deliver = {
    init: function () {
...
var Validate = {
    init: function (e, t, i) {
        var n = e, a = n.find("input,textarea");
        n.on("submit", function (e) {
            var s = !1;
            if (a.each(function () {
                if ($(this).val($(this).val().replace(/(^[\s\n\r]*)|([\s\n\r]*$)/g, "")), !$(this).attr("disabled") && ($(this).hasClass("required") || $(this).attr("data-range")) && !Validate.check($(this), !0)) return s = !1, !1;
                s = !0
            }), s) {
        ...
        for (var t = 0, e = e.replace(/(^[\s\n\r]*)|([\s\n\r]*$)/g, ""), i = e.length, n = -1, a = 0; a < i; a++) n = e.charCodeAt(a), t += n > 255 ? 1 : .5;
        return Math.ceil(t)
    }, check: function (e, t, i) {
        var e = e, n = e.attr("data-range"), a = Validate.getLength(e.val().trim()), s = e.val().replace(/(\s*$)/g, "");
        ...
        if ("locationName" == e.attr("name") && "" != s && "" == e.parent().find('input[name="location"]').val()) return Validate.showError(e, "璇疯緭鍏ユ纭殑鍩庡競"), !1;
        if (t && "gender" == e.attr("name") && Number(s) < 0) return Validate.showError(e, e.attr("data-blank")), !1;
        if (n) {
            if (n = n.split(","), i && i.length && i.html("<em" + (a > n[1] ? ' class="red"' : "") + ">" + a + "</em>/" + n[1]), a > n[1] || a < n[0]) return Validate.showError(e, "璇疯緭鍏� " + n[0] + "-" + n[1] + " 涓瓧"), !1;
            Validate.hideError(e)
        }
        return !0
    ...
    eq: 0, appointedBlueCollarPosition: [], init: function (e) {
        ...
        if (this.dropSelect(t), this.prettyRadio(t), this.formEl = t, t.find(".ipt-datetimepicker").length) {
            ...
            nowYear = i.getFullYear(), nowMonth = i.getMonth() + 1, nowThisDate = i.getDate(), t.find(".ipt-datetimepicker").each(function (e) {
                var t = $(this), i = e, n = t.attr("data-format") || "yyyy-mm-dd", a = t.hasClass("date-range"),
                    s = t.attr("data-today"), o = t.attr("data-type"), r = t.attr("data-minYear") || !1, c = 2, l = 2;
                (o && "y-m-d" == o || "y-m" == o) && (c = 4), "yyyy-mm" == n && (l = 3), t.datetimepicker({
                    ...
                    a && "endDate" == t.attr("name") && (new Date(e.date).getFullYear() == (new Date).getFullYear() && new Date(e.date).getMonth() == (new Date).getMonth() ? (t.parent().addClass("show-prefix-today"), t.parent().find('input[name="now"]').val("1"), t.removeClass("required")) : (t.parent().removeClass("show-prefix-today"), t.parent().find('input[name="now"]').val(""), t.addClass("required"))), $(e.target).attr("data-minyear") && (new Date(e.date).getFullYear() <= 1989 ? i.parent().addClass("show-prefix-minyear") : i.parent().removeClass("show-prefix-minyear"))
                }), "birthday" == t.attr("name") && (t.datetimepicker("setStartDate", "1950-01"), t.datetimepicker("setEndDate", nowYear - 15 + "-12")), a && "startDate" == t.attr("name") && t.datetimepicker("setStartDate", "1989-01"), a && "endDate" == t.attr("name") && ("" == t.val() && "" == t.closest(".form-row").find(".date-range").eq(0).val() ? t.datetimepicker("setStartDate", "1990-01") : t.datetimepicker("setStartDate", t.closest(".form-row").find(".date-range").eq(0).val())), t.parent().find(".prefix-minyear,.prefix-today").on("click", function (e) {
        ...
        t.find(".ipt-workyear").length && t.find(".ipt-workyear").workstartpicker(), t.find(".start-salary").on("click", "li", function () {
            ...
            if ("纭畾" == $(this).text()) {
                ...
                t.find(".select-industry .industry-cells .selected").each(function () {
                    a.push($(this).text()), s.push($(this).attr("data-val") || $(this).text())
                }), a.length || (a.push("涓嶉檺"), s.push("0")), t.find(".select-industry").closest("dd").find(".dropdown-select .ipt").val(a.join("路")), t.find(".select-industry").closest("dd").find('.dropdown-select input[type="hidden"]').val(s.join("路")), t.find(".select-industry").closest("dd").find(".dropdown-select").removeClass("dropdown-select-open"), t.find(".select-industry").closest("dd").find(".dropdown-menu").removeClass("dropdown-menu-open")
        ...
        if (t.length) {
            var n = [], a = t.val().split("路"), s = i.val().split("路");
            $.each(s, function (e, t) {
                n.push({name: a[e], code: s[e]})
                ...
                $.isArray(n) ? ($.each(n, function (e, t) {
                    a.push(t.name), s.push(t.code)
                }), t.val(a.join("路")), i.val(s.join("路"))) : (t.val(n.name), i.val(n.code))
            })
        }
        ...
        function n(n, a, s) {
            if (a.hasClass("ipt-range") && "start" == a.attr("data-range")) {
                var o, r = a.closest(".form-row"), c = a.closest("dd").find(".dropdown-menu ul"),
                ...
                p.html(g), s || (l.val(p.find("li:last").text()), d.val(p.find("li:last").attr("data-val")), l.val(v), d.val(v))
            }
        }
        ...
        var e = e || $(document);
        if (e) {
            var s = e.find('input[placeholder="閫夋嫨鑱屼綅绫诲瀷"], input[placeholder="鎮ㄧ殑鑱屼綅"]').next('input[name="position"]'),
                o = s ? s.val() : "";
            if (o && a(s, o), 0 === FormsUI.eq) {
                var r = new $.Position;
                    ...
                    r.init({
                        data: jobData, callback: function (t) {
                            e.val(t[2].name), e.next().val(t[2].code), e.next().attr("level2", t[1].code), e.next().attr("level3", t[2].code), $('input[placeholder="閫夋嫨鎶€鑳芥爣绛�"]').val(""), $('input[placeholder="閫夋嫨鎶€鑳芥爣绛�"]').next().val(""), $(".select-tags .industry-cells").html(""), Resume.getSkillsData({
                                p1: t[2].code,
                                p2: t[1].code
                            }, !0), e.closest("dd").find(".tip-text").hide(), "閫夋嫨鑱屼綅绫诲瀷" == e.attr("placeholder") && e.closest(".form-row").find('input[name="positionName"]').val(t[2].name), "guide" == e.data("type") && Guide.showSugSkillTag(t[2].code), a(e, t[2].code)
                        }, hasSearch: !0
                    })
                }), FormsUI.eq = 1
            }
            e.find(".dropdown-select").each(function () {
                var t = $(this), i = t.find('.ipt-range[data-range="start"]'), a = t.find('input[name="highSalary"]');
                t.on("click", function () {
                ...
                }), t.find('.ipt-range[data-range="end"]') && n(i, i, !0), "" == a.val() && (a.closest(".dropdown-select").addClass("dropdown-disabled"), a.closest(".dropdown-select").find(".ipt").attr("disabled", "disabled"))
            });
            ...
            c.length && c.find(".btn").each(function () {
                ...
                var t = $(this), i = t.prev(".dropdown-select"), a = i.find("input[readonly]"),
                    s = i.find('input[type="hidden"]'), o = t.find(".select-tree"), r = t.find(".tags-cells");
                o.length && (3 == o.attr("data-level") && o.html('<ul class="tree-1"></ul><ul class="tree-2"></ul><ul class="tree-3"></ul>'), 2 == o.attr("data-level") && o.html('<ul class="tree-1"></ul><ul class="tree-2"></ul>'), FormsUI.getTreeData(o, jobData)), r.length && void 0 !== Resume && Resume.getTag(e, !0), t.on("click", "li", function () {
                    ...
                    if (c.length && e.length && ($(this).attr("data-val") <= 205 ? ($(c).removeClass("hide"), $(c.find(".btn")[0]).attr("class", "btn btn-outline"), $(c.find(".btn")[1]).attr("class", "btn btn-slight"), c.next().val(1)) : ($(c).hasClass("hide") || $(c).addClass("hide"), $(c.find(".btn")[0]).attr("class", "btn btn-outline"), $(c.find(".btn")[1]).attr("class", "btn btn-slight"), c.next().val(""))), $(this).closest(".select-tree").length) {
                        ...
                        if ($(this).parent().find("li").removeClass("selected"), $(this).addClass("selected"), 3 == r) {
                            ...
                            if ($(this).closest(".tree-2").length) return $(this).closest(".select-tree").find(".tree-3").show(), s.attr("level2", $(this).attr("data-id")), FormsUI.getTreeData(o, jobData, $(this).closest(".select-tree").find(".tree-1 .selected").attr("data-id"), $(this).attr("data-id")), !1
                        }
                        if (2 == r) {
                            if ($(this).closest(".tree-1").length) return $(this).closest(".select-tree").find(".tree-3").hide(), FormsUI.getTreeData(o, jobData, $(this).attr("data-id")), !1;
                            if ($(this).closest(".tree-2").length) return $(this).closest(".select-tree").find(".tree-3").show(), s.attr("level2", $(this).attr("data-id")), FormsUI.getTreeData(o, jobData, $(this).closest(".select-tree").find(".tree-1 .selected").attr("data-id"), $(this).attr("data-id")), !1
                    ...
                    if (n($(this), a), a.val($(this).text()), void 0 !== $(this).data("val") && s.val($(this).attr("data-val")), s.closest("dd").find(".tip-text").remove(), t.removeClass("dropdown-menu-open"), i.removeClass("dropdown-select-open"), "position" == s.attr("name")) {
        ...
        for (a = 0; a < t.length; a++) {
            var d = t[a].children;
            if (r += '<li data-id="' + t[a].id + '">' + t[a].name + "</li>", d && i && t[a].id == i) for (s = 0; s < d.length; s++) {
                var p = d[s].children;
                if (c += '<li data-id="' + d[s].id + '">' + d[s].name + "</li>", p && n && d[s].id == n) for (o = 0; o < p.length; o++) l += '<li data-val="' + p[o].id + '">' + p[o].name + "</li>"
            }
        }
        ...
        if (e) {
            var i = $(".end-salary"), n = i.find(".ipt"), a = i.find('input[type="hidden"]'), s = i.find("ul"), e = e,
                o = 0;
            if (e && (n.closest(".dropdown-select").removeClass("dropdown-disabled").parent().parent().find(".range-devide").show(), n.removeAttr("disabled")), "闈㈣" == e) n.val("闈㈣").parent().hide().parent().parent().find(".range-devide").hide(), a.val("闈㈣"); else {
            ...
            t && 0 == e && 0 == a.val() && n.parent().hide(), t || (n.val(o + "K"), a.val(o))
        }
        ...
        var t = e.closest("dd").find(".ipt"), i = e.closest("dd").find('input[name="location"]'),
            n = e.closest("dd").find('input[type="hidden"]'), a = e.clone();
        a.find(".ignore").remove(), t.val(a.text()), i.val(e.attr("data-val")), n.val(e.attr("data-val")), e.closest(".suggest-complete").removeClass("dropdown-menu-open"), t.parent().find(".tip-text").remove()
    }
};
$(function () {
...
var ResumeEditor = {
    ...
    ownerTags: [], skillsData: [], formStatus: !1, parserId: "", init: function () {
        ...
        return $.ajax({
            ...
            success: function (i) {
                if (i.zpData && i.zpData.showType && 1 === i.zpData.showType) {
                    var n = i.zpData.parserId, a = i.zpData.resumeName;
                    Resume.parserId = n, Resume.showResumeAnalyzeTools(a), t = !0;
                    try {
                        _T.sendEvent("to_resume_expose")
                    } catch (e) {
                    }
        ...
        for (var i = {}, n = [], a = 0; a < e.length; a++) {
            var s = e[a], o = !!t && typeof i[s] != typeof s;
            (void 0 === i[s] || o) && (i[s] = s, n.push(s))
        }
        return n
        ...
        e.length && (e.removeAttr("readonly"), "" != e.val() && (t = e.val().split("路"), e.val(t.join(",")), Resume.owerSkillData = t), e.tagsinput({
            ...
            var i = !0, n = !1, a = t.item.replace(/</g, "&lt;").replace(/>/g, "&gt;");
            if (Resume.getLength(a) > 6 && (n = !0), Resume.tagsPannel.find("li").each(function () {
                $(this).text() == a && (i = !1, n = !1)
            }), n && (Resume.skillsContainer.find(".bootstrap-tagsinput .tag:last").find('span[data-role="remove"]').click(), Validate.showError(e, "鏈€澶氬厑璁歌緭鍏�6涓腑鏂囧瓧绗�")), i && !n && (Resume.tagsPannel.find("div.empty").remove(), Resume.tagsPannel.find("ul").append("<li><span>" + a + "</span></li>"), Resume.tagsPannel.show(), Resume.skillsContainer.find(".result-selecter").hide(), Resume.skillsData = Resume.unique(Resume.skillsData), Resume.skillsData.push(a)), !n) {
        ...
        var i = e, n = i.find(".tags-cells"), a = "", s = "",
        ...
        o && $.ajax({
            ...
            success: function (e) {
                ...
                if (e.length > 0) {
                    for (i = 0; i < e.length; i++) o = $.inArray(e[i], r) > -1 ? ' class="selected"' : "", s += "<span" + o + ' ka="tag-' + e[i] + '">' + e[i] + "</span>", c.push(e[i]);
                    if (t) for (var l = 0; l < r.length; l++) -1 == $.inArray(r[l], c) && (Resume.ownerTags.push(r[l]), a += '<span class="selected" ka="tag-' + r[l] + '">' + r[l] + "</span>")
                } else s = '<div class="blank-tag">杩樻湭娣诲姞鏍囩</div>';
                n.html(a + s)
            },
            error: function (e) {
            }
        ...
        function n(e) {
            var t = this, i = (t.baseLine, e.data.resumeActiveness), n = i.recentActiveness, a = n,
                s = i.similarGeekRecentActiveness, c = a.concat(s), l = i.date8Arr,
        ...
        function s(e, t) {
            ...
            return $.each(t, function (t, a) {
                n = "", s = parseInt(xAxisDot * t + 20), 2 == t && (r = "dn"), 9 == e && (2 == t ? (a.xAxis = "浠婂ぉ", n = "degree", c = '<text class="today-dots ' + n + ' dn" x="137" y="' + a.yAxis[1] + '" > +' + a.series[0] + "</text>") : 1 == t && (a.xAxis = "鏄ㄥぉ")), o += '<g class="bg-x' + t + ' " transform="translate(5,20)"><line x1="' + s + '" y2="84"  x2="' + s + '" y2="84" class="bg-axis" data-value="' + t + '"/></g>', i += '<g class="refresh-x  x' + t + ' " data-value="' + t + '" transform="translate(5,20)"><text x="' + (s - 10) + '" y="104" class="fresh-day" width="30" >' + a.xAxis + '</text><text class="similar-series" x="' + s + '" y="' + (a.yAxis[1] - 5) + '" >' + a.series[1] + '</text><text class="my-series ' + r + " " + n + '" x="' + s + '" y="' + (a.yAxis[0] - 5) + '" >' + a.series[0] + '</text><circle class="similar-yaxis" cx="' + s + '" cy="' + a.yAxis[1] + '" r="2"/><circle class="my-yaxis ' + n + '" cx="' + s + '" cy="' + a.yAxis[0] + '" r="2"/></g>', l[0].push(a.yAxis[1]), l[1].push(a.yAxis[0])
            }), $.each(l, function (t, i) {
                a = 9 == e && 1 == t ? "degree" : "", l += '<g  transform="translate(5,20)"><polyline  class="refesh-line  refesh-line' + t + " " + a + '"   points="20,' + Math.abs(i[0]) + " 70," + Math.abs(i[1]) + " 120," + Math.abs(i[2]) + '" fill="none"/></g>'
            }), o + c + l + i
        }
        ...
        function c() {
            ...
            if (0 == i.leftCount && 0 == i.refreshed) {
                ...
                var a = {from: "resume" == this.type ? 2 : 1};
                1 == !i.free && i.leftCount > 0 && $.extend(a, {userItemId: i.encryptUserItemId}), p("/geek/item/resumerefresh/useitem.json", "post", a).then(function (t) {
                    if (1 == t.rescode) {
                        d();
                        var i = $(".refresh-free-count").find("span"), a = parseInt(i.text()), s = a >= 1 ? a - 1 : a;
                        i.html(s);
        ...
        function l(e, t) {
            ...
            p("/geek/item/resumerefresh/activeness.json", "get", {}).then(function (s) {
                if (n.resData = s, s.data.resumeActiveness) {
                    if (resumeActiveness = s.data.resumeActiveness, list = resumeActiveness.recentActiveness, 0 == resumeActiveness.refreshed) var o = '<a class="btn refresh-btn" href="javascript:;">鍒锋柊绠€鍘�</a>'; else if (resumeActiveness.refreshDays > 1) var o = '<a class="btn refresh-bt-grey" href="javascript:;">宸茶繛缁埛鏂�' + resumeActiveness.refreshDays + " 澶�</a>"; else var o = '<a class="btn refresh-bt-grey" href="javascript:;">浠婃棩宸插埛鏂�</a>';
                    var r = 0 == resumeActiveness.free ? "鍓╀綑娆℃暟" : "鍓╀綑鍏嶈垂娆℃暟", l = 0;
                    1 == resumeActiveness.free && 2 == resumeActiveness.leftCount && (l = 1);
                    var p = '<div class="resume-refresh-hwslider"></a><ul>' + a(s) + '</ul> <a href="javascript:;"  class="arrow-prev"></a><a href="javascript:;"  class="arrow-next"></a></div>' + o + '<p class="refresh-text"><span class="refresh-free-count"><span>' + resumeActiveness.leftCount + "</span>娆�</span><span>" + r + "</span></p></li>" + i();
                    t(l, p), 1 == e && c();
        ...
        function d() {
            var e = this, t = $(".resume-refresh-hwslider"), i = $(".resume-refresh-hwslider .arrow-prev"),
                n = $(".resume-refresh-hwslider .arrow-next"), a = t.children("ul"), s = a.children("li"), o = s.length,
                r = 10, c = !0, l = function (e, i) {
                    if (!c) return !1;
                    c = !1;
                    var n = t.width();
                    "prev" == i && (n *= -1), a.children(".active").stop().animate({left: -n}, 400, function () {
                        $(this).removeClass("active")
                    }), s.eq(e - 1).css("left", n + "px").addClass("active").stop().animate({left: 0}, 400, function () {
                        c = !0
                    })
                };
        ...
        function u() {
            p("/business/item/sellunit.json", "get", {itemType: "b5799fd5b0d1ce3b1XU~"}).then(function (e) {
                for (var t = e.itemSellUnit, i = t.itemSellItemList, n = "", a = 0; a < i.length; a++) {
                    var s = "", o = "", r = "", c = i.length - 1;
                    s = 0 == i[a].decreaseAmount ? "" : "锛堣妭鐪伮�" + i[a].decreaseAmount + "锛�", a == c && (o = "item-hot selected"), r = i[c].beanAmount - e.beanCount > 0 ? i[c].beanAmount - e.beanCount : 0, n += '<li data-id="' + i[a].encryptBeanItemId + '" class="' + o + '" data-money ="' + i[a].beanAmount + '">                                <div class="pull-right"><span class="text-orange">锟�' + i[a].beanAmount + "</span></div>                                <p>" + i[a].specDesc + '<span class="text-gray">' + s + "</span></p>                             </li>"
                }
                ...
                $.dialog({
                    ...
                    onConfirm: function (e) {
                        ...
                        }, n = e.find(".purchase-container li.selected").attr("data-id"), a = {
    ...
    init: function (e) {
        ...
        var t = {title: "", confirmText: "涓婁紶闄勪欢绠€鍘�", cancelText: "", callbackChat: null, callbackUpload: null},
            e = $.extend(t, e), i = "", n = "upload-dialog-box", a = "dialog_cancel", s = "";
        e.cancelText && ("鍏堣亰鑱�" == e.cancelText && (a = "dialog_upload_deliver_chat"), i = '<button type="button" class="btn btn-outline" ka="' + a + '">' + e.cancelText + "</button>", n = "upload-dialog-deliver"), e.isComplete || (s = '<p>娌℃湁闄勪欢绠€鍘�&nbsp;<a href="/web/geek/guide" ka="nlp_no_resume">&nbsp;鍦ㄧ嚎濉啓</a></p>'), $.dialog({
            content: '<div class="' + n + '"><p>鏀寔DOC銆丏OCX銆丳DF銆丣PG銆丳NG鏍煎紡闄勪欢</p><p class="red">鏂囦欢澶у皬涓嶈秴杩�8M</p><div class="btns">' + i + '<a href="javascript:;" class="btn btn-file">' + e.confirmText + '<input id="fileupload" type="file" name="file" ka="user-resume-upload-file" title="" accept="' + Attachment.getResumeAccept() + '"></a></div>' + s + "</div>",
            title: e.title,
            closeText: !0,
            confirmText: "",
            cancelText: "",
        ...
        Attachment.previewErrorNum = 0, el.fileupload({
            ...
            add: function (e, t) {
                var i = t.files[0], n = i.name, a = i.size;
                if (fileInfo = i, reg.test(n)) if (a > 8e6) {
        ...
        var t = t || {}, i = "", n = "", a = "";
        if (t.name) {
            var s = t.name.split(".").length;
            i = t.name.split(".")[s - 1]
        }
        switch (e) {
            case"added":
                n = '<div class="data-tips"><div class="tip-inner"><p><i class="icon-upload-resume"></i></p><p class="gray"><i class="icon-loading-chrysanthemum"></i>姝ｅ湪涓婁紶涓�</p></div></div>', a = '<h3 class="title">闄勪欢鐘舵€�</h3>' + (t.name ? "<p>闄勪欢鍚嶇О锛�" + t.name + "</p>" : "") + '<p class="gray">闄勪欢鍐呭鍙兘棰勮10椤碉紝涓旀湁涓€瀹氬帇缂╋紝浣嗕笉褰卞搷Boss鐪嬪埌鍐呭鐨勮川閲�</p>';
                break;
            case"success":
                n = '<div class="img-box"><img src="/wapi/zpgeek/resume/preview4geek/' + t.previewUrl + '"/></div>', a = '<h3 class="title">闄勪欢纭</h3>' + (t.name ? "<p>闄勪欢鍚嶇О锛�" + t.name + "</p>" : "") + (t.size ? "<p>闄勪欢澶у皬锛�" + parseInt(t.size / 1024) + " KB</p>" : "") + (i ? "<p>闄勪欢鏍煎紡锛�" + i + "</p>" : "") + '<p class="gray">闄勪欢鍐呭鍙兘棰勮10椤碉紝涓旀湁涓€瀹氬帇缂╋紝浣嗕笉褰卞搷Boss鐪嬪埌鍐呭鐨勮川閲忋€�</p><p class="gray">Boss灏嗕綘杞彂缁欏悓浜嬫椂锛屽彲鑳戒細灏嗛檮浠剁畝鍘嗕竴骞惰浆鍙戙€�</p><div class="btns"><a href="javascript:;" class="btn btn-file btn-outline">閲嶆柊閫夋嫨<input id="fileupload" type="file" name="file" ka="user_resume_add_reupload" title="" accept="' + Attachment.getResumeAccept() + '"></a><button type="button" class="btn btn-sure" ka="user_resume_add_sure">纭畾娣诲姞</button></div>';
                break;
            case"preview":
                n = '<div class="data-tips"><div class="tip-inner"><p><i class="icon-upload-resume"></i></p><p class="gray">棰勮澶辫触</p><p class="gray">鐐瑰嚮 <a href="javascript:;" class="link-refresh text-blue" ka="user-resume-refresh">鍒锋柊</a> 閲嶆柊棰勮</p></div></div>', a = '<h3 class="title">闄勪欢鐘舵€�</h3><p>闄勪欢灏嗗湪鎶曢€掑悗琚獴oss棰勮鏌ョ湅锛岃纭鏄剧ず姝ｇ‘锛堥瑙堝彧灞曠ず鍓�10椤碉級</p>' + (t.name ? '<p class="gray">闄勪欢鍚嶇О锛�' + t.name + "</p>" : "") + '<div class="btns"><a href="javascript:;" class="btn btn-through btn-file">閲嶆柊閫夋嫨<input id="fileupload" type="file" name="file" ka="user-resume-upload-fail-reupload" title="" accept="' + Attachment.getResumeAccept() + '"></a></div><p class="gray">鏀寔doc锛宒ocx锛宲df锛宩pg锛宲ng鏍煎紡闄勪欢锛屾枃浠跺ぇ灏忎笉瓒呰繃8M</p>';
                break;
            case"fail":
                n = '<div class="data-tips"><div class="tip-inner"><p><i class="icon-upload-resume"></i></p><p class="gray">涓婁紶澶辫触</p><p class="gray">璇烽噸鏂颁笂浼狅紝濡備粛鐒舵棤娉曟垚鍔燂紝鍙皾璇曟洿鏀规枃浠舵牸寮�</p></div></div>', a = '<h3 class="title">闄勪欢鐘舵€�</h3><p>闄勪欢灏嗗湪鎶曢€掑悗琚獴oss棰勮鏌ョ湅锛岃纭鏄剧ず姝ｇ‘锛堥瑙堝彧灞曠ず鍓�10椤碉級</p>' + (t.name ? '<p class="gray">闄勪欢鍚嶇О锛�' + t.name + "</p>" : "") + '<div class="btns"><a href="javascript:;" class="btn btn-through btn-file">閲嶆柊閫夋嫨<input id="fileupload" type="file" name="file" ka="user-resume-upload-fail-reupload" title="" accept="' + Attachment.getResumeAccept() + '"></a></div><p class="gray">鏀寔doc锛宒ocx锛宲df锛宩pg锛宲ng鏍煎紡闄勪欢锛屾枃浠跺ぇ灏忎笉瓒呰繃8M</p>'
        }
        return '<div class="pop-resume-box"><div class="resume-wrap"><h3 class="title">涓婁紶闄勪欢</h3>' + n + '</div><div class="resume-sider">' + a + "</div></div>"
        ...
        var i = e.closest("li").find(".basis").text(), n = i.replace(/\s/g, "").split("."),
            a = n.splice(0, n.length - 1), s = n.splice(n.length - 1, 1);
        $.dialog({
            content: '<div class="pop-resume-rename"><p>璇疯緭鍏ヤ綘纭畾瑕佷慨鏀圭殑绠€鍘嗗悕绉�</p><p><input maxlength="30" placeholder="璇疯緭鍏ョ畝鍘嗗悕绉�" value="' + a + '" class="ipt" /></p></div>',
            title: "淇敼闄勪欢绠€鍘嗗悕绉�",
            wrapClass: "dialog-primary-default",
            onOpen: function (e) {
            ...
            onConfirm: function (t) {
                ...
                if (a.length) {
                    a.length > 30 ? $.toast({content: "瀛楁暟涓嶈兘瓒呰繃30", type: "warning"}) : ($.ajax({
                        type: "POST",
                        url: "/wapi/zpgeek/resume/attachment/name/update.json",
                        data: {resumeId: i, customName: a + "." + s},
                        dataType: "json",
                        success: function (e) {
                            0 == e.code ? ($.toast({
                                content: "閲嶅懡鍚嶆垚鍔�",
        ...
        for (var i = "", n = 0, a = "", s = e.resumeList || [], o = 0; o < s.length; o++) a += '<li><div class="side">' + s[o].uploadTime + '<span class="size">' + s[o].resumeSizeDesc + '</span><input type="radio" value="' + (s[o].resumeId || s[o].encryptId) + '" /></div><img src="' + staticPath + "/web/geek/images/icon-" + s[o].suffixName.toLowerCase() + '.png" alt="" />' + (s[o].showName || s[o].customName || s[o].originalName) + "</li>";
        a = '<ul class="resume-list">' + a + "</ul>", $.dialog({
            content: a,
...
var UserCheck = {
    checkPhone: function (e, t, i, n, a, s) {
        ...
        var n = e.find(".btn-sms"), a = e.find(".btn-sure"), s = t ? n.data("url") : e.attr("action");
        t || a.html("鎻愪氦涓�...").addClass("btn-disabled"), $.ajax({
            url: s, type: "post", dataType: "json", data: e.serialize(), success: function (s) {
                s.zpData && (s.rescode = 0 == s.code ? 1 : 1 == s.code ? 0 : s.code, s.type = s.zpData.type, s.resmsg = s.message);
                var o = e.attr("action");
                if (1 != s.rescode && VerrifyCode.reset(e.find(".row-code")), t) if (2 == s.type) if (n.html('宸插彂閫�(<em class="num">60s</em>)').addClass("count-down btn-disabled"), UserCheck.countDown(n, function () {
                    n.html("鍙戦€侀獙璇佺爜").removeClass("count-down btn-disabled")
                }), n.parent().find(".ipt-sms").focus(), 4 == s.errorType) {
                ...
                } else UserCheck.showError(e, $(".phonecode-error"), s.resmsg, !0), $.toast({
                    type: "error",
                    content: s.resmsg
                }), n.html("鍙戦€侀獙璇佺爜").removeClass("count-down btn-disabled"); else if (setTimeout(function () {
                    a.html("纭畾").removeClass("btn-disabled")
                }, 500), "/login/phone.json" == o) if (1 == s.rescode) Sign.callbackSms(e, s), i.remove(); else {
                    i.remove();
                    var r = {code: 0 == s.rescode ? 1 : 1 == s.rescode ? 0 : s.rescode, message: s.resmsg, zpData: s};
                    Sign.dealSignFail($(".sign-pwd").find("form"), n, t, r)
                } else "/wechat/account/unbind.json" == o ? 1 == s.rescode ? (i.remove(), $.toast({
                    type: "success",
                    content: "瑙ｇ粦鎴愬姛"
                }), Account.elSideNav.find("li").eq(Account.convertTypeToIndex(5)).click()) : $.toast({
                    type: "error", content: s.resmsg
                }) : "/wapi/zppassport/login/phone" == o && (0 == s.code ? (Sign.callbackSms(e, s.zpData), i.remove()) : (i.remove(), Sign.dealSignFail($(".sign-pwd").find("form"), n, t, s)))
            }, error: function () {
                $.toast({type: "error", content: "鏈嶅姟鍣ㄥ紓甯�"})
            }
        })
...
var VERRIFYCODETYPE = 1, CODE_JIYAN_URL = "/wapi/zppassport/send/smsCodeV2",
    LOGIN_JIYAN_URL = "/wapi/zppassport/login/phoneV2", ACCOUNT_JIYAN_URL = "/wapi/zppassport/login/accountV2",
    CODE_IMG_URL = "/wapi/zppassport/send/smsCodeV3", LOGIN_IMG_URL = "/wapi/zppassport/login/phoneV3",
    ACCOUNT_IMG_URL = "/wapi/zppassport/login/accountV3", CODE_ALI_URL = "/wapi/zppassport/send/smsCode",
    LOGIN_ALI_URL = "/wapi/zppassport/login/phone", ACCOUNT_ALI_URL = "/wapi/zppassport/login/account";
seriesLoadScripts("https://static.zhipin.com/library/js/sdk/verify-sdk-v2.js", function () {
    Sign.VerrifySuccessCallback = function (e) {
        ...
        if (1 == e.type) {
            e.challenge, e.validate, e.seccode;
            t.find('input[name="challenge"]').length || (t.append('<input type="hidden" name="challenge"></input>'), t.append('<input type="hidden" name="validate"></input>'), t.append('<input type="hidden" name="seccode"></input>')), t.find('input[name="challenge"]').val(e.challenge), t.find('input[name="validate"]').val(e.validate), t.find('input[name="seccode"]').val(e.seccode)
        } else 2 == e.type ? (t.find('input[name="csessionId"]').length || (t.append('<input type="hidden" name="csessionId"></input>'), t.append('<input type="hidden" name="csig"></input>'), t.append('<input type="hidden" name="ctoken"></input>')), t.find('input[name="csessionId"]').val(e.csessionId), t.find('input[name="csig"]').val(e.csig), t.find('input[name="ctoken"]').val(e.ctoken)) : (t.find('input[name="randKey"]').length || (t.append('<input type="hidden" name="randKey"></input>'), t.append('<input type="hidden" name="captcha"></input>')), t.find('input[name="randKey"]').val(e.randKey));
        ...
        var t = $(e.el).parents("form");
        VERRIFYCODETYPE = e.type, 1 == e.type ? t.find(".sign-tab .cur").hasClass("link-signin") ? t.attr("action", ACCOUNT_JIYAN_URL) : (t.attr("action", LOGIN_JIYAN_URL), t.find(".btn-sms").attr("data-url", CODE_JIYAN_URL)) : 2 == e.type ? t.find(".sign-tab .cur").hasClass("link-signin") ? t.attr("action", ACCOUNT_ALI_URL) : (t.attr("action", LOGIN_ALI_URL), t.find(".btn-sms").attr("data-url", CODE_ALI_URL)) : t.find(".sign-tab .cur").hasClass("link-signin") ? t.attr("action", ACCOUNT_IMG_URL) : (t.attr("action", LOGIN_IMG_URL), t.find(".btn-sms").attr("data-url", CODE_IMG_URL))
    }, $(".top-sign-box").length || $(".search-job-list-wrap").find(".sign-quick").length || $(".job-box .sign-wrap-v2").find(".sign-quick").length || $(".sign-form:visible").find(".row-code").length && ($(".sign-form:visible").find(".row-code").html(""), new VerifyCodeSDK({
...
var VerrifyCode = function () {
    return {
        reset: function (e) {
            ...
            t.find("input[name=csig]").val(""), t.find("input[name=ctoken]").val(""), t.find("input[name=csessionId]").val(""), t.find('input[name="challenge"]').val(""), t.find('input[name="validate"]').val(""), t.find('input[name="seccode"]').val(""), t.find('input[name="randKey"]').val("")
        }
    }
}(), Sign = {
    xhrs: {},
    ...
    init: function (e) {
        ...
        if (Sign.source = getQueryString("s"), Sign.source && (Sign.directUrls = {
            ...
            0 === e ? (i.filter(".geek-slide").removeClass("hide"), i.filter(".boss-slide").addClass("hide")) : 1 === e && (i.filter(".geek-slide").addClass("hide"), i.filter(".boss-slide").removeClass("hide")), $(this).addClass("cur").siblings().removeClass("cur"), $(this).parents(".sign-form").find(".row-code").html(""), new VerifyCodeSDK({
    ...
    showPannel: function (e, t) {
        ...
        s.attr("id", a), s.length && (s.html(""), VerrifyCode.reset(s), "undefined" != typeof VerifyCodeSDK && new VerifyCodeSDK({
            dom: s[0],
            success: function (e) {
                Sign.VerrifySuccessCallback(e)
            },
    ...
    checkForm: function (e, t) {
        var e = e, i = e.find(".ipt-phone"), n = e.find('input[name="regionCode"]'), a = e.find(".ipt-pwd"),
            s = e.find(".ipt-sms"), o = e.find("input[name=policy]"),
            r = (e.find("input[name=policy]"), e.find(".row-code")), c = "";
        if (1 == VERRIFYCODETYPE ? c = e.find("input[name=challenge]") : 2 == VERRIFYCODETYPE && (c = e.find("input[name=csessionId]")), i.length) {
            if ("" == i.val()) {
        ...
        if (a.length) {
            if ("" == a.val()) return Sign.showError(a, "璇峰～鍐欏瘑鐮�"), a.focus(), !1;
            Sign.hideError(a)
        }
        if (e.parents(".sign-quick").length && t) {
            if (e.find(".form-row-verify").length) e.find(".form-row-verify").show(); else {
                e.find(".form-row").last().append('<div class="form-row-verify"></div>');
                var l = new VerifyCodeSDK({
                    dom: e.find(".form-row-verify")[0], success: function (i) {
                        Sign.VerrifySuccessCallback(i), 3 != l.type ? setTimeout(function () {
                            Sign.postData(e, t), e.find(".form-row-verify").remove()
                        }, 500) : (e.find(".form-row-verify .picture_box").append('<button class="btn btn-img">纭畾</button>'), e.on("click", ".btn-img", function () {
                            if (e.find('input[name="captcha"]').val(l.getInputValue()), !e.find('input[name="captcha"]').val()) return void $.toast({
                                type: "error",
                                content: "璇峰～鍐欏浘鐗囬獙璇佺爜"
                            });
                            Sign.postData(e, t), e.find(".form-row-verify").remove()
                        }))
                    }, ready: function (e) {
        ...
        if (3 != VERRIFYCODETYPE) {
            if (!c.length) return e.parents(".sign-quick").length ? $.toast({
                type: "error",
                content: "璇锋粦鍔ㄥ畬鎴愰獙璇�"
            }) : Sign.showError(r, "璇锋粦鍔ㄥ畬鎴愰獙璇�"), c.focus(), !1;
            if ("" == c.val()) return e.parents(".sign-quick").length ? $.toast({
                type: "error",
                content: "璇锋粦鍔ㄥ畬鎴愰獙璇�"
            }) : Sign.showError(r, "璇锋粦鍔ㄥ畬鎴愰獙璇�"), c.focus(), !1;
            Sign.hideError(c)
        } else {
            var c = e.find(".input_code"), d = c.val();
            if (!c.length || "" == d) return e.parents(".sign-quick").length ? $.toast({
                type: "error",
                content: "璇峰～鍐欏浘鐗囬獙璇佺爜"
            }) : Sign.showError(r, "璇峰～鍐欏浘鐗囬獙璇佺爜"), c.focus(), !1;
            e.find("input[name=captcha]").val(d), Sign.hideError(c)
        }
        if (!t && o.length && !o.is(":checked")) return alert("璇烽槄璇诲苟鍚屾剰BOSS鐩磋仒鐢ㄦ埛鍗忚锛屾柟鍙敞鍐�"), !1;
        if (s.length && !t) {
            if ("" == s.val()) return Sign.showError(s, "璇峰～鍐欑煭淇￠獙璇佺爜"), s.focus(), !1;
            if (!s.val().match(/^.{4,6}$/)) return Sign.showError(s, "璇峰～鍐欐纭殑鐭俊楠岃瘉鐮�"), s.focus(), !1;
            if (s.val().match(/\D+/)) return Sign.showError(s, "璇峰～鍐欐纭殑鐭俊楠岃瘉鐮�"), s.val(""), s.focus(), !1;
            Sign.hideError(s)
        }
        Sign.postData(e, t)
    },
    postData: function (formEl, isSms) {
        ...
        if (isSms) {
            ...
            url = btnSms.attr("data-url"), btnSms.addClass("btn-disabled").html("璇风◢鍚�")
        } else {
    ...
    dealSignResult: function (e, t, i, n, a, s) {
        ...
        if ((0 != s.code && 6 != s.code || 2 == o.type && r || 4 == o.type) && (VerrifyCode.reset(e.find(".row-code")), e.find(".row-code").is(":visible") && (e.find(".row-code").html(""), new VerifyCodeSDK({
            ...
            if (t.hasClass("sign-pwd") && Sign.callbackPwd(e, o), t.hasClass("sign-sms")) if (a) if (i.html('宸插彂閫� <em class="num">60s</em>').addClass("count-down btn-disabled"), Sign.countDown(i, function () {
            ...
            if (t.hasClass("sign-register")) if (a) {
            ...
            if (t.hasClass("sign-bind-wechat-signin")) if (a) if (2 == o.type) if (i.html('宸插彂閫� <em class="num">60s</em>').addClass("count-down btn-disabled"), Sign.countDown(i, function () {
                i.html("鍙戦€侀獙璇佺爜").removeClass("count-down btn-disabled")
            }), i.parent().find(".ipt-sms").focus(), 4 == o.errorType) {
                Sign.showError(e, "鑾峰彇楠岃瘉鐮佽繃浜庨绻侊紝璇风◢鍚庡啀璇�", !0);
                try {
            ...
            } else Sign.showError(e, s.message, !0), i.html("鍙戦€侀獙璇佺爜").removeClass("count-down btn-disabled"); else Sign.callbackWechatBind(e, o);
            if (t.hasClass("sign-bind-wechat-signup")) if (a) if (2 == o.type) Sign.showError(e, s.message, !0), i.html("鍙戦€侀獙璇佺爜").removeClass("count-down btn-disabled"); else {
                i.html('宸插彂閫� <em class="num">60s</em>').addClass("count-down btn-disabled"), Sign.countDown(i, function () {
                    i.html("鍙戦€侀獙璇佺爜").removeClass("count-down btn-disabled")
            ...
            if (t.hasClass("sign-resume")) if (a) if (i.html('宸插彂閫� <em class="num">60s</em>').addClass("count-down btn-disabled"), Sign.countDown(i, function () {
                i.html("鍙戦€侀獙璇佺爜").removeClass("count-down btn-disabled")
            }), i.parent().find(".ipt-sms").focus(), 4 == o.errorType) {
                Sign.showError(e, "鑾峰彇楠岃瘉鐮佽繃浜庨绻侊紝璇风◢鍚庡啀璇�", !0);
                try {
            ...
            if (t.hasClass("sign-quick")) if (a) if (i.html('宸插彂閫� <em class="num">60s</em>').addClass("count-down btn-disabled"), Sign.countDown(i, function () {
                i.html("鍙戦€侀獙璇佺爜").removeClass("count-down btn-disabled")
        ...
        } else 4545 == s.code ? Sign.showError(e, s.message, !0) : 4563 == s.code ? $.dialog({
            title: "",
            content: s.message || "鎮ㄧ洰鍓嶅湪瑙傚療鏈燂紝璇风櫥褰旴OSS鐩磋仒APP绔繘琛屾嫑鑱�",
            closeText: !0,
            cancelText: !1,
            confirmText: "濂界殑",
            wrapClass: "dialog-prop-default"
    ...
    dealSignFail: function (e, t, i, n) {
        ...
        if (0 == n.code) {
            ...
            if (7 == n.code && 2 == a.bizcode) {
                ...
                Sign.showConfirm(s)
            } else if (7 != n.code || 3 != a.bizcode && 4 != a.bizcode) if (7 != n.code || 6 != a.bizcode && 8 != a.bizcode) if (7 == n.code && 5 == a.bizcode) {
                var s = {
                    content: '<div class="sign-hunter-gray">濡傛灉鎮ㄦ槸鐚庡ご锛岃璇锋嫧鎵撳鏈嶇數璇濓細400-0655-799杩涜鐢宠瘔銆傚悓浜嬪凡缁忔敞鍐屾垚鍔烞oss鐩磋仒鐚庡ご鐗堬紝璇峰皢TA鐨勬墜鏈哄彿鎻愪緵缁欏鏈嶃€�</div>',
                    title: "姝よ处鍙峰湪BOSS鐩磋仒琚娆′妇鎶ワ紝鏆備笉鏀寔浣跨敤",
                    confirmButton: "鐭ラ亾浜�",
                ...
                var s = {
                    content: '<div class="sign-hunter-gray">                            <i class="icon-fail"></i>                            <div class="freeze-container"><p class="reject-title">闈炲父鎶辨瓑锛屾偍鐨勮处鍙峰凡琚喕缁�</p>                            <p class="reject-reason">' + n.message + '</p>                            <p>鎮ㄥ彲浠ラ€氳繃浠ヤ笅鏂瑰紡鐢宠瘔</p>                            <div class="reject-content">                            璇蜂娇鐢ㄩ偖绠憋細' + a.userEmail + "<br />鍙戦€侀偖浠惰嚦boss@kanzhun.com<br />                            閭欢鏍囬鏍煎紡锛氬喕缁撶敵璇�+鎮ㄧ殑娉ㄥ唽鎵嬫満鍙�<br />                            閭欢鍐呭璇峰～鍐欐偍鐨勫叕鍙稿叏绉板拰鍏朵粬鐢宠瘔鍐呭                            </div></div>                            </div>",
                    title: "",
                    closeIcon: !0,
                    confirmButton: "鐭ラ亾浜�",
            ...
            if (1 == a.bizcode || 0 == a.bizcode) {
                ...
                var s = {
                    content: '<p>鎮ㄥ凡娉ㄥ唽杩嘊OSS鐩磋仒锛屾槸鍚﹀垏鎹负鐚庡ご韬唤锛�</p><ul class="pop-content"><li>涓虹墰浜烘湇鍔★紝涓ョ鐚庡ご鍐掑厖BOSS</li><li>鍒囨崲涓虹寧澶磋韩浠藉悗锛屾偍灏嗚幏寰桞OSS鐩磋仒鐨勯珮绔墰浜虹畝鍘嗭紝浜湁鏇村叿绔炰簤鍔涚殑鐚庡ご浼氬憳鏈嶅姟銆�</li><li class="bold">鎮ㄧ殑BOSS鐩磋仒璐︽埛涓墿浣�' + a.beancount + "涓洿璞嗭紝鍒囨崲涓虹寧澶磋韩浠藉悗鏃犳硶浣跨敤銆備絾鐩磋眴浠嶄細淇濈暀銆�</li><li>鐚庡ご韬唤鐢熸晥鍚庯紝鎮ㄤ笉鑳戒互鐗涗汉鎴朆OSS韬唤鐧诲綍APP</li></ul>",
                    title: "鎮ㄥ皢瑕佸垏鎹负鐚庡ご韬唤",
                    cancelButton: "鍙栨秷",
                    confirmButton: "鍒囨崲涓虹寧澶�",
                    columnClass: "pop-sign-hunter",
        ...
        }), i && t.html("鍙戦€侀獙璇佺爜").removeClass("btn-disabled"), e.find(".ipt-code").val(""), e.find(".verifyimg").click(); else if (4562 == n.code) $.dialog({
            title: "鎻愮ず",
            content: n.message || "闈炲父鎶辨瓑锛岃璐﹀彿缁戝畾鐨勬墜鏈哄彿褰掑睘鍦板尯鏆傛椂鏃犳硶浣跨敤鎷涜仒鏈嶅姟銆傛偍鍙互閫夋嫨鍒囨崲鐗涗汉韬唤锛屼娇鐢ㄦ眰鑱屾湇鍔�",
            closeText: !0,
            type: "warning",
            cancelText: !1,
            confirmText: "濂界殑",
            wrapClass: "dialog-prop-default"
        }), i && t.html("鍙戦€侀獙璇佺爜").removeClass("btn-disabled"), e.find(".ipt-code").val(""); else if (n.code > 4e5 && n.code < 401e3) if (Sign.tooLongCode.indexOf(n.code)) {
            var o = "";
            switch (n.code) {
                case 400026:
            ...
            n.zpData && (n.zpData.link && (c = n.zpData.link), n.zpData.tel && (r = function (e, t) {
                var i, n, a = $.trim(e), s = "", o = "", r = 0, c = 0;
                for (t.indexOf("-") > -1 ? (i = t.split("-"), o = "-") : (i = t.split(" "), o = "-"), r = 0; r < i.length; r++) n = c + Number(i[r]), s += a.substring(c, n), r < i.length - 1 && (s += o), c = n;
                return s
    ...
    dealSignResultOld: function (e, t, i, n, a, s) {
        ...
        if ((1 != s.rescode && 6 != s.rescode || 2 == s.type && o || 4 == s.type) && (VerrifyCode.reset(e.find(".row-code")), e.find(".row-code").is(":visible") && (e.find(".row-code").html(""), new VerifyCodeSDK({
            dom: e.find(".row-code")[0],
            success: function (e) {
                Sign.VerrifySuccessCallback(e)
            },
            ...
            if (t.hasClass("sign-pwd") && Sign.callbackPwd(e, s), t.hasClass("sign-sms")) if (a) if (2 == s.type) if (i.html('宸插彂閫� <em class="num">60s</em>').addClass("count-down btn-disabled"), Sign.countDown(i, function () {
                i.html("鍙戦€侀獙璇佺爜").removeClass("count-down btn-disabled")
            }), i.parent().find(".ipt-sms").focus(), 4 == s.errorType) {
                Sign.showError(e, "鑾峰彇楠岃瘉鐮佽繃浜庨绻侊紝璇风◢鍚庡啀璇�", !0);
                try {
                    _T.sendEvent("signin_sms_send_lot")
                } catch (e) {
            ...
            } else Sign.showError(e, s.resmsg, !0), i.html("鍙戦€侀獙璇佺爜").removeClass("count-down btn-disabled"); else Sign.callbackSms(e, s);
            if (t.hasClass("sign-register")) if (a) if (2 == s.type) Sign.showError(e, s.resmsg, !0), i.html("鍙戦€侀獙璇佺爜").removeClass("count-down btn-disabled"); else if (i.html('宸插彂閫� <em class="num">60s</em>').addClass("count-down btn-disabled"), Sign.countDown(i, function () {
                i.html("鍙戦€侀獙璇佺爜").removeClass("count-down btn-disabled")
            }), i.parent().find(".ipt-sms").focus(), 4 == s.errorType) {
                Sign.showError(e, "鑾峰彇楠岃瘉鐮佽繃浜庨绻侊紝璇风◢鍚庡啀璇�", !0);
                try {
            ...
            } else "function" == typeof _PAGE.RegisterCallback ? _PAGE.RegisterCallback() : QuickSign.callbackRegister(e, s);
            if (t.hasClass("sign-bind-wechat-signin")) if (a) if (2 == s.type) if (i.html('宸插彂閫� <em class="num">60s</em>').addClass("count-down btn-disabled"), Sign.countDown(i, function () {
                i.html("鍙戦€侀獙璇佺爜").removeClass("count-down btn-disabled")
            }), i.parent().find(".ipt-sms").focus(), 4 == s.errorType) {
                Sign.showError(e, "鑾峰彇楠岃瘉鐮佽繃浜庨绻侊紝璇风◢鍚庡啀璇�", !0);
                try {
            ...
            } else Sign.showError(e, s.resmsg, !0), i.html("鍙戦€侀獙璇佺爜").removeClass("count-down btn-disabled"); else Sign.callbackWechatBind(e, s);
            if (t.hasClass("sign-bind-wechat-signup")) if (a) if (2 == s.type) Sign.showError(e, s.resmsg, !0), i.html("鍙戦€侀獙璇佺爜").removeClass("count-down btn-disabled"); else {
                i.html('宸插彂閫� <em class="num">60s</em>').addClass("count-down btn-disabled"), Sign.countDown(i, function () {
                    i.html("鍙戦€侀獙璇佺爜").removeClass("count-down btn-disabled")
                }), i.parent().find(".ipt-sms").focus();
                try {
            ...
            } else Sign.callbackWechatBindRegister(e, s);
            if (t.hasClass("sign-resume")) if (a) if (i.html('宸插彂閫� <em class="num">60s</em>').addClass("count-down btn-disabled"), Sign.countDown(i, function () {
                i.html("鍙戦€侀獙璇佺爜").removeClass("count-down btn-disabled")
            }), i.parent().find(".ipt-sms").focus(), 4 == s.errorType) {
                Sign.showError(e, "鑾峰彇楠岃瘉鐮佽繃浜庨绻侊紝璇风◢鍚庡啀璇�", !0);
            ...
            } else AnalysisResume.signOrRegisterCallback(e, s);
            if (t.hasClass("sign-quick")) if (a) if (2 == s.type) Sign.showError(e, s.resmsg, !0), i.html("鍙戦€侀獙璇佺爜").removeClass("count-down btn-disabled"); else if (i.html('宸插彂閫� <em class="num">60s</em>').addClass("count-down btn-disabled"), Sign.countDown(i, function () {
                i.html("鍙戦€侀獙璇佺爜").removeClass("count-down btn-disabled")
            }), i.parent().find(".ipt-sms").focus(), 4 == s.errorType) {
                Sign.showError(e, "鑾峰彇楠岃瘉鐮佽繃浜庨绻侊紝璇风◢鍚庡啀璇�", !0);
                try {
            ...
            } else QuickSign.callbackRegister(e, s)
        } else Sign.dealSignFailOld(e, i, a, s);
        a || n.removeClass("btn-disabled")
    },
    dealSignFailOld: function (e, t, i, n) {
        if (0 == n.rescode) {
            ...
            switch (n.rescode) {
                case 400026:
                    s = "鏍规嵁鐩稿叧娉曞緥瑙勫畾锛屽洜鎮ㄦ湭婊�16鍛ㄥ瞾锛屾殏涓嶆敮鎸佷娇鐢紝鐩磋嚦鎮ㄥ勾婊�16鍛ㄥ瞾璐﹀彿鑷姩瑙ｅ喕锛�";
                    break;
                case 400027:
                    s = "璐﹀彿宸插喕缁擄紝璇风櫥褰旴OSS鐩磋仒 APP 鎸夌収鎻愮ず瀹屾垚瑙ｅ喕鎿嶄綔銆�";
                    break;
                case 400021:
                    s = "璇ユ墜鏈哄彿宸叉敞閿€锛屾棤娉曟敞鍐�";
                    break;
                case 400033:
                case 400034:
                    s = "鎮ㄧ殑璐︽埛瀛樺湪瀹夊叏闅愭偅锛岃浣跨敤鐭俊楠岃瘉鐮佺櫥褰曘€�";
                    break;
                default:
                    s = n.resmsg
            }
    ...
    callbackPwd: function (e, t) {
        ...
        return t.commonDevice ? void (window.location.href = "https://www.zhipin.com/user/safe?uuid=" + t.uuid) : Sign.source ? void (window.location.href = Sign.setWxUrlRandomParam(Sign.directUrls[Sign.source])) : isZpdesk && 1 != t.identity ? void Sign.showDeskGeekTip() : ($(".semwrap").length && (window.location.href = "/"), void (1 == t.identity ? 0 == t.compStep ? window.location.href = decodeURIComponent(t.toUrl) : 1 == t.compStep ? window.location.href = t.webHost + "/web/boss/guide/" : 2 == t.compStep && (window.location.href = t.webHost + "/boss/complete/job.html") : t.toUrl ? window.location.href = Sign.setWxUrlRandomParam(decodeURIComponent(t.toUrl)) : 1 == t.identity ? window.location.href = Sign.setWxUrlRandomParam("https://www.zhipin.com/chat/im") : $(".page-sign").length ? window.location.href = Sign.setWxUrlRandomParam("https://www.zhipin.com/") : window.location.href = Sign.setWxUrlRandomParam(window.location.href)))
    },
    ...
    callbackWechatBindRegister: function (e, t) {
        var i = $(".sign-wrap"), n = e.find('input[name="purpose"]').val(), a = "g";
        "1" == n && (a = "b");
        try {
        ...
        if (e.closest(".pop-sign-box").length && (i = e.closest(".pop-sign-box")), t.toUrl) {
            ...
            var s = "";
            s = -1 != t.toUrl.indexOf("http") ? t.toUrl : "https://www.zhipin.com" + t.toUrl, window.location.href = decodeURIComponent(s)
    ...
    callbackRegister: function (e, t) {
        ...
        if (e.closest(".pop-sign-box").length && (i = e.closest(".pop-sign-box")), t.commonDevice) return void (window.location.href = t.webHost + "/user/safe?uuid=" + t.uuid);
        if (t.toUrl) {
    ...
    callbackCheckRegister: function (e, t) {
        ...
        e.parents(".login-wechat .register-box").addClass("hide"), i.removeClass("hide"), i.find(".ipt-phone").val(t.account), Sign.init(i), t.isRegistered ? (n.attr("action", "/login/headhunter/phone.json"), n.find('input[name="smsType"]').val(4), a.text("鐧诲綍锛屽苟缁戝畾鎵嬫満鍙�")) : (n.attr("action", "/registe/headhunter/save.json"), n.parents(".sign-form").removeClass(".sign-sms"), n.find('input[name="smsType"]').val(5), a.text("娉ㄥ唽"), n.parents(".sign-form").removeClass("sign-sms").addClass("sign-register"))
    },
    ...
    showError: function (e, t, i) {
        var n = e.closest(".sign-form"), a = e.closest(".form-row").find(".tip-error");
        if (a.length || (a = n.find(".tip-error-form")), a.length || (a = n.find(".tip-error").eq(0)), a.text(t).show(), "鐭俊楠岃瘉鐮侀敊璇�" == t && n.find(".ipt-sms").focus().val(""), i) try {
    ...
    scanJump: function (e, t, i, n) {
        $.ajax({
            ...
            success: function (t) {
                ...
                var a = "";
                $(".semwrap").length && (a = n.indexOf("?") > -1 ? "&jumpUrl=/" : "?jumpUrl=/");
                var s = e.find(".sign-scan").length ? e.find(".sign-scan").data("flow") : "web";
                "validate" in i && i.validate ? (Sign.sendKaEvent(s + "_done"), isZpdesk ? Sign.checkDeskIsBoss(function (e) {
                    1 == e ? window.location.href = n : Sign.showDeskGeekTip()
                }) : window.location.href = n + a) : "allweb" in i && i.allweb ? (Sign.sendKaEvent(s + "_done"), isZpdesk ? Sign.checkDeskIsBoss(function (e) {
                    1 == e ? window.location.href = n + a : Sign.showDeskGeekTip()
                }) : window.location.href = n + a) : ("validate" in i && i.validate, Sign.sendKaEvent(s + "_error"), setTimeout("window.location.reload()", 3e3))
            },
            error: function () {
    ...
    scanPending: function (e) {
        ...
        t && e.find(".sign-scan").is(":visible") && $.ajax({
            ...
            timeout: 1e5,
            success: function (a) {
                a.scaned ? a.newScaned ? ($(".sign-scan .qrcode-box").hide(), $(".sign-scan .text-tip").hide(), $(".sign-scan .login-step-box").show(), n.scanGetHeadImg(t), n.scanLogin(e, t, a, i + t)) : n.scanJump(e, t, a, i + t) : e.find(".sign-scan").is(":visible") && "none" == $(".sign-scan .invalid-box").css("display") && Sign.scanPending(e)
            },
            error: function () {
                e.find(".sign-scan").is(":visible") && "none" == $(".sign-scan .invalid-box").css("display") && setTimeout(function () {
                    Sign.scanPending(e)
    ...
    scanGetHeadImg: function (e) {
        $.ajax({
            ...
            timeout: 1e5,
            success: function (e) {
                0 == e.code && e.zpData && e.zpData.large ? $(".sign-scan .login-step-box img").attr("src", e.zpData.large) : ($.toast({
                    content: e.message,
                    type: "error"
                }), setTimeout(function () {
                    window.location.reload()
        ...
        $.ajax({
            ...
            success: function (i) {
                if (i.scaned) if (i.login) $(".sign-scan .login-step-text .login-step-title").text("姝ｅ湪鐧诲綍..."), $(".sign-scan .login-step-text .login-step-detail").hide(), Sign.scanJump(e, t, i, n); else {
                    ...
                    var s = e.find(".sign-scan");
                    Sign.getRandomkey(e, s, function (t) {
                        Sign.scanPending(e), Sign.scanValid()
                    })
                } else a.scanLogin(e, t, i, n)
            },
            error: function () {
                setTimeout(function () {
                    a.scanLogin(e, t, i, n)
    ...
    drawSideSignBg: function (e) {
        function t() {
            i.clearRect(0, 0, e.width, e.height), 360 === ++s && (s = 0);
            for (var r = o.length - 1; r >= 0; r--) {
                i.fillStyle = o[r];
                var c = (s + 100 * r) * Math.PI / 180, l = Math.sin(c) * n, d = Math.cos(c) * n;
                i.beginPath(), i.moveTo(0, a + l), i.bezierCurveTo(e.width / 2, a + l - n, e.width / 2, a + d - n, e.width, a + d), i.lineTo(e.width, e.height), i.lineTo(0, e.height), i.lineTo(0, a + l), i.closePath(), i.fill()
            }
            requestAnimFrame(t)
        }
        ...
        var n = e.height / 7, a = e.height / 1.3, s = 0, o = ["rgba(255,255,255, 0.4)", "rgba(255,255,255, 0.30)"];
        t()
    }
};
$(function () {
    ...
    try {
        var e = {content: '{                "identity":1,                "items":[                    {                        "action": "action_active",                        "p": "{\\"appKey\\": \\"MeT5lsyaHisySUCH\\",\\"time\\":' + (new Date).getTime() + '}"                    }                ],                "clientInfo": {                    "model": "",                    "version":"",                    "os":"",                    "channel":"",                    "ssid":"",                    "bssid":"",                    "imei":"",                    "longitude":"",                    "dzt":"",                    "latitude":"",                    "network":""                }            }'};
...
var hunterSign = {
    init: function () {
        ...
        if ($("#login_container").length && _PAGE.appid) {
            ...
            setTimeout(function () {
                a.is(":visible") || a.show()
            }, 6e4), a.find(".btn-refresh").on("click", function () {
                setTimeout(function () {
                    a.is(":visible") || a.show()
                }, 6e4), a.hide();
                new WxLogin({
...
var GeekAccount = {
    URL: {
        ...
        $(".account-container .sayhello-form").on("change", ".radio-list .radio input", function () {
            ...
            t.find(".defined-form").addClass("show-defined-form"), t.find(".defined-form .ipt-area").focus(), i.text(n).val(n), t.find('input[name="templateId"]').val($(this).closest("li").find('input[name="sendMsg"]').val()), t.find(".btn-remove").show(), $(window).scrollTop($(".account-container").height()), e.countArea(i),
                t.find(".defined-form .tip-text").text("璇蜂笉瑕佸～鍐欐墜鏈恒€丵Q銆佸井淇＄瓑鑱旂郴鏂瑰紡鎴栧箍鍛婁俊鎭紝鍚﹀垯绯荤粺灏嗗皝绂佹偍鐨勮处鍙凤紒")
        }), i.on("input", function () {
            e.countArea($(this))
        ...
        $.dialog({
            ...
            onConfirm: function (i) {
                ...
                $.ajax({
                    ...
                    type: "POST",
                    data: {templateId: n, candidateId: a},
                    dataType: "JSON",
                    timeout: 3e4,
                    success: function (a) {
                        a.rescode ? ($.toast({
        ...
        a && a.length && (i = i.split(","), a.html("<em" + (n > i[1] ? ' class="red"' : "") + ">" + n + "</em>/" + i[1]))
        ...
        var t = t, i = t.find(".ipt-code"), n = i.attr("data-url"), a = t.find(".randomkey");
        "" == a.val() && $.ajax({
            url: n,
            type: "POST",
            dataType: "json",
            ...
            success: function (t) {
                if (1 == t.rescode) {
                    t.qrId;
                    e.find(".randomkey").val(t.randomKey), a.parent().find(".verifyimg").click(), e.find(".sign-scan .qrcode-box img").attr("src", "/qrcode/" + t.qrId), e.find(".uuid").val(t.qrId)
                }
            },
            error: function (e) {
            }
        ...
        $(".phone-form").on("submit", function (t) {
            $(this);
            t.preventDefault();
            var i = e.formPhoneValidate(), n = e.formMessageCodeValidate(), a = e.formImageCodeValidate();
            i && n && a && $.ajax({
    ...
    init: function () {
        if ($(".top-sign-box").length) {
            ...
            $(".show-code-box").on("click", function () {
                if (!$(this).hasClass("btn-disabled")) {
                    ...
                    if ("" != t && /^(1[3456789][0-9]{9})$/.test(t)) {
                        if ($(".code-form-box").show(), QuickSign.Verify) return;
                    ...
                    } else $.toast({content: "璇疯緭鍏ユ纭殑鎵嬫満鍙�", type: "warning"})
                }
            ...
            QuickSign.VerrifySuccessCallback = function (e) {
                ...
                var t = $(e.el).parents("form");
                QuickSign.VERRIFYCODETYPE = e.type, 1 == e.type ? (t.attr("action", "/wapi/zppassport/login/phoneV2"), t.find(".show-code-box").attr("data-url", "/wapi/zppassport/send/smsCodeV2")) : 2 == e.type ? (t.attr("action", "/wapi/zppassport/login/phone"), t.find(".show-code-box").attr("data-url", "/wapi/zppassport/send/smsCode")) : (t.attr("action", "/wapi/zppassport/login/phoneV3"), t.find(".show-code-box").attr("data-url", "/wapi/zppassport/send/smsCodeV3"))
            }
        }
    }, getRandomkey: function (e, t) {
        var t = t, i = t.find(".ipt-code"), n = i.attr("data-url"), a = t.find(".randomkey");
        ...
        var n = e.find('input[name="purpose"]').val(), a = "g";
        "1" == n && (a = "b");
        try {
            _T.sendEvent(e.closest(".sign-form").data("flow") + "_done_" + a)
        } catch (e) {
        }
        if (t.commonDevice) return void (window.location.href = t.webHost + "/user/safe?uuid=" + t.uuid);
        if (t.isCompletion) if (t.toUrl) {
            $.toast({content: "鐧诲綍鎴愬姛", type: "success"});
            var s = "";
            s = -1 != t.toUrl.indexOf("http") ? t.toUrl : "https://www.zhipin.com" + t.toUrl, setTimeout(function () {
                window.location.href = decodeURIComponent(s)
            }, 500)
        } else window.location.reload(); else {
            var o = "";
            1 == t.identity ? 0 == t.compStep ? (o = "鐧诲綍鎴愬姛", setTimeout(function () {
                window.location.href = decodeURIComponent(t.toUrl)
            }, 500)) : 1 == t.compStep ? (o = t.autoRegister ? "娉ㄥ唽鎴愬姛锛屾鍦ㄤ负鎮ㄨ烦杞埌瀹屽杽椤甸潰" : "鐧诲綍鎴愬姛锛屾鍦ㄤ负鎮ㄨ烦杞埌瀹屽杽椤甸潰", setTimeout(function () {
                window.location.href = t.webHost + "/web/boss/guide/"
            }, 500)) : 2 == t.compStep && (o = t.autoRegister ? "娉ㄥ唽鎴愬姛锛屾鍦ㄤ负鎮ㄨ烦杞埌瀹屽杽椤甸潰" : "鐧诲綍鎴愬姛锛屾鍦ㄤ负鎮ㄨ烦杞埌瀹屽杽椤甸潰", setTimeout(function () {
                window.location.href = t.webHost + "/boss/complete/job.html"
            }, 500)) : (o = t.autoRegister ? "娉ㄥ唽鎴愬姛锛屾鍦ㄤ负鎮ㄨ烦杞埌瀹屽杽椤甸潰" : "鐧诲綍鎴愬姛锛屾鍦ㄤ负鎮ㄨ烦杞埌瀹屽杽椤甸潰", setTimeout(function () {
                window.location.href = t.webHost + "/web/geek/guide"
            }, 500)), $.toast({content: o, type: "success"})
        }
    }, countDown: function (e, t) {
        var i = parseInt(e.find(".num").text().replace("s"), 10);
        Sign.interCount = setInterval(function () {
        ...
        var e = e, i = e.find(".ipt-phone"), n = e.find(".ipt-sms"), a = "";
        if (1 == QuickSign.VERRIFYCODETYPE ? a = e.find("input[name=challenge]") : 2 == QuickSign.VERRIFYCODETYPE && (a = e.find("input[name=csessionId]")), i.length) {
            if ("" == i.val()) {
        ...
        if (3 != QuickSign.VERRIFYCODETYPE) {
            if (a.length) {
                if ("" == a.val()) return $.toast({content: "璇锋粦鍔ㄥ畬鎴愰獙璇�", type: "warning"}), a.focus(), !1;
                Sign.hideError(a)
            }
        } else {
            var a = e.find(".input_code"), s = a.val();
            if ("" == s) return $.toast({content: "璇峰～鍐欏浘鐗囬獙璇佺爜", type: "warning"}), a.focus(), !1;
            e.find("input[name=captcha]").val(s), Sign.hideError(a)
        }
        if (n.length && !t) {
            if ("" == n.val()) return $.toast({content: "璇峰～鍐欑煭淇￠獙璇佺爜", type: "warning"}), n.focus(), !1;
            if (!n.val().match(/^.{4,6}$/)) return $.toast({content: "鐭俊楠岃瘉鐮侀敊璇�", type: "warning"}), n.focus(), !1;
            if (n.val().match(/\D+/)) return $.toast({
                content: "鐭俊楠岃瘉鐮侀敊璇�",
                type: "warning"
            }), n.val(""), n.focus(), !1
        }
        ...
        $.ajax({
            url: url, type: "post", dataType: "json", data: formEl.serialize(), success: function (result) {
                ...
                if (0 !== result.code && new VerifyCodeSDK({
                    dom: formEl.find(".row-code")[0], success: function (e) {
                        QuickSign.VerrifySuccessCallback(e)
                    }, ready: function (e) {
                        QuickSign.VerrifyReadyCallback(e)
                    }
                }), 0 == result.code) if (isSms) if (2 == zpData.type) $.toast({
...
var Settings = {
    init: function () {
        ...
        Settings.post("/autocomplete/maskcompany.json", {searchContent: e}).then(function (n) {
            var a = n.suggestList, s = "", o = "", r = "disabled";
            if (a.length) {
                for (var c = 0; c < a.length; c++) a[c].mark ? o += '<li data-id="' + a[c].encryptComId + '">\t\t\t\t\t\t\t<label class="checkbox">\t\t\t\t\t\t\t\t<span class="gray">宸插睆钄�</span>\t\t\t\t\t\t\t</label>\t\t\t\t\t\t\t<div class="company-name">\t\t\t\t\t\t\t\t<p>' + a[c].company.name + '</p>\t\t\t\t\t\t\t\t<p class="gray">' + (null == a[c].desc ? "" : a[c].desc.hlname) + "</p>\t\t\t\t\t\t\t</div>\t\t\t\t\t\t</li>" : (o += '<li data-id="' + a[c].encryptComId + '">\t\t\t\t\t\t\t<label class="checkbox">\t\t\t\t\t\t\t\t<input type="checkbox" checked="checked">\t\t\t\t\t\t\t\t<span></span>\t\t\t\t\t\t\t</label>\t\t\t\t\t\t\t<div class="company-name">\t\t\t\t\t\t\t\t<p>' + a[c].company.name + '</p>\t\t\t\t\t\t\t\t<p class="gray">' + (null == a[c].desc ? "" : a[c].desc.hlname) + "</p>\t\t\t\t\t\t\t</div>\t\t\t\t\t\t</li>", r = "");
                s = '<div class="search-result"><p class="gray">涓庘€�' + e + "鈥濈浉鍏崇殑鍏徃锛屽叡" + a.length + '涓�</p>\t\t\t\t\t\t<ul class="result-list">' + o + '</ul></div>\t\t\t\t\t\t<div class="op">\t\t\t\t\t\t\t<div class="pull-right">\t\t\t\t\t\t\t\t<button class="btn ' + r + '">灞忚斀鎵€閫夊叕鍙�</button>\t\t\t\t\t\t\t</div>\t\t\t\t\t\t\t<label class="checkbox check-all">\t\t\t\t\t\t\t\t<input type="checkbox" checked="checked" class="disabled">\t\t\t\t\t\t\t\t<span>鍏ㄩ€�</span>\t\t\t\t\t\t\t</label>\t\t\t\t\t\t</div>'
            } else s = '<div class="search-result"><p class="gray">涓庘€�' + e + "鈥濈浉鍏崇殑鍏徃锛屽叡" + a.length + '涓�</p><div class="tips"><img src="' + staticPath + '/web/geek/images/settings-tip.png"><p class="gray">娌℃湁鎵惧埌鎮ㄦ悳绱㈢殑鍏徃</p></div></div>';
            i.html(s), i.find(".check-all input").on("change", function () {
        ...
        Settings.page++, $.get(i, {page: Settings.page}, function (i) {
            if (i.rescode) {
                for (var a = i.maskCompanyList, s = 0; s < a.length; s++) n += '<li><span class="link-cancel" data-id="' + a[s].encryptComId + '">鍙栨秷灞忚斀</span>' + a[s].comName + "</li>";
...
preview.init(), $(function () {
    ...
    function e() {
        ...
        l < i[0] && (c < 1 ? c += c > .03 ? 1 / (2 * i[0]) : 1 / (5 * i[0]) : c = 0, o.save(), o.globalAlpha = l > 1 ? 1 : 0, o.beginPath(), o.fillStyle = "rgba(83,202,195," + c + ")", o.arc(n / 2 + 125 * e, a / 2 + 125 * t, 7, 0, 2 * Math.PI), o.fill(), o.restore()), u > 10 && u < i[1] && (p.clearRect(0, 0, n, a), p.save(), p.translate(n / 2, a / 2), p.rotate(u * Math.PI / 320), p.fillStyle = "rgb(83,202,195)",
            p.beginPath(), p.arc(-120, 75, 5, 0, 2 * Math.PI, !0), p.closePath(), p.fill(), p.restore())
    }

    if ($("#competitive-main").length) {
        var t = _COMPETITIVE_PAGE.position / _COMPETITIVE_PAGE.commNum, i = [];
        t <= .25 ? (i = [340, 340], $(".competitive_text").html("鏋佸ソ"), $(".competitive_text").parents(".row-one").find(".chart_title").find("p").eq(1).html("鏋佸ソ")) : t > .25 && t <= .5 ? (i = [260, 260], $(".competitive_text").html("浼樼"), $(".competitive_text").parents(".row-one").find(".chart_title").find("p").eq(1).html("浼樼")) : t > .5 && t <= .75 ? (i = [160, 160], $(".competitive_text").html("鑹ソ"), $(".competitive_text").parents(".row-one").find(".chart_title").find("p").eq(1).html("鑹ソ")) : t > .75 && (i = [88, 88], $(".competitive_text").html("涓€鑸�"), $(".competitive_text").parents(".row-one").find(".chart_title").find("p").eq(1).html("涓€鑸�"));
        var n, a, s = document.getElementById("canvas"), o = s.getContext("2d"), r = 1, c = 0;
        n = $(".competition_show_chart img").width(), a = $(".competition_show_chart img").height();
...
$(document).ready(function () {
    ...
    if ($("#competitive-main").length) {
        ...
        $(window).scroll(n(200, e)), n(200, e)(), _COMPETITIVE_PAGE.reportDataJson.Communicate.forEach(function (e, t, i) {
            var n = "#" + e.factor, a = $(".hoz_bar").width(), s = e.rate * a / 100, o = 0;
            ...
            var n = "#" + e.factor, a = 0, s = $(".match_wrap").data("height") * parseInt($("html").css("fontSize"));
            if (height = e.rate * s / 100, ids.map(function (t) {
                ...
                for (var o = t - 1; o >= 0; o--) a += i[o].rate;
                0 == a && $("#CVMatch").html("1%").prev("span").html("瓒呰繃浜�"), a < 50 && a > 0 && $("#CVMatch").html(parseInt(a) + "%").prev("span").html("瓒呰繃浜�"), a >= 50 && 100 - a != 0 && $("#CVMatch").html(+parseInt(100 - a) + "%").prev("span").html("鎺掑悕鍓�")
            } else 0 == t && (a = 100);
            100 - a == 0 && $("#CVMatch").html("1%").prev("span").html("瓒呰繃浜�")
        }), _COMPETITIVE_PAGE.reportDataJson.Degree.forEach(function (e, t, i) {
            var n = "#" + e.factor, a = 0, s = $(".qua_wrap").data("height") * parseInt($("html").css("fontSize")),
                o = e.rate * s / 100;
            if (ids.map(function (t) {
                t.id == e.factor && (t.height = o)
            }), $(n).find(".percent").html(e.rate + "%"), e.isCur && $(n).find(".match").show(), e.isCur && 0 != t) {
                for (var r = t - 1; r >= 0; r--) a += i[r].rate;
                0 == a && $("#Degree").html("1%").prev("span").html("瓒呰繃浜�"), a < 50 && a > 0 && $("#Degree").html(+parseInt(a) + "%").prev("span").html("瓒呰繃浜�"), a >= 50 && 100 - a != 0 && $("#Degree").html(+parseInt(100 - a) + "%").prev("span").html("鎺掑悕鍓�")
            } else 0 == t && (a = 100);
            100 - a == 0 && $("#Degree").html("1%").prev("span").html("瓒呰繃浜�")
        }), _COMPETITIVE_PAGE.reportDataJson.Experience.forEach(function (e, t, i) {
            var n = "#" + e.factor, a = 0, s = $(".hoz_bar").width(), o = e.rate * s / 100;
            if (ids.map(function (t) {
                ...
                for (var r = t - 1; r >= 0; r--) a += i[r].rate;
                0 == a && $("#Experience").html("1%").prev("span").html("瓒呰繃浜�"), a < 50 && a > 0 && $("#Experience").html(+parseInt(a) + "%").prev("span").html("瓒呰繃浜�"), a >= 50 && 100 - a != 0 && $("#Experience").html(+parseInt(100 - a) + "%").prev("span").html("鎺掑悕鍓�")
            } else 0 == t && (a = 100);
            100 - a == 0 && $("#Experience").html("1%").prev("span").html("瓒呰繃浜�")
        }), _COMPETITIVE_PAGE.reportDataJson.Salary_Dynamic.forEach(function (e, t, i) {
            var n = "#" + e.factor, a = 0, s = $(".sal_wrap").data("height") * parseInt($("html").css("fontSize"));
            if (height = e.rate * s / 100, ids.map(function (t) {
                t.id == e.factor && (t.height = height)
            }), $(".Xtext").children()[t].innerText = e.name, $(n).find(".percent").html(e.rate + "%"), e.isCur && $(n).find(".sal").show(), e.isCur && 0 != t) {
                for (var o = t - 1; o >= 0; o--) a += i[o].rate;
                0 == a && $("#Salary_Dynamic").html("1%").prev("span").html("瓒呰繃浜�"), a < 50 && a > 0 && $("#Salary_Dynamic").html(+parseInt(a) + "%").prev("span").html("瓒呰繃浜�"), a >= 50 && 100 - a != 0 && $("#Salary_Dynamic").html(+parseInt(100 - a) + "%").prev("span").html("鎺掑悕鍓�"), $("#Salary_Dynamic + p").html(text[e.factor])
            } else 0 == t && (a = 100);
            100 - a == 0 && $("#Salary_Dynamic").html("1%").prev("span").html("瓒呰繃浜�"), e.isCur && "Salary_NO" == e.factor && $("#Salary_Dynamic").html(e.rate + "%").prev("span").html("鏈～鍐�")
        });
        ...
        _COMPETITIVE_PAGE.reportDataJson.Boss_Active.forEach(function (e, t) {
            var i = "#" + e.factor;
            if (e.isCur) {
                $(i).attr("src", a), $(i).hasClass("no_active") && $(i).removeClass("no_active"), $(i).hasClass("active") || $(i).addClass("active");
            ...
            } else $(i).attr("src", s), $(i).hasClass("no_active") || $(i).addClass("no_active"), $(i).hasClass("active") && $(i).removeClass("active")
        });
    ...
    init: function () {
        if ($("#wrap").hasClass("sign-resume-wrapper")) {
            ...
            AnalysisResume.initUploadResume(function (e) {
                if (n.find(".sign-slide-box ul").find(".count").eq(0).text(e.data.validUserBaseInfoNum).end().eq(1).text(e.data.validWorkExpNum).end().eq(2).text(e.data.validEduExpNum).end().eq(3).text(e.data.validExpectNum), n.find("input[name=cvpk]").val(e.data.key), n.find("input[name=phone]").val(e.data.phone ? e.data.phone : ""), i.addClass("hide"), $(".sign-resume").removeClass("hide"), $(".sign-form:visible").find(".row-code").length) {
                    new VerifyCodeSDK({
                        dom: $(".sign-form:visible").find(".row-code")[0], success: function (e) {
                            Sign.VerrifySuccessCallback(e)
                        }, ready: function (e) {
                            Sign.VerrifyReadyCallback(e)
                        }
        ...
        if (t.resumeCount >= 3 && t.isComplete) $.dialog({
            ...
            if (t.resumeCount >= 3) {
                var a = "";
                t.toUrl.indexOf("?") > -1 ? a += "&" : a += "?", t.toUrl += a + "maxResumeCount=true"
            }
